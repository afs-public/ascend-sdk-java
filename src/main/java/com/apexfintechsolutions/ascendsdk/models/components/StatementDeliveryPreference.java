...
public class StatementDeliveryPreference {
  ...
  public static final StatementDeliveryPreference SUPPRESS =
      new StatementDeliveryPreference("SUPPRESS");
  ...
  // convention)
  private static final Map<String, StatementDeliveryPreference> values = createValuesMap();
  private static final Map<String, StatementDeliveryPreferenceEnum> enums = createEnumsMap();

  private final String value;

  private StatementDeliveryPreference(String value) {
    this.value = value;
  }

  /**
   * Returns a StatementDeliveryPreference with the given value. For a specific value the returned
   * object will always be a singleton so reference equality is satisfied when the values are the
   * same.
   *
   * @param value value to be wrapped as StatementDeliveryPreference
   */
  public static StatementDeliveryPreference of(String value) {
    synchronized (StatementDeliveryPreference.class) {
      return values.computeIfAbsent(value, v -> new StatementDeliveryPreference(v));
    }
  }
  ...
  public Optional<StatementDeliveryPreferenceEnum> asEnum() {
  ...
  public boolean equals(java.lang.Object obj) {
    ...
    StatementDeliveryPreference other = (StatementDeliveryPreference) obj;
    return Objects.equals(value, other.value);
  }

  @Override
  public String toString() {
    return "StatementDeliveryPreference [value=" + value + "]";
  }

  // return an array just like an enum
  public static StatementDeliveryPreference[] values() {
    synchronized (StatementDeliveryPreference.class) {
      return values.values().toArray(new StatementDeliveryPreference[] {});
    }
  }
  ...
  public static final class _Serializer extends StdSerializer<StatementDeliveryPreference> {

    protected _Serializer() {
      super(StatementDeliveryPreference.class);
    }

    @Override
    public void serialize(
        StatementDeliveryPreference value, JsonGenerator g, SerializerProvider provider)
  ...
  @SuppressWarnings("serial")
  public static final class _Deserializer extends StdDeserializer<StatementDeliveryPreference> {
    ...
    @Override
    public StatementDeliveryPreference deserialize(JsonParser p, DeserializationContext ctxt)
        throws IOException, JacksonException {
      String v = p.readValueAs(new TypeReference<String>() {});
      // use the factory method to ensure we get singletons
      return StatementDeliveryPreference.of(v);
    }
  }
  ...
  public enum StatementDeliveryPreferenceEnum {
    ...
    private StatementDeliveryPreferenceEnum(String value) {
      this.value = value;
    }
