 ...
 *
 * <p>The current state of the credit
 */
public class TransfersCreditState {
  ...
  @JsonInclude(Include.NON_ABSENT)
  @JsonProperty("state")
  private Optional<? extends TransfersCreditStateState> state;
  ...
  @SuppressWarnings("unchecked")
  @JsonIgnore
  public Optional<TransfersCreditStateState> state() {
    return (Optional<TransfersCreditStateState>) state;
  }
  ...
  /** The user or service that triggered the state update. */
  public TransfersCreditState withActor(String actor) {
    Utils.checkNotNull(actor, "actor");
  ...
  /** The user or service that triggered the state update. */
  public TransfersCreditState withActor(Optional<String> actor) {
    Utils.checkNotNull(actor, "actor");
    this.actor = actor;
    return this;
  }
  ...
  /** Additional description of the transfer state. */
  public TransfersCreditState withMessage(String message) {
    Utils.checkNotNull(message, "message");
  ...
  /** Additional description of the transfer state. */
  public TransfersCreditState withMessage(Optional<String> message) {
    Utils.checkNotNull(message, "message");
    this.message = message;
    return this;
  }
   ...
   * when `state` is `CANCELED`
   */
  public TransfersCreditState withMetadata(Map<String, Object> metadata) {
    Utils.checkNotNull(metadata, "metadata");
   ...
   * when `state` is `CANCELED`
   */
  public TransfersCreditState withMetadata(JsonNullable<? extends Map<String, Object>> metadata) {
    Utils.checkNotNull(metadata, "metadata");
    this.metadata = metadata;
    return this;
  }
   ...
   * - The transfer is postponed and will resume processing during the next processing window.
   */
  public TransfersCreditState withState(TransfersCreditStateState state) {
    Utils.checkNotNull(state, "state");
   ...
   * - The transfer is postponed and will resume processing during the next processing window.
   */
  public TransfersCreditState withState(Optional<? extends TransfersCreditStateState> state) {
    Utils.checkNotNull(state, "state");
    this.state = state;
    return this;
  }
  ...
  /** The time of the state update. */
  public TransfersCreditState withUpdateTime(OffsetDateTime updateTime) {
    Utils.checkNotNull(updateTime, "updateTime");
  ...
  /** The time of the state update. */
  public TransfersCreditState withUpdateTime(JsonNullable<OffsetDateTime> updateTime) {
    Utils.checkNotNull(updateTime, "updateTime");
    this.updateTime = updateTime;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TransfersCreditState other = (TransfersCreditState) o;
  ...
  public static final class Builder {
    ...
    private Optional<? extends TransfersCreditStateState> state = Optional.empty();
     ...
     * processing window.
     */
    public Builder state(TransfersCreditStateState state) {
      Utils.checkNotNull(state, "state");
      this.state = Optional.ofNullable(state);
      return this;
    }
     ...
     * processing window.
     */
    public Builder state(Optional<? extends TransfersCreditStateState> state) {
      Utils.checkNotNull(state, "state");
      this.state = state;
      return this;
    }
    ...
    public TransfersCreditState build() {

      return new TransfersCreditState(actor, message, metadata, state, updateTime);
    }
  }
}
