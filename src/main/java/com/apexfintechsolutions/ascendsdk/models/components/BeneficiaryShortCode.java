 ...
 */
public class BeneficiaryShortCode {
  /**
   ...
   * "611".
   */
  public BeneficiaryShortCode withNumber(String number) {
    Utils.checkNotNull(number, "number");
   ...
   * "611".
   */
  public BeneficiaryShortCode withNumber(Optional<String> number) {
    Utils.checkNotNull(number, "number");
    this.number = number;
    return this;
  }
   ...
   * <p>Reference(s): - http://www.unicode.org/reports/tr35/#unicode_region_subtag
   */
  public BeneficiaryShortCode withRegionCode(String regionCode) {
    Utils.checkNotNull(regionCode, "regionCode");
   ...
   * <p>Reference(s): - http://www.unicode.org/reports/tr35/#unicode_region_subtag
   */
  public BeneficiaryShortCode withRegionCode(Optional<String> regionCode) {
    Utils.checkNotNull(regionCode, "regionCode");
    this.regionCode = regionCode;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BeneficiaryShortCode other = (BeneficiaryShortCode) o;
  ...
  public String toString() {
    return Utils.toString(BeneficiaryShortCode.class, "number", number, "regionCode", regionCode);
  }
  ...
  public static final class Builder {
    ...
    public BeneficiaryShortCode build() {

      return new BeneficiaryShortCode(number, regionCode);
    }
  }
}
