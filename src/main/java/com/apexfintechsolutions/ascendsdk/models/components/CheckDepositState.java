 ...
 * CheckDepositState
 *
 * <p>The current state of the check deposit.
 */
public class CheckDepositState {
  ...
  @JsonInclude(Include.NON_ABSENT)
  @JsonProperty("state")
  private Optional<? extends CheckDepositStateState> state;
  ...
  @SuppressWarnings("unchecked")
  @JsonIgnore
  public Optional<CheckDepositStateState> state() {
    return (Optional<CheckDepositStateState>) state;
  }
  ...
  /** The user or service that triggered the state update. */
  public CheckDepositState withActor(String actor) {
    Utils.checkNotNull(actor, "actor");
  ...
  /** The user or service that triggered the state update. */
  public CheckDepositState withActor(Optional<String> actor) {
    Utils.checkNotNull(actor, "actor");
    this.actor = actor;
    return this;
  }
  ...
  /** Additional description of the transfer state. */
  public CheckDepositState withMessage(String message) {
    Utils.checkNotNull(message, "message");
  ...
  /** Additional description of the transfer state. */
  public CheckDepositState withMessage(Optional<String> message) {
    Utils.checkNotNull(message, "message");
    this.message = message;
    return this;
  }
   ...
   * when `state` is `CANCELED`
   */
  public CheckDepositState withMetadata(Map<String, Object> metadata) {
    Utils.checkNotNull(metadata, "metadata");
   ...
   * when `state` is `CANCELED`
   */
  public CheckDepositState withMetadata(JsonNullable<? extends Map<String, Object>> metadata) {
    Utils.checkNotNull(metadata, "metadata");
    this.metadata = metadata;
    return this;
  }
   ...
   * - The transfer is postponed and will resume processing during the next processing window.
   */
  public CheckDepositState withState(CheckDepositStateState state) {
    Utils.checkNotNull(state, "state");
   ...
   * - The transfer is postponed and will resume processing during the next processing window.
   */
  public CheckDepositState withState(Optional<? extends CheckDepositStateState> state) {
    Utils.checkNotNull(state, "state");
    this.state = state;
    return this;
  }
  ...
  /** The time of the state update. */
  public CheckDepositState withUpdateTime(OffsetDateTime updateTime) {
    Utils.checkNotNull(updateTime, "updateTime");
  ...
  /** The time of the state update. */
  public CheckDepositState withUpdateTime(JsonNullable<OffsetDateTime> updateTime) {
    Utils.checkNotNull(updateTime, "updateTime");
    this.updateTime = updateTime;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CheckDepositState other = (CheckDepositState) o;
  ...
  public static final class Builder {
    ...
    private Optional<? extends CheckDepositStateState> state = Optional.empty();
     ...
     * processing window.
     */
    public Builder state(CheckDepositStateState state) {
      Utils.checkNotNull(state, "state");
      this.state = Optional.ofNullable(state);
      return this;
    }
     ...
     * processing window.
     */
    public Builder state(Optional<? extends CheckDepositStateState> state) {
      Utils.checkNotNull(state, "state");
      this.state = state;
      return this;
    }
    ...
    public CheckDepositState build() {

      return new CheckDepositState(actor, message, metadata, state, updateTime);
    }
  }
}
