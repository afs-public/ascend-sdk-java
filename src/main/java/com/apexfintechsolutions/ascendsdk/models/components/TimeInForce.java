 ...
 */
/**
 * TimeInForce - Must be the value "DAY". Regulatory requirements dictate that the system capture
 * the intended time_in_force, which is why this a mandatory field.
 */
...
public class TimeInForce {
  ...
  // convention)
  private static final Map<String, TimeInForce> values = createValuesMap();
  private static final Map<String, TimeInForceEnum> enums = createEnumsMap();
  ...
  /**
   * Returns a TimeInForce with the given value. For a specific value the returned object will
   * always be a singleton so reference equality is satisfied when the values are the same.
   *
   * @param value value to be wrapped as TimeInForce
   */
  public static TimeInForce of(String value) {
    synchronized (TimeInForce.class) {
      return values.computeIfAbsent(value, v -> new TimeInForce(v));
    }
  }
  ...
  public Optional<TimeInForceEnum> asEnum() {
  ...
  public boolean equals(java.lang.Object obj) {
    ...
    TimeInForce other = (TimeInForce) obj;
    return Objects.equals(value, other.value);
  }

  @Override
  public String toString() {
    return "TimeInForce [value=" + value + "]";
  }

  // return an array just like an enum
  public static TimeInForce[] values() {
    synchronized (TimeInForce.class) {
      return values.values().toArray(new TimeInForce[] {});
    }
  }
  ...
  public static final class _Serializer extends StdSerializer<TimeInForce> {

    protected _Serializer() {
      super(TimeInForce.class);
    }

    @Override
    public void serialize(TimeInForce value, JsonGenerator g, SerializerProvider provider)
  ...
  @SuppressWarnings("serial")
  public static final class _Deserializer extends StdDeserializer<TimeInForce> {
    ...
    @Override
    public TimeInForce deserialize(JsonParser p, DeserializationContext ctxt)
        throws IOException, JacksonException {
      String v = p.readValueAs(new TypeReference<String>() {});
      // use the factory method to ensure we get singletons
      return TimeInForce.of(v);
    }
  }
