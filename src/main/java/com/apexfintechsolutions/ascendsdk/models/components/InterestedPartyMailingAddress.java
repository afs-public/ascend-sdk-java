 ...
 *
 * <p>The object containing data for the purpose of delivery physical mailings to a party; Typically
 * used for statements, account updates, tax documents, and other postal mailings; May also be used
 * as an alternative identity verification address to personalAddress. Required fields within the
 * `mailing_address` object include: - `administrative_area` - `region_code` - 2 character CLDR Code
 * - `postal_code` - `locality` - `address_lines` - max 5 lines
 */
public class InterestedPartyMailingAddress {
  /**
  ...
  @JsonCreator
  public InterestedPartyMailingAddress(
   ...
   * parts of the address should be localities or administrative areas).
   */
  public InterestedPartyMailingAddress withAddressLines(List<String> addressLines) {
    Utils.checkNotNull(addressLines, "addressLines");
   ...
   * parts of the address should be localities or administrative areas).
   */
  public InterestedPartyMailingAddress withAddressLines(
   ...
   * Switzerland this should be left unpopulated.
   */
  public InterestedPartyMailingAddress withAdministrativeArea(String administrativeArea) {
    Utils.checkNotNull(administrativeArea, "administrativeArea");
   ...
   * Switzerland this should be left unpopulated.
   */
  public InterestedPartyMailingAddress withAdministrativeArea(Optional<String> administrativeArea) {
    Utils.checkNotNull(administrativeArea, "administrativeArea");
    this.administrativeArea = administrativeArea;
    return this;
  }
   ...
   * <p>Examples: "zh-Hant", "ja", "ja-Latn", "en".
   */
  public InterestedPartyMailingAddress withLanguageCode(String languageCode) {
    Utils.checkNotNull(languageCode, "languageCode");
   ...
   * <p>Examples: "zh-Hant", "ja", "ja-Latn", "en".
   */
  public InterestedPartyMailingAddress withLanguageCode(Optional<String> languageCode) {
    Utils.checkNotNull(languageCode, "languageCode");
    this.languageCode = languageCode;
    return this;
  }
   ...
   * fit into this structure well, leave locality empty and use address_lines.
   */
  public InterestedPartyMailingAddress withLocality(String locality) {
    Utils.checkNotNull(locality, "locality");
   ...
   * fit into this structure well, leave locality empty and use address_lines.
   */
  public InterestedPartyMailingAddress withLocality(Optional<String> locality) {
    Utils.checkNotNull(locality, "locality");
    this.locality = locality;
    return this;
  }
  ...
  /** Optional. The name of the organization at the address. */
  public InterestedPartyMailingAddress withOrganization(String organization) {
    Utils.checkNotNull(organization, "organization");
  ...
  /** Optional. The name of the organization at the address. */
  public InterestedPartyMailingAddress withOrganization(Optional<String> organization) {
    Utils.checkNotNull(organization, "organization");
    this.organization = organization;
    return this;
  }
   ...
   * the address (e.g. state/zip validation in the U.S.A.).
   */
  public InterestedPartyMailingAddress withPostalCode(String postalCode) {
    Utils.checkNotNull(postalCode, "postalCode");
   ...
   * the address (e.g. state/zip validation in the U.S.A.).
   */
  public InterestedPartyMailingAddress withPostalCode(Optional<String> postalCode) {
    Utils.checkNotNull(postalCode, "postalCode");
    this.postalCode = postalCode;
    return this;
  }
   ...
   * multiline information. For example, it might contain "care of" information.
   */
  public InterestedPartyMailingAddress withRecipients(List<String> recipients) {
    Utils.checkNotNull(recipients, "recipients");
   ...
   * multiline information. For example, it might contain "care of" information.
   */
  public InterestedPartyMailingAddress withRecipients(Optional<? extends List<String>> recipients) {
    Utils.checkNotNull(recipients, "recipients");
    this.recipients = recipients;
    return this;
  }
   ...
   * Example: "CH" for Switzerland.
   */
  public InterestedPartyMailingAddress withRegionCode(String regionCode) {
    Utils.checkNotNull(regionCode, "regionCode");
   ...
   * Example: "CH" for Switzerland.
   */
  public InterestedPartyMailingAddress withRegionCode(Optional<String> regionCode) {
    Utils.checkNotNull(regionCode, "regionCode");
    this.regionCode = regionCode;
    return this;
  }
   ...
   * <p>All new revisions **must** be backward compatible with old revisions.
   */
  public InterestedPartyMailingAddress withRevision(int revision) {
    Utils.checkNotNull(revision, "revision");
   ...
   * <p>All new revisions **must** be backward compatible with old revisions.
   */
  public InterestedPartyMailingAddress withRevision(Optional<Integer> revision) {
    Utils.checkNotNull(revision, "revision");
    this.revision = revision;
    return this;
  }
   ...
   * indicator" (Malawi) or "post office indicator" (e.g. Côte d'Ivoire).
   */
  public InterestedPartyMailingAddress withSortingCode(String sortingCode) {
    Utils.checkNotNull(sortingCode, "sortingCode");
   ...
   * indicator" (Malawi) or "post office indicator" (e.g. Côte d'Ivoire).
   */
  public InterestedPartyMailingAddress withSortingCode(Optional<String> sortingCode) {
    Utils.checkNotNull(sortingCode, "sortingCode");
    this.sortingCode = sortingCode;
    return this;
  }
   ...
   * districts.
   */
  public InterestedPartyMailingAddress withSublocality(String sublocality) {
    Utils.checkNotNull(sublocality, "sublocality");
   ...
   * districts.
   */
  public InterestedPartyMailingAddress withSublocality(Optional<String> sublocality) {
    Utils.checkNotNull(sublocality, "sublocality");
    this.sublocality = sublocality;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    InterestedPartyMailingAddress other = (InterestedPartyMailingAddress) o;
    return Utils.enhancedDeepEquals(this.addressLines, other.addressLines)
        ...
        && Utils.enhancedDeepEquals(this.revision, other.revision)
        && Utils.enhancedDeepEquals(this.sortingCode, other.sortingCode)
        && Utils.enhancedDeepEquals(this.sublocality, other.sublocality);
  }
  ...
  public String toString() {
    return Utils.toString(
        InterestedPartyMailingAddress.class,
        "addressLines",
        addressLines,
        "administrativeArea",
        administrativeArea,
  ...
  public static final class Builder {
    ...
    public InterestedPartyMailingAddress build() {

      return new InterestedPartyMailingAddress(
          addressLines,
          administrativeArea,
          languageCode,
          locality,
