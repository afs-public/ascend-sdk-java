...
/**
 * SeriesDate - The date of the option contract this is the value in the OSI and is typically the
 * same as the expiration_date but can vary when the option expiration is accelerated.
 */
