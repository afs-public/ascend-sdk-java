...
public class PayDate {
   ...
   * by itself or a year and month where the day isn't significant.
   */
  public PayDate withDay(int day) {
    Utils.checkNotNull(day, "day");
   ...
   * by itself or a year and month where the day isn't significant.
   */
  public PayDate withDay(Optional<Integer> day) {
    Utils.checkNotNull(day, "day");
    this.day = day;
    return this;
  }
  ...
  /** Month of a year. Must be from 1 to 12, or 0 to specify a year without a month and day. */
  public PayDate withMonth(int month) {
    Utils.checkNotNull(month, "month");
  ...
  /** Month of a year. Must be from 1 to 12, or 0 to specify a year without a month and day. */
  public PayDate withMonth(Optional<Integer> month) {
    Utils.checkNotNull(month, "month");
    this.month = month;
    return this;
  }
  ...
  /** Year of the date. Must be from 1 to 9999, or 0 to specify a date without a year. */
  public PayDate withYear(int year) {
    Utils.checkNotNull(year, "year");
  ...
  /** Year of the date. Must be from 1 to 9999, or 0 to specify a date without a year. */
  public PayDate withYear(Optional<Integer> year) {
    Utils.checkNotNull(year, "year");
    this.year = year;
    return this;
  }
  ...
  public String toString() {
    return Utils.toString(PayDate.class, "day", day, "month", month, "year", year);
  }
  ...
  public static final class Builder {
    ...
    public PayDate build() {
      ...
      return new PayDate(day, month, year);
    }
  }
}
