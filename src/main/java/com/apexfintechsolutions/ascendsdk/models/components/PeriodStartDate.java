 ...
 * PeriodStartDate
 *
 * <p>The period start date, specific to the US Eastern Time Zone, of the LOI. Date range: 90 days
...
public class PeriodStartDate {
   ...
   * by itself or a year and month where the day isn't significant.
   */
  public PeriodStartDate withDay(int day) {
    Utils.checkNotNull(day, "day");
   ...
   * by itself or a year and month where the day isn't significant.
   */
  public PeriodStartDate withDay(Optional<Integer> day) {
    Utils.checkNotNull(day, "day");
    this.day = day;
    return this;
  }
  ...
  /** Month of a year. Must be from 1 to 12, or 0 to specify a year without a month and day. */
  public PeriodStartDate withMonth(int month) {
    Utils.checkNotNull(month, "month");
  ...
  /** Month of a year. Must be from 1 to 12, or 0 to specify a year without a month and day. */
  public PeriodStartDate withMonth(Optional<Integer> month) {
    Utils.checkNotNull(month, "month");
    this.month = month;
    return this;
  }
  ...
  /** Year of the date. Must be from 1 to 9999, or 0 to specify a date without a year. */
  public PeriodStartDate withYear(int year) {
    Utils.checkNotNull(year, "year");
  ...
  /** Year of the date. Must be from 1 to 9999, or 0 to specify a date without a year. */
  public PeriodStartDate withYear(Optional<Integer> year) {
    Utils.checkNotNull(year, "year");
    this.year = year;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PeriodStartDate other = (PeriodStartDate) o;
  ...
  public String toString() {
    return Utils.toString(PeriodStartDate.class, "day", day, "month", month, "year", year);
  }
  ...
  public static final class Builder {
    ...
    public PeriodStartDate build() {

      return new PeriodStartDate(day, month, year);
    }
  }
}
