 ...
 * WireWithdrawalState
 *
 * <p>The current state of the wire withdrawal
 */
public class WireWithdrawalState {
  ...
  @JsonInclude(Include.NON_ABSENT)
  @JsonProperty("state")
  private Optional<? extends WireWithdrawalStateState> state;
  ...
  @SuppressWarnings("unchecked")
  @JsonIgnore
  public Optional<WireWithdrawalStateState> state() {
    return (Optional<WireWithdrawalStateState>) state;
  }
  ...
  /** The user or service that triggered the state update. */
  public WireWithdrawalState withActor(String actor) {
    Utils.checkNotNull(actor, "actor");
  ...
  /** The user or service that triggered the state update. */
  public WireWithdrawalState withActor(Optional<String> actor) {
    Utils.checkNotNull(actor, "actor");
    this.actor = actor;
    return this;
  }
  ...
  /** Additional description of the transfer state. */
  public WireWithdrawalState withMessage(String message) {
    Utils.checkNotNull(message, "message");
  ...
  /** Additional description of the transfer state. */
  public WireWithdrawalState withMessage(Optional<String> message) {
    Utils.checkNotNull(message, "message");
    this.message = message;
    return this;
  }
   ...
   * when `state` is `CANCELED`
   */
  public WireWithdrawalState withMetadata(Map<String, Object> metadata) {
    Utils.checkNotNull(metadata, "metadata");
   ...
   * when `state` is `CANCELED`
   */
  public WireWithdrawalState withMetadata(JsonNullable<? extends Map<String, Object>> metadata) {
    Utils.checkNotNull(metadata, "metadata");
    this.metadata = metadata;
    return this;
  }
   ...
   * - The transfer is postponed and will resume processing during the next processing window.
   */
  public WireWithdrawalState withState(WireWithdrawalStateState state) {
    Utils.checkNotNull(state, "state");
   ...
   * - The transfer is postponed and will resume processing during the next processing window.
   */
  public WireWithdrawalState withState(Optional<? extends WireWithdrawalStateState> state) {
    Utils.checkNotNull(state, "state");
    this.state = state;
    return this;
  }
  ...
  /** The time of the state update. */
  public WireWithdrawalState withUpdateTime(OffsetDateTime updateTime) {
    Utils.checkNotNull(updateTime, "updateTime");
  ...
  /** The time of the state update. */
  public WireWithdrawalState withUpdateTime(JsonNullable<OffsetDateTime> updateTime) {
    Utils.checkNotNull(updateTime, "updateTime");
    this.updateTime = updateTime;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    WireWithdrawalState other = (WireWithdrawalState) o;
  ...
  public static final class Builder {
    ...
    private Optional<? extends WireWithdrawalStateState> state = Optional.empty();
     ...
     * processing window.
     */
    public Builder state(WireWithdrawalStateState state) {
      Utils.checkNotNull(state, "state");
      this.state = Optional.ofNullable(state);
      return this;
    }
     ...
     * processing window.
     */
    public Builder state(Optional<? extends WireWithdrawalStateState> state) {
      Utils.checkNotNull(state, "state");
      this.state = state;
      return this;
    }
    ...
    public WireWithdrawalState build() {

      return new WireWithdrawalState(actor, message, metadata, state, updateTime);
    }
  }
}
