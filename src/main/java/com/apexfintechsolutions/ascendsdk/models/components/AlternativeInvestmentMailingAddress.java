 ...
 *
 * <p>The issuer’s mailing address.
 */
public class AlternativeInvestmentMailingAddress {
  /**
  ...
  @JsonCreator
  public AlternativeInvestmentMailingAddress(
   ...
   * parts of the address should be localities or administrative areas).
   */
  public AlternativeInvestmentMailingAddress withAddressLines(List<String> addressLines) {
    Utils.checkNotNull(addressLines, "addressLines");
   ...
   * parts of the address should be localities or administrative areas).
   */
  public AlternativeInvestmentMailingAddress withAddressLines(
   ...
   * Switzerland this should be left unpopulated.
   */
  public AlternativeInvestmentMailingAddress withAdministrativeArea(String administrativeArea) {
    Utils.checkNotNull(administrativeArea, "administrativeArea");
   ...
   * Switzerland this should be left unpopulated.
   */
  public AlternativeInvestmentMailingAddress withAdministrativeArea(
   ...
   * <p>Examples: "zh-Hant", "ja", "ja-Latn", "en".
   */
  public AlternativeInvestmentMailingAddress withLanguageCode(String languageCode) {
    Utils.checkNotNull(languageCode, "languageCode");
   ...
   * <p>Examples: "zh-Hant", "ja", "ja-Latn", "en".
   */
  public AlternativeInvestmentMailingAddress withLanguageCode(Optional<String> languageCode) {
    Utils.checkNotNull(languageCode, "languageCode");
    this.languageCode = languageCode;
    return this;
  }
   ...
   * fit into this structure well, leave locality empty and use address_lines.
   */
  public AlternativeInvestmentMailingAddress withLocality(String locality) {
    Utils.checkNotNull(locality, "locality");
   ...
   * fit into this structure well, leave locality empty and use address_lines.
   */
  public AlternativeInvestmentMailingAddress withLocality(Optional<String> locality) {
    Utils.checkNotNull(locality, "locality");
    this.locality = locality;
    return this;
  }
  ...
  /** Optional. The name of the organization at the address. */
  public AlternativeInvestmentMailingAddress withOrganization(String organization) {
    Utils.checkNotNull(organization, "organization");
  ...
  /** Optional. The name of the organization at the address. */
  public AlternativeInvestmentMailingAddress withOrganization(Optional<String> organization) {
    Utils.checkNotNull(organization, "organization");
    this.organization = organization;
    return this;
  }
   ...
   * the address (e.g. state/zip validation in the U.S.A.).
   */
  public AlternativeInvestmentMailingAddress withPostalCode(String postalCode) {
    Utils.checkNotNull(postalCode, "postalCode");
   ...
   * the address (e.g. state/zip validation in the U.S.A.).
   */
  public AlternativeInvestmentMailingAddress withPostalCode(Optional<String> postalCode) {
    Utils.checkNotNull(postalCode, "postalCode");
    this.postalCode = postalCode;
    return this;
  }
   ...
   * multiline information. For example, it might contain "care of" information.
   */
  public AlternativeInvestmentMailingAddress withRecipients(List<String> recipients) {
    Utils.checkNotNull(recipients, "recipients");
   ...
   * multiline information. For example, it might contain "care of" information.
   */
  public AlternativeInvestmentMailingAddress withRecipients(
   ...
   * Example: "CH" for Switzerland.
   */
  public AlternativeInvestmentMailingAddress withRegionCode(String regionCode) {
    Utils.checkNotNull(regionCode, "regionCode");
   ...
   * Example: "CH" for Switzerland.
   */
  public AlternativeInvestmentMailingAddress withRegionCode(Optional<String> regionCode) {
    Utils.checkNotNull(regionCode, "regionCode");
    this.regionCode = regionCode;
    return this;
  }
   ...
   * <p>All new revisions **must** be backward compatible with old revisions.
   */
  public AlternativeInvestmentMailingAddress withRevision(int revision) {
    Utils.checkNotNull(revision, "revision");
   ...
   * <p>All new revisions **must** be backward compatible with old revisions.
   */
  public AlternativeInvestmentMailingAddress withRevision(Optional<Integer> revision) {
    Utils.checkNotNull(revision, "revision");
    this.revision = revision;
    return this;
  }
   ...
   * indicator" (Malawi) or "post office indicator" (e.g. Côte d'Ivoire).
   */
  public AlternativeInvestmentMailingAddress withSortingCode(String sortingCode) {
    Utils.checkNotNull(sortingCode, "sortingCode");
   ...
   * indicator" (Malawi) or "post office indicator" (e.g. Côte d'Ivoire).
   */
  public AlternativeInvestmentMailingAddress withSortingCode(Optional<String> sortingCode) {
    Utils.checkNotNull(sortingCode, "sortingCode");
    this.sortingCode = sortingCode;
    return this;
  }
   ...
   * districts.
   */
  public AlternativeInvestmentMailingAddress withSublocality(String sublocality) {
    Utils.checkNotNull(sublocality, "sublocality");
   ...
   * districts.
   */
  public AlternativeInvestmentMailingAddress withSublocality(Optional<String> sublocality) {
    Utils.checkNotNull(sublocality, "sublocality");
    this.sublocality = sublocality;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AlternativeInvestmentMailingAddress other = (AlternativeInvestmentMailingAddress) o;
  ...
  public String toString() {
    return Utils.toString(
        AlternativeInvestmentMailingAddress.class,
        "addressLines",
        addressLines,
        "administrativeArea",
        administrativeArea,
  ...
  public static final class Builder {
    ...
    public AlternativeInvestmentMailingAddress build() {

      return new AlternativeInvestmentMailingAddress(
          addressLines,
          administrativeArea,
          languageCode,
          locality,
