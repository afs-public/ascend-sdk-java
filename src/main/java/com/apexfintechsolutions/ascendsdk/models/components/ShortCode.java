...
public class ShortCode {
   ...
   * "611".
   */
  public ShortCode withNumber(String number) {
    Utils.checkNotNull(number, "number");
   ...
   * "611".
   */
  public ShortCode withNumber(Optional<String> number) {
    Utils.checkNotNull(number, "number");
    this.number = number;
    return this;
  }
   ...
   * <p>Reference(s): - http://www.unicode.org/reports/tr35/#unicode_region_subtag
   */
  public ShortCode withRegionCode(String regionCode) {
    Utils.checkNotNull(regionCode, "regionCode");
   ...
   * <p>Reference(s): - http://www.unicode.org/reports/tr35/#unicode_region_subtag
   */
  public ShortCode withRegionCode(Optional<String> regionCode) {
    Utils.checkNotNull(regionCode, "regionCode");
    this.regionCode = regionCode;
    return this;
  }
  ...
  public String toString() {
    return Utils.toString(ShortCode.class, "number", number, "regionCode", regionCode);
  }
  ...
  public static final class Builder {
    ...
    public ShortCode build() {
      return new ShortCode(number, regionCode);
    }
  }
}
