 ...
 *
 * <p>The required minimum distribution (RMD). Will be unset if the account is not required to make
...
public class RequiredMinimumDistribution {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Utils.enhancedDeepEquals(this.amount, other.amount)
        && Utils.enhancedDeepEquals(this.lifeExpectancyFactor, other.lifeExpectancyFactor)
        && Utils.enhancedDeepEquals(
            this.priorYearEndAccountBalance, other.priorYearEndAccountBalance)
        && Utils.enhancedDeepEquals(
