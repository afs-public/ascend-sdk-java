...
/**
 * OrderDate - The date on which the order will go to the market: must either be "today" or the next
 * valid trading day. If the current day is not a valid trading day, then the next valid market day
 * must be specified. If the current time is within 5 minutes prior to market close, the next valid
...
public class OrderDate {
   ...
   * by itself or a year and month where the day isn't significant.
   */
  public OrderDate withDay(int day) {
    Utils.checkNotNull(day, "day");
   ...
   * by itself or a year and month where the day isn't significant.
   */
  public OrderDate withDay(Optional<Integer> day) {
    Utils.checkNotNull(day, "day");
    this.day = day;
    return this;
  }
  ...
  /** Month of a year. Must be from 1 to 12, or 0 to specify a year without a month and day. */
  public OrderDate withMonth(int month) {
    Utils.checkNotNull(month, "month");
  ...
  /** Month of a year. Must be from 1 to 12, or 0 to specify a year without a month and day. */
  public OrderDate withMonth(Optional<Integer> month) {
    Utils.checkNotNull(month, "month");
    this.month = month;
    return this;
  }
  ...
  /** Year of the date. Must be from 1 to 9999, or 0 to specify a date without a year. */
  public OrderDate withYear(int year) {
    Utils.checkNotNull(year, "year");
  ...
  /** Year of the date. Must be from 1 to 9999, or 0 to specify a date without a year. */
  public OrderDate withYear(Optional<Integer> year) {
    Utils.checkNotNull(year, "year");
    this.year = year;
    return this;
  }
  ...
  public String toString() {
    return Utils.toString(OrderDate.class, "day", day, "month", month, "year", year);
  }
  ...
  public static final class Builder {
    ...
    public OrderDate build() {
      return new OrderDate(day, month, year);
    }
  }
}
