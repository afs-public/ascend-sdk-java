 ...
 * AchWithdrawalState
 *
 * <p>The current state of the ACH withdrawal.
 */
public class AchWithdrawalState {
  ...
  @JsonInclude(Include.NON_ABSENT)
  @JsonProperty("state")
  private Optional<? extends AchWithdrawalStateState> state;
  ...
  @SuppressWarnings("unchecked")
  @JsonIgnore
  public Optional<AchWithdrawalStateState> state() {
    return (Optional<AchWithdrawalStateState>) state;
  }
  ...
  /** The user or service that triggered the state update. */
  public AchWithdrawalState withActor(String actor) {
    Utils.checkNotNull(actor, "actor");
  ...
  /** The user or service that triggered the state update. */
  public AchWithdrawalState withActor(Optional<String> actor) {
    Utils.checkNotNull(actor, "actor");
    this.actor = actor;
    return this;
  }
  ...
  /** Additional description of the transfer state. */
  public AchWithdrawalState withMessage(String message) {
    Utils.checkNotNull(message, "message");
  ...
  /** Additional description of the transfer state. */
  public AchWithdrawalState withMessage(Optional<String> message) {
    Utils.checkNotNull(message, "message");
    this.message = message;
    return this;
  }
   ...
   * when `state` is `CANCELED`
   */
  public AchWithdrawalState withMetadata(Map<String, Object> metadata) {
    Utils.checkNotNull(metadata, "metadata");
   ...
   * when `state` is `CANCELED`
   */
  public AchWithdrawalState withMetadata(JsonNullable<? extends Map<String, Object>> metadata) {
    Utils.checkNotNull(metadata, "metadata");
    this.metadata = metadata;
    return this;
  }
   ...
   * - The transfer is postponed and will resume processing during the next processing window.
   */
  public AchWithdrawalState withState(AchWithdrawalStateState state) {
    Utils.checkNotNull(state, "state");
   ...
   * - The transfer is postponed and will resume processing during the next processing window.
   */
  public AchWithdrawalState withState(Optional<? extends AchWithdrawalStateState> state) {
    Utils.checkNotNull(state, "state");
    this.state = state;
    return this;
  }
  ...
  /** The time of the state update. */
  public AchWithdrawalState withUpdateTime(OffsetDateTime updateTime) {
    Utils.checkNotNull(updateTime, "updateTime");
  ...
  /** The time of the state update. */
  public AchWithdrawalState withUpdateTime(JsonNullable<OffsetDateTime> updateTime) {
    Utils.checkNotNull(updateTime, "updateTime");
    this.updateTime = updateTime;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AchWithdrawalState other = (AchWithdrawalState) o;
  ...
  public static final class Builder {
    ...
    private Optional<? extends AchWithdrawalStateState> state = Optional.empty();
     ...
     * processing window.
     */
    public Builder state(AchWithdrawalStateState state) {
      Utils.checkNotNull(state, "state");
      this.state = Optional.ofNullable(state);
      return this;
    }
     ...
     * processing window.
     */
    public Builder state(Optional<? extends AchWithdrawalStateState> state) {
      Utils.checkNotNull(state, "state");
      this.state = state;
      return this;
    }
    ...
    public AchWithdrawalState build() {

      return new AchWithdrawalState(actor, message, metadata, state, updateTime);
    }
  }
}
