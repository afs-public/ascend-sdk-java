 ...
 */
public class IdentityLookupShortCode {
  /**
  ...
  @JsonCreator
  public IdentityLookupShortCode(
   ...
   * "611".
   */
  public IdentityLookupShortCode withNumber(String number) {
    Utils.checkNotNull(number, "number");
   ...
   * "611".
   */
  public IdentityLookupShortCode withNumber(Optional<String> number) {
    Utils.checkNotNull(number, "number");
    this.number = number;
    return this;
  }
   ...
   * <p>Reference(s): - http://www.unicode.org/reports/tr35/#unicode_region_subtag
   */
  public IdentityLookupShortCode withRegionCode(String regionCode) {
    Utils.checkNotNull(regionCode, "regionCode");
   ...
   * <p>Reference(s): - http://www.unicode.org/reports/tr35/#unicode_region_subtag
   */
  public IdentityLookupShortCode withRegionCode(Optional<String> regionCode) {
    Utils.checkNotNull(regionCode, "regionCode");
    this.regionCode = regionCode;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    IdentityLookupShortCode other = (IdentityLookupShortCode) o;
  ...
  public String toString() {
    return Utils.toString(
        IdentityLookupShortCode.class, "number", number, "regionCode", regionCode);
  }
  ...
  public static final class Builder {
    ...
    public IdentityLookupShortCode build() {

      return new IdentityLookupShortCode(number, regionCode);
    }
  }
}
