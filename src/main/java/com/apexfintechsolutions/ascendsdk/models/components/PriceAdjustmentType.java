...
public class PriceAdjustmentType {
  ...
  public static final PriceAdjustmentType PRICE_ADJUSTMENT_TYPE_UNSPECIFIED =
  ...
  // convention)
  private static final Map<String, PriceAdjustmentType> values = createValuesMap();
  private static final Map<String, PriceAdjustmentTypeEnum> enums = createEnumsMap();
  ...
  /**
   * Returns a PriceAdjustmentType with the given value. For a specific value the returned object
   * will always be a singleton so reference equality is satisfied when the values are the same.
   *
   * @param value value to be wrapped as PriceAdjustmentType
   */
  public static PriceAdjustmentType of(String value) {
    synchronized (PriceAdjustmentType.class) {
      return values.computeIfAbsent(value, v -> new PriceAdjustmentType(v));
    }
  }
  ...
  public Optional<PriceAdjustmentTypeEnum> asEnum() {
  ...
  public boolean equals(java.lang.Object obj) {
    ...
    PriceAdjustmentType other = (PriceAdjustmentType) obj;
    return Objects.equals(value, other.value);
  }

  @Override
  public String toString() {
    return "PriceAdjustmentType [value=" + value + "]";
  }

  // return an array just like an enum
  public static PriceAdjustmentType[] values() {
    synchronized (PriceAdjustmentType.class) {
      return values.values().toArray(new PriceAdjustmentType[] {});
    }
  }

  private static final Map<String, PriceAdjustmentType> createValuesMap() {
    Map<String, PriceAdjustmentType> map = new LinkedHashMap<>();
  ...
  private static final Map<String, PriceAdjustmentTypeEnum> createEnumsMap() {
    Map<String, PriceAdjustmentTypeEnum> map = new HashMap<>();
    map.put(
  ...
  public static final class _Serializer extends StdSerializer<PriceAdjustmentType> {

    protected _Serializer() {
      super(PriceAdjustmentType.class);
    }

    @Override
    public void serialize(PriceAdjustmentType value, JsonGenerator g, SerializerProvider provider)
  ...
  @SuppressWarnings("serial")
  public static final class _Deserializer extends StdDeserializer<PriceAdjustmentType> {
    ...
    @Override
    public PriceAdjustmentType deserialize(JsonParser p, DeserializationContext ctxt)
        throws IOException, JacksonException {
      String v = p.readValueAs(new TypeReference<String>() {});
      // use the factory method to ensure we get singletons
      return PriceAdjustmentType.of(v);
    }
  }
  ...
  public enum PriceAdjustmentTypeEnum {
    ...
    private PriceAdjustmentTypeEnum(String value) {
      this.value = value;
    }
