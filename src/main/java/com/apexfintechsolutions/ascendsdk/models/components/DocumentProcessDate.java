 ...
 * DocumentProcessDate
 *
 * <p>Date that the related activities were processed
 */
public class DocumentProcessDate {
  /**
   ...
   * by itself or a year and month where the day isn't significant.
   */
  public DocumentProcessDate withDay(int day) {
    Utils.checkNotNull(day, "day");
   ...
   * by itself or a year and month where the day isn't significant.
   */
  public DocumentProcessDate withDay(Optional<Integer> day) {
    Utils.checkNotNull(day, "day");
    this.day = day;
    return this;
  }
  ...
  /** Month of a year. Must be from 1 to 12, or 0 to specify a year without a month and day. */
  public DocumentProcessDate withMonth(int month) {
    Utils.checkNotNull(month, "month");
  ...
  /** Month of a year. Must be from 1 to 12, or 0 to specify a year without a month and day. */
  public DocumentProcessDate withMonth(Optional<Integer> month) {
    Utils.checkNotNull(month, "month");
    this.month = month;
    return this;
  }
  ...
  /** Year of the date. Must be from 1 to 9999, or 0 to specify a date without a year. */
  public DocumentProcessDate withYear(int year) {
    Utils.checkNotNull(year, "year");
  ...
  /** Year of the date. Must be from 1 to 9999, or 0 to specify a date without a year. */
  public DocumentProcessDate withYear(Optional<Integer> year) {
    Utils.checkNotNull(year, "year");
    this.year = year;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DocumentProcessDate other = (DocumentProcessDate) o;
  ...
  public String toString() {
    return Utils.toString(DocumentProcessDate.class, "day", day, "month", month, "year", year);
  }
  ...
  public static final class Builder {
    ...
    public DocumentProcessDate build() {

      return new DocumentProcessDate(day, month, year);
    }
  }
}
