...
public class UploadedDate {
   ...
   * by itself or a year and month where the day isn't significant.
   */
  public UploadedDate withDay(int day) {
    Utils.checkNotNull(day, "day");
   ...
   * by itself or a year and month where the day isn't significant.
   */
  public UploadedDate withDay(Optional<Integer> day) {
    Utils.checkNotNull(day, "day");
    this.day = day;
    return this;
  }
  ...
  /** Month of a year. Must be from 1 to 12, or 0 to specify a year without a month and day. */
  public UploadedDate withMonth(int month) {
    Utils.checkNotNull(month, "month");
  ...
  /** Month of a year. Must be from 1 to 12, or 0 to specify a year without a month and day. */
  public UploadedDate withMonth(Optional<Integer> month) {
    Utils.checkNotNull(month, "month");
    this.month = month;
    return this;
  }
  ...
  /** Year of the date. Must be from 1 to 9999, or 0 to specify a date without a year. */
  public UploadedDate withYear(int year) {
    Utils.checkNotNull(year, "year");
  ...
  /** Year of the date. Must be from 1 to 9999, or 0 to specify a date without a year. */
  public UploadedDate withYear(Optional<Integer> year) {
    Utils.checkNotNull(year, "year");
    this.year = year;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UploadedDate other = (UploadedDate) o;
  ...
  public String toString() {
    return Utils.toString(UploadedDate.class, "day", day, "month", month, "year", year);
  }
  ...
  public static final class Builder {
    ...
    public UploadedDate build() {

      return new UploadedDate(day, month, year);
    }
  }
}
