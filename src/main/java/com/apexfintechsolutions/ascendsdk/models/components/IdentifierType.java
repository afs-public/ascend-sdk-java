 ...
 */
/**
 * IdentifierType - The identifier type of the asset being ordered. For Equities: only SYMBOL is
 * supported For Mutual Funds: only SYMBOL and CUSIP are supported For Fixed Income: only CUSIP and
 * ISIN are supported
 */
