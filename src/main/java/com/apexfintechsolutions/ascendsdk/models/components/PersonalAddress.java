...
/**
 * PersonalAddress - The legal street number and street name for an account Party. Required fields
 * within the `personal_address` object include: - `administrative_area` - `region_code` - 2
