 ...
 * firm account
 */
public class TransfersFeeCreate {
  /**
  ...
  /** The type of the fee being charged */
  @JsonIgnore
  public TransfersFeeCreateType type() {
    return type;
  }
   ...
   * [decimal.Decimal]: https://docs.python.org/3/library/decimal.html
   */
  public TransfersFeeCreate withAmount(DecimalCreate amount) {
    Utils.checkNotNull(amount, "amount");
    this.amount = amount;
    return this;
  }
   ...
   * client_transfer_id and account
   */
  public TransfersFeeCreate withClientTransferId(String clientTransferId) {
    Utils.checkNotNull(clientTransferId, "clientTransferId");
    this.clientTransferId = clientTransferId;
    return this;
  }
  ...
  /** Optional description information that will attach to this transaction */
  public TransfersFeeCreate withDescription(String description) {
    Utils.checkNotNull(description, "description");
  ...
  /** Optional description information that will attach to this transaction */
  public TransfersFeeCreate withDescription(Optional<String> description) {
    Utils.checkNotNull(description, "description");
    this.description = description;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TransfersFeeCreate other = (TransfersFeeCreate) o;
