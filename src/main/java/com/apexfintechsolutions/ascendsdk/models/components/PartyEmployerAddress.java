...
/**
 * PartyEmployerAddress - The data structure containing attributes describing the location of an
 * investor's employer. If input, the required fields within the `employer_address` object include:
