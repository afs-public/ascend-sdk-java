 ...
 * TransfersFeeState
 *
 * <p>The current state of the fee
 */
public class TransfersFeeState {
  ...
  @JsonInclude(Include.NON_ABSENT)
  @JsonProperty("state")
  private Optional<? extends TransfersFeeStateState> state;
  ...
  @SuppressWarnings("unchecked")
  @JsonIgnore
  public Optional<TransfersFeeStateState> state() {
    return (Optional<TransfersFeeStateState>) state;
  }
  ...
  /** The user or service that triggered the state update. */
  public TransfersFeeState withActor(String actor) {
    Utils.checkNotNull(actor, "actor");
  ...
  /** The user or service that triggered the state update. */
  public TransfersFeeState withActor(Optional<String> actor) {
    Utils.checkNotNull(actor, "actor");
    this.actor = actor;
    return this;
  }
  ...
  /** Additional description of the transfer state. */
  public TransfersFeeState withMessage(String message) {
    Utils.checkNotNull(message, "message");
  ...
  /** Additional description of the transfer state. */
  public TransfersFeeState withMessage(Optional<String> message) {
    Utils.checkNotNull(message, "message");
    this.message = message;
    return this;
  }
   ...
   * when `state` is `CANCELED`
   */
  public TransfersFeeState withMetadata(Map<String, Object> metadata) {
    Utils.checkNotNull(metadata, "metadata");
   ...
   * when `state` is `CANCELED`
   */
  public TransfersFeeState withMetadata(JsonNullable<? extends Map<String, Object>> metadata) {
    Utils.checkNotNull(metadata, "metadata");
    this.metadata = metadata;
    return this;
  }
   ...
   * - The transfer is postponed and will resume processing during the next processing window.
   */
  public TransfersFeeState withState(TransfersFeeStateState state) {
    Utils.checkNotNull(state, "state");
   ...
   * - The transfer is postponed and will resume processing during the next processing window.
   */
  public TransfersFeeState withState(Optional<? extends TransfersFeeStateState> state) {
    Utils.checkNotNull(state, "state");
    this.state = state;
    return this;
  }
  ...
  /** The time of the state update. */
  public TransfersFeeState withUpdateTime(OffsetDateTime updateTime) {
    Utils.checkNotNull(updateTime, "updateTime");
  ...
  /** The time of the state update. */
  public TransfersFeeState withUpdateTime(JsonNullable<OffsetDateTime> updateTime) {
    Utils.checkNotNull(updateTime, "updateTime");
    this.updateTime = updateTime;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TransfersFeeState other = (TransfersFeeState) o;
  ...
  public static final class Builder {
    ...
    private Optional<? extends TransfersFeeStateState> state = Optional.empty();
     ...
     * processing window.
     */
    public Builder state(TransfersFeeStateState state) {
      Utils.checkNotNull(state, "state");
      this.state = Optional.ofNullable(state);
      return this;
    }
     ...
     * processing window.
     */
    public Builder state(Optional<? extends TransfersFeeStateState> state) {
      Utils.checkNotNull(state, "state");
      this.state = state;
      return this;
    }
    ...
    public TransfersFeeState build() {

      return new TransfersFeeState(actor, message, metadata, state, updateTime);
    }
  }
}
