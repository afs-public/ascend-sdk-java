 ...
 * PartyLegalAddress
 *
 * <p>The mailing address of the legal entity. Required fields within the `legal_address` object
 * include: - `administrative_area` - `region_code` - 2 character CLDR Code - `postal_code` -
 * `locality` - `address_lines` - max 5 lines
 */
public class PartyLegalAddress {
  /**
   ...
   * parts of the address should be localities or administrative areas).
   */
  public PartyLegalAddress withAddressLines(List<String> addressLines) {
    Utils.checkNotNull(addressLines, "addressLines");
   ...
   * parts of the address should be localities or administrative areas).
   */
  public PartyLegalAddress withAddressLines(Optional<? extends List<String>> addressLines) {
    Utils.checkNotNull(addressLines, "addressLines");
    this.addressLines = addressLines;
    return this;
  }
   ...
   * Switzerland this should be left unpopulated.
   */
  public PartyLegalAddress withAdministrativeArea(String administrativeArea) {
    Utils.checkNotNull(administrativeArea, "administrativeArea");
   ...
   * Switzerland this should be left unpopulated.
   */
  public PartyLegalAddress withAdministrativeArea(Optional<String> administrativeArea) {
    Utils.checkNotNull(administrativeArea, "administrativeArea");
    this.administrativeArea = administrativeArea;
    return this;
  }
   ...
   * <p>Examples: "zh-Hant", "ja", "ja-Latn", "en".
   */
  public PartyLegalAddress withLanguageCode(String languageCode) {
    Utils.checkNotNull(languageCode, "languageCode");
   ...
   * <p>Examples: "zh-Hant", "ja", "ja-Latn", "en".
   */
  public PartyLegalAddress withLanguageCode(Optional<String> languageCode) {
    Utils.checkNotNull(languageCode, "languageCode");
    this.languageCode = languageCode;
    return this;
  }
   ...
   * fit into this structure well, leave locality empty and use address_lines.
   */
  public PartyLegalAddress withLocality(String locality) {
    Utils.checkNotNull(locality, "locality");
   ...
   * fit into this structure well, leave locality empty and use address_lines.
   */
  public PartyLegalAddress withLocality(Optional<String> locality) {
    Utils.checkNotNull(locality, "locality");
    this.locality = locality;
    return this;
  }
  ...
  /** Optional. The name of the organization at the address. */
  public PartyLegalAddress withOrganization(String organization) {
    Utils.checkNotNull(organization, "organization");
  ...
  /** Optional. The name of the organization at the address. */
  public PartyLegalAddress withOrganization(Optional<String> organization) {
    Utils.checkNotNull(organization, "organization");
    this.organization = organization;
    return this;
  }
   ...
   * the address (e.g. state/zip validation in the U.S.A.).
   */
  public PartyLegalAddress withPostalCode(String postalCode) {
    Utils.checkNotNull(postalCode, "postalCode");
   ...
   * the address (e.g. state/zip validation in the U.S.A.).
   */
  public PartyLegalAddress withPostalCode(Optional<String> postalCode) {
    Utils.checkNotNull(postalCode, "postalCode");
    this.postalCode = postalCode;
    return this;
  }
   ...
   * multiline information. For example, it might contain "care of" information.
   */
  public PartyLegalAddress withRecipients(List<String> recipients) {
    Utils.checkNotNull(recipients, "recipients");
   ...
   * multiline information. For example, it might contain "care of" information.
   */
  public PartyLegalAddress withRecipients(Optional<? extends List<String>> recipients) {
    Utils.checkNotNull(recipients, "recipients");
    this.recipients = recipients;
    return this;
  }
   ...
   * Example: "CH" for Switzerland.
   */
  public PartyLegalAddress withRegionCode(String regionCode) {
    Utils.checkNotNull(regionCode, "regionCode");
   ...
   * Example: "CH" for Switzerland.
   */
  public PartyLegalAddress withRegionCode(Optional<String> regionCode) {
    Utils.checkNotNull(regionCode, "regionCode");
    this.regionCode = regionCode;
    return this;
  }
   ...
   * <p>All new revisions **must** be backward compatible with old revisions.
   */
  public PartyLegalAddress withRevision(int revision) {
    Utils.checkNotNull(revision, "revision");
   ...
   * <p>All new revisions **must** be backward compatible with old revisions.
   */
  public PartyLegalAddress withRevision(Optional<Integer> revision) {
    Utils.checkNotNull(revision, "revision");
    this.revision = revision;
    return this;
  }
   ...
   * indicator" (Malawi) or "post office indicator" (e.g. Côte d'Ivoire).
   */
  public PartyLegalAddress withSortingCode(String sortingCode) {
    Utils.checkNotNull(sortingCode, "sortingCode");
   ...
   * indicator" (Malawi) or "post office indicator" (e.g. Côte d'Ivoire).
   */
  public PartyLegalAddress withSortingCode(Optional<String> sortingCode) {
    Utils.checkNotNull(sortingCode, "sortingCode");
    this.sortingCode = sortingCode;
    return this;
  }
   ...
   * districts.
   */
  public PartyLegalAddress withSublocality(String sublocality) {
    Utils.checkNotNull(sublocality, "sublocality");
   ...
   * districts.
   */
  public PartyLegalAddress withSublocality(Optional<String> sublocality) {
    Utils.checkNotNull(sublocality, "sublocality");
    this.sublocality = sublocality;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PartyLegalAddress other = (PartyLegalAddress) o;
  ...
  public static final class Builder {
    ...
    public PartyLegalAddress build() {

      return new PartyLegalAddress(
          addressLines,
          administrativeArea,
          languageCode,
          locality,
