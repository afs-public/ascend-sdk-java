...
/**
 * PartyLegalAddress - The mailing address of the legal entity. Required fields within the
 * `legal_address` object include: - `administrative_area` - `region_code` - 2 character CLDR Code -
