 ...
 * WireDepositState
 *
 * <p>The current state of the wire deposit
 */
public class WireDepositState {
  ...
  @JsonInclude(Include.NON_ABSENT)
  @JsonProperty("state")
  private Optional<? extends WireDepositStateState> state;
  ...
  @SuppressWarnings("unchecked")
  @JsonIgnore
  public Optional<WireDepositStateState> state() {
    return (Optional<WireDepositStateState>) state;
  }
  ...
  /** The user or service that triggered the state update. */
  public WireDepositState withActor(String actor) {
    Utils.checkNotNull(actor, "actor");
  ...
  /** The user or service that triggered the state update. */
  public WireDepositState withActor(Optional<String> actor) {
    Utils.checkNotNull(actor, "actor");
    this.actor = actor;
    return this;
  }
  ...
  /** Additional description of the transfer state. */
  public WireDepositState withMessage(String message) {
    Utils.checkNotNull(message, "message");
  ...
  /** Additional description of the transfer state. */
  public WireDepositState withMessage(Optional<String> message) {
    Utils.checkNotNull(message, "message");
    this.message = message;
    return this;
  }
   ...
   * when `state` is `CANCELED`
   */
  public WireDepositState withMetadata(Map<String, Object> metadata) {
    Utils.checkNotNull(metadata, "metadata");
   ...
   * when `state` is `CANCELED`
   */
  public WireDepositState withMetadata(JsonNullable<? extends Map<String, Object>> metadata) {
    Utils.checkNotNull(metadata, "metadata");
    this.metadata = metadata;
    return this;
  }
   ...
   * - The transfer is postponed and will resume processing during the next processing window.
   */
  public WireDepositState withState(WireDepositStateState state) {
    Utils.checkNotNull(state, "state");
   ...
   * - The transfer is postponed and will resume processing during the next processing window.
   */
  public WireDepositState withState(Optional<? extends WireDepositStateState> state) {
    Utils.checkNotNull(state, "state");
    this.state = state;
    return this;
  }
  ...
  /** The time of the state update. */
  public WireDepositState withUpdateTime(OffsetDateTime updateTime) {
    Utils.checkNotNull(updateTime, "updateTime");
  ...
  /** The time of the state update. */
  public WireDepositState withUpdateTime(JsonNullable<OffsetDateTime> updateTime) {
    Utils.checkNotNull(updateTime, "updateTime");
    this.updateTime = updateTime;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    WireDepositState other = (WireDepositState) o;
  ...
  public static final class Builder {
    ...
    private Optional<? extends WireDepositStateState> state = Optional.empty();
     ...
     * processing window.
     */
    public Builder state(WireDepositStateState state) {
      Utils.checkNotNull(state, "state");
      this.state = Optional.ofNullable(state);
      return this;
    }
     ...
     * processing window.
     */
    public Builder state(Optional<? extends WireDepositStateState> state) {
      Utils.checkNotNull(state, "state");
      this.state = state;
      return this;
    }
    ...
    public WireDepositState build() {

      return new WireDepositState(actor, message, metadata, state, updateTime);
    }
  }
}
