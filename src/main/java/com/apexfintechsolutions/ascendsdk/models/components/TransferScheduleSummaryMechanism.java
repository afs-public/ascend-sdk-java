 ...
 *
 * <p>The mechanism used for this transfer schedule
 */
@JsonDeserialize(using = TransferScheduleSummaryMechanism._Deserializer.class)
@JsonSerialize(using = TransferScheduleSummaryMechanism._Serializer.class)
public class TransferScheduleSummaryMechanism {
  ...
  // convention)
  private static final Map<String, TransferScheduleSummaryMechanism> values = createValuesMap();
  private static final Map<String, TransferScheduleSummaryMechanismEnum> enums = createEnumsMap();

  private final String value;

  private TransferScheduleSummaryMechanism(String value) {
    this.value = value;
  }

  /**
   * Returns a TransferScheduleSummaryMechanism with the given value. For a specific value the
   * returned object will always be a singleton so reference equality is satisfied when the values
   * are the same.
   *
   * @param value value to be wrapped as TransferScheduleSummaryMechanism
   */
  public static TransferScheduleSummaryMechanism of(String value) {
    synchronized (TransferScheduleSummaryMechanism.class) {
      return values.computeIfAbsent(value, v -> new TransferScheduleSummaryMechanism(v));
    }
  }
  ...
  public Optional<TransferScheduleSummaryMechanismEnum> asEnum() {
  ...
  public boolean equals(java.lang.Object obj) {
    ...
    TransferScheduleSummaryMechanism other = (TransferScheduleSummaryMechanism) obj;
    return Objects.equals(value, other.value);
  }

  @Override
  public String toString() {
    return "TransferScheduleSummaryMechanism [value=" + value + "]";
  }

  // return an array just like an enum
  public static TransferScheduleSummaryMechanism[] values() {
    synchronized (TransferScheduleSummaryMechanism.class) {
      return values.values().toArray(new TransferScheduleSummaryMechanism[] {});
    }
  }
  ...
  public static final class _Serializer extends StdSerializer<TransferScheduleSummaryMechanism> {

    protected _Serializer() {
      super(TransferScheduleSummaryMechanism.class);
    }

    @Override
    public void serialize(
        TransferScheduleSummaryMechanism value, JsonGenerator g, SerializerProvider provider)
  ...
  public static final class _Deserializer
      extends StdDeserializer<TransferScheduleSummaryMechanism> {
    ...
    @Override
    public TransferScheduleSummaryMechanism deserialize(JsonParser p, DeserializationContext ctxt)
        throws IOException, JacksonException {
      String v = p.readValueAs(new TypeReference<String>() {});
      // use the factory method to ensure we get singletons
      return TransferScheduleSummaryMechanism.of(v);
    }
  }
  ...
  public enum TransferScheduleSummaryMechanismEnum {
    ...
    private TransferScheduleSummaryMechanismEnum(String value) {
      this.value = value;
    }
