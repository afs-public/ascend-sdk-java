 ...
 * Geolocation
 *
 * <p>Geographic location coordinates of the end-user's device
 */
public class Geolocation {
  ...
  /** The latitude in degrees. It must be in the range [-90.0, +90.0]. */
  public Geolocation withLatitude(Optional<Double> latitude) {
    Utils.checkNotNull(latitude, "latitude");
    this.latitude = latitude;
    return this;
  }
  ...
  /** The longitude in degrees. It must be in the range [-180.0, +180.0]. */
  public Geolocation withLongitude(Optional<Double> longitude) {
    Utils.checkNotNull(longitude, "longitude");
    this.longitude = longitude;
    return this;
  }
  ...
  public String toString() {
    return Utils.toString(Geolocation.class, "latitude", latitude, "longitude", longitude);
  }
