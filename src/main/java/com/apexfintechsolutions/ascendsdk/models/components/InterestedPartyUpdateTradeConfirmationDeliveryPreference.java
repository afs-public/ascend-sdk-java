...
public class InterestedPartyUpdateTradeConfirmationDeliveryPreference {
  ...
  public static final InterestedPartyUpdateTradeConfirmationDeliveryPreference SUPPRESS =
      new InterestedPartyUpdateTradeConfirmationDeliveryPreference("SUPPRESS");
  ...
  // convention)
  private static final Map<String, InterestedPartyUpdateTradeConfirmationDeliveryPreference>
  ...
  private InterestedPartyUpdateTradeConfirmationDeliveryPreference(String value) {
    this.value = value;
  }

  /**
   * Returns a InterestedPartyUpdateTradeConfirmationDeliveryPreference with the given value. For a
   ...
   *
   * @param value value to be wrapped as InterestedPartyUpdateTradeConfirmationDeliveryPreference
   */
  public static InterestedPartyUpdateTradeConfirmationDeliveryPreference of(String value) {
    synchronized (InterestedPartyUpdateTradeConfirmationDeliveryPreference.class) {
      return values.computeIfAbsent(
          value, v -> new InterestedPartyUpdateTradeConfirmationDeliveryPreference(v));
    }
  }
  ...
  public Optional<InterestedPartyUpdateTradeConfirmationDeliveryPreferenceEnum> asEnum() {
  ...
  public boolean equals(java.lang.Object obj) {
    ...
    InterestedPartyUpdateTradeConfirmationDeliveryPreference other =
        (InterestedPartyUpdateTradeConfirmationDeliveryPreference) obj;
    return Objects.equals(value, other.value);
  }

  @Override
  public String toString() {
    return "InterestedPartyUpdateTradeConfirmationDeliveryPreference [value=" + value + "]";
  }

  // return an array just like an enum
  public static InterestedPartyUpdateTradeConfirmationDeliveryPreference[] values() {
    synchronized (InterestedPartyUpdateTradeConfirmationDeliveryPreference.class) {
      return values
          .values()
          .toArray(new InterestedPartyUpdateTradeConfirmationDeliveryPreference[] {});
    }
  }
  ...
  public static final class _Serializer
      extends StdSerializer<InterestedPartyUpdateTradeConfirmationDeliveryPreference> {

    protected _Serializer() {
      super(InterestedPartyUpdateTradeConfirmationDeliveryPreference.class);
    }

    @Override
    public void serialize(
        InterestedPartyUpdateTradeConfirmationDeliveryPreference value,
        JsonGenerator g,
  ...
  public static final class _Deserializer
      extends StdDeserializer<InterestedPartyUpdateTradeConfirmationDeliveryPreference> {
    ...
    @Override
    public InterestedPartyUpdateTradeConfirmationDeliveryPreference deserialize(
        JsonParser p, DeserializationContext ctxt) throws IOException, JacksonException {
      String v = p.readValueAs(new TypeReference<String>() {});
      // use the factory method to ensure we get singletons
      return InterestedPartyUpdateTradeConfirmationDeliveryPreference.of(v);
    }
  }
  ...
  public enum InterestedPartyUpdateTradeConfirmationDeliveryPreferenceEnum {
    ...
    private InterestedPartyUpdateTradeConfirmationDeliveryPreferenceEnum(String value) {
      this.value = value;
    }
