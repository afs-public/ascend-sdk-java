 ...
 * <p>legal address
 */
public class InvestigationLegalAddress {
  /**
  ...
  @JsonCreator
  public InvestigationLegalAddress(
   ...
   * parts of the address should be localities or administrative areas).
   */
  public InvestigationLegalAddress withAddressLines(List<String> addressLines) {
    Utils.checkNotNull(addressLines, "addressLines");
   ...
   * parts of the address should be localities or administrative areas).
   */
  public InvestigationLegalAddress withAddressLines(Optional<? extends List<String>> addressLines) {
    Utils.checkNotNull(addressLines, "addressLines");
    this.addressLines = addressLines;
    return this;
  }
   ...
   * Switzerland this should be left unpopulated.
   */
  public InvestigationLegalAddress withAdministrativeArea(String administrativeArea) {
    Utils.checkNotNull(administrativeArea, "administrativeArea");
   ...
   * Switzerland this should be left unpopulated.
   */
  public InvestigationLegalAddress withAdministrativeArea(Optional<String> administrativeArea) {
    Utils.checkNotNull(administrativeArea, "administrativeArea");
    this.administrativeArea = administrativeArea;
    return this;
  }
   ...
   * <p>Examples: "zh-Hant", "ja", "ja-Latn", "en".
   */
  public InvestigationLegalAddress withLanguageCode(String languageCode) {
    Utils.checkNotNull(languageCode, "languageCode");
   ...
   * <p>Examples: "zh-Hant", "ja", "ja-Latn", "en".
   */
  public InvestigationLegalAddress withLanguageCode(Optional<String> languageCode) {
    Utils.checkNotNull(languageCode, "languageCode");
    this.languageCode = languageCode;
    return this;
  }
   ...
   * fit into this structure well, leave locality empty and use address_lines.
   */
  public InvestigationLegalAddress withLocality(String locality) {
    Utils.checkNotNull(locality, "locality");
   ...
   * fit into this structure well, leave locality empty and use address_lines.
   */
  public InvestigationLegalAddress withLocality(Optional<String> locality) {
    Utils.checkNotNull(locality, "locality");
    this.locality = locality;
    return this;
  }
  ...
  /** Optional. The name of the organization at the address. */
  public InvestigationLegalAddress withOrganization(String organization) {
    Utils.checkNotNull(organization, "organization");
  ...
  /** Optional. The name of the organization at the address. */
  public InvestigationLegalAddress withOrganization(Optional<String> organization) {
    Utils.checkNotNull(organization, "organization");
    this.organization = organization;
    return this;
  }
   ...
   * the address (e.g. state/zip validation in the U.S.A.).
   */
  public InvestigationLegalAddress withPostalCode(String postalCode) {
    Utils.checkNotNull(postalCode, "postalCode");
   ...
   * the address (e.g. state/zip validation in the U.S.A.).
   */
  public InvestigationLegalAddress withPostalCode(Optional<String> postalCode) {
    Utils.checkNotNull(postalCode, "postalCode");
    this.postalCode = postalCode;
    return this;
  }
   ...
   * multiline information. For example, it might contain "care of" information.
   */
  public InvestigationLegalAddress withRecipients(List<String> recipients) {
    Utils.checkNotNull(recipients, "recipients");
   ...
   * multiline information. For example, it might contain "care of" information.
   */
  public InvestigationLegalAddress withRecipients(Optional<? extends List<String>> recipients) {
    Utils.checkNotNull(recipients, "recipients");
    this.recipients = recipients;
    return this;
  }
   ...
   * Example: "CH" for Switzerland.
   */
  public InvestigationLegalAddress withRegionCode(String regionCode) {
    Utils.checkNotNull(regionCode, "regionCode");
   ...
   * Example: "CH" for Switzerland.
   */
  public InvestigationLegalAddress withRegionCode(Optional<String> regionCode) {
    Utils.checkNotNull(regionCode, "regionCode");
    this.regionCode = regionCode;
    return this;
  }
   ...
   * <p>All new revisions **must** be backward compatible with old revisions.
   */
  public InvestigationLegalAddress withRevision(int revision) {
    Utils.checkNotNull(revision, "revision");
   ...
   * <p>All new revisions **must** be backward compatible with old revisions.
   */
  public InvestigationLegalAddress withRevision(Optional<Integer> revision) {
    Utils.checkNotNull(revision, "revision");
    this.revision = revision;
    return this;
  }
   ...
   * indicator" (Malawi) or "post office indicator" (e.g. Côte d'Ivoire).
   */
  public InvestigationLegalAddress withSortingCode(String sortingCode) {
    Utils.checkNotNull(sortingCode, "sortingCode");
   ...
   * indicator" (Malawi) or "post office indicator" (e.g. Côte d'Ivoire).
   */
  public InvestigationLegalAddress withSortingCode(Optional<String> sortingCode) {
    Utils.checkNotNull(sortingCode, "sortingCode");
    this.sortingCode = sortingCode;
    return this;
  }
   ...
   * districts.
   */
  public InvestigationLegalAddress withSublocality(String sublocality) {
    Utils.checkNotNull(sublocality, "sublocality");
   ...
   * districts.
   */
  public InvestigationLegalAddress withSublocality(Optional<String> sublocality) {
    Utils.checkNotNull(sublocality, "sublocality");
    this.sublocality = sublocality;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    InvestigationLegalAddress other = (InvestigationLegalAddress) o;
  ...
  public String toString() {
    return Utils.toString(
        InvestigationLegalAddress.class,
        "addressLines",
        addressLines,
        "administrativeArea",
        administrativeArea,
  ...
  public static final class Builder {
    ...
    public InvestigationLegalAddress build() {

      return new InvestigationLegalAddress(
          addressLines,
          administrativeArea,
          languageCode,
          locality,
