...
/**
 * PartyMailingAddress - The object containing data for the purpose of delivery physical mailings to
 * a party; Typically used for statements, account updates, tax documents, and other postal
 * mailings; May also be used as an alternative identity verification address to personalAddress.
 * Required fields within the `mailing_address` object include: - `administrative_area` -
