...
/**
 * PostalAddressCreate - Represents a postal address, e.g. for postal delivery or payments
 ...
 */
public class PostalAddressCreate {
   ...
   * parts of the address should be localities or administrative areas).
   */
  public PostalAddressCreate withAddressLines(List<String> addressLines) {
    Utils.checkNotNull(addressLines, "addressLines");
   ...
   * parts of the address should be localities or administrative areas).
   */
  public PostalAddressCreate withAddressLines(Optional<? extends List<String>> addressLines) {
    Utils.checkNotNull(addressLines, "addressLines");
    this.addressLines = addressLines;
    return this;
  }
   ...
   * Switzerland this should be left unpopulated.
   */
  public PostalAddressCreate withAdministrativeArea(String administrativeArea) {
    Utils.checkNotNull(administrativeArea, "administrativeArea");
   ...
   * Switzerland this should be left unpopulated.
   */
  public PostalAddressCreate withAdministrativeArea(Optional<String> administrativeArea) {
    Utils.checkNotNull(administrativeArea, "administrativeArea");
    this.administrativeArea = administrativeArea;
    return this;
  }
   ...
   * <p>Examples: "zh-Hant", "ja", "ja-Latn", "en".
   */
  public PostalAddressCreate withLanguageCode(String languageCode) {
    Utils.checkNotNull(languageCode, "languageCode");
   ...
   * <p>Examples: "zh-Hant", "ja", "ja-Latn", "en".
   */
  public PostalAddressCreate withLanguageCode(Optional<String> languageCode) {
    Utils.checkNotNull(languageCode, "languageCode");
    this.languageCode = languageCode;
    return this;
  }
   ...
   * fit into this structure well, leave locality empty and use address_lines.
   */
  public PostalAddressCreate withLocality(String locality) {
    Utils.checkNotNull(locality, "locality");
   ...
   * fit into this structure well, leave locality empty and use address_lines.
   */
  public PostalAddressCreate withLocality(Optional<String> locality) {
    Utils.checkNotNull(locality, "locality");
    this.locality = locality;
    return this;
  }
  ...
  /** Optional. The name of the organization at the address. */
  public PostalAddressCreate withOrganization(String organization) {
    Utils.checkNotNull(organization, "organization");
  ...
  /** Optional. The name of the organization at the address. */
  public PostalAddressCreate withOrganization(Optional<String> organization) {
    Utils.checkNotNull(organization, "organization");
    this.organization = organization;
    return this;
  }
   ...
   * the address (e.g. state/zip validation in the U.S.A.).
   */
  public PostalAddressCreate withPostalCode(String postalCode) {
    Utils.checkNotNull(postalCode, "postalCode");
   ...
   * the address (e.g. state/zip validation in the U.S.A.).
   */
  public PostalAddressCreate withPostalCode(Optional<String> postalCode) {
    Utils.checkNotNull(postalCode, "postalCode");
    this.postalCode = postalCode;
    return this;
  }
   ...
   * multiline information. For example, it might contain "care of" information.
   */
  public PostalAddressCreate withRecipients(List<String> recipients) {
    Utils.checkNotNull(recipients, "recipients");
   ...
   * multiline information. For example, it might contain "care of" information.
   */
  public PostalAddressCreate withRecipients(Optional<? extends List<String>> recipients) {
    Utils.checkNotNull(recipients, "recipients");
    this.recipients = recipients;
    return this;
  }
   ...
   * Example: "CH" for Switzerland.
   */
  public PostalAddressCreate withRegionCode(String regionCode) {
    Utils.checkNotNull(regionCode, "regionCode");
   ...
   * Example: "CH" for Switzerland.
   */
  public PostalAddressCreate withRegionCode(Optional<String> regionCode) {
    Utils.checkNotNull(regionCode, "regionCode");
    this.regionCode = regionCode;
    return this;
  }
   ...
   * <p>All new revisions **must** be backward compatible with old revisions.
   */
  public PostalAddressCreate withRevision(int revision) {
    Utils.checkNotNull(revision, "revision");
   ...
   * <p>All new revisions **must** be backward compatible with old revisions.
   */
  public PostalAddressCreate withRevision(Optional<Integer> revision) {
    Utils.checkNotNull(revision, "revision");
    this.revision = revision;
    return this;
  }
   ...
   * indicator" (Malawi) or "post office indicator" (e.g. Côte d'Ivoire).
   */
  public PostalAddressCreate withSortingCode(String sortingCode) {
    Utils.checkNotNull(sortingCode, "sortingCode");
   ...
   * indicator" (Malawi) or "post office indicator" (e.g. Côte d'Ivoire).
   */
  public PostalAddressCreate withSortingCode(Optional<String> sortingCode) {
    Utils.checkNotNull(sortingCode, "sortingCode");
    this.sortingCode = sortingCode;
    return this;
  }
   ...
   * districts.
   */
  public PostalAddressCreate withSublocality(String sublocality) {
    Utils.checkNotNull(sublocality, "sublocality");
   ...
   * districts.
   */
  public PostalAddressCreate withSublocality(Optional<String> sublocality) {
    Utils.checkNotNull(sublocality, "sublocality");
    this.sublocality = sublocality;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PostalAddressCreate other = (PostalAddressCreate) o;
  ...
  public static final class Builder {
    ...
    public PostalAddressCreate build() {
      return new PostalAddressCreate(
          addressLines,
          administrativeArea,
          languageCode,
          locality,
