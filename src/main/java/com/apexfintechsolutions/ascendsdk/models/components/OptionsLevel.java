 ...
 */
@JsonDeserialize(using = OptionsLevel._Deserializer.class)
@JsonSerialize(using = OptionsLevel._Serializer.class)
public class OptionsLevel {
  ...
  // convention)
  private static final Map<String, OptionsLevel> values = createValuesMap();
  private static final Map<String, OptionsLevelEnum> enums = createEnumsMap();

  private final String value;

  private OptionsLevel(String value) {
    this.value = value;
  }

  /**
   * Returns a OptionsLevel with the given value. For a specific value the returned object will
   * always be a singleton so reference equality is satisfied when the values are the same.
   *
   * @param value value to be wrapped as OptionsLevel
   */
  public static OptionsLevel of(String value) {
    synchronized (OptionsLevel.class) {
      return values.computeIfAbsent(value, v -> new OptionsLevel(v));
    }
  }
  ...
  public Optional<OptionsLevelEnum> asEnum() {
  ...
  public boolean equals(java.lang.Object obj) {
    ...
    OptionsLevel other = (OptionsLevel) obj;
    return Objects.equals(value, other.value);
  }

  @Override
  public String toString() {
    return "OptionsLevel [value=" + value + "]";
  }

  // return an array just like an enum
  public static OptionsLevel[] values() {
    synchronized (OptionsLevel.class) {
      return values.values().toArray(new OptionsLevel[] {});
    }
  }
  ...
  public static final class _Serializer extends StdSerializer<OptionsLevel> {

    protected _Serializer() {
      super(OptionsLevel.class);
    }

    @Override
    public void serialize(OptionsLevel value, JsonGenerator g, SerializerProvider provider)
  ...
  @SuppressWarnings("serial")
  public static final class _Deserializer extends StdDeserializer<OptionsLevel> {
    ...
    @Override
    public OptionsLevel deserialize(JsonParser p, DeserializationContext ctxt)
        throws IOException, JacksonException {
      String v = p.readValueAs(new TypeReference<String>() {});
      // use the factory method to ensure we get singletons
      return OptionsLevel.of(v);
    }
  }
  ...
  public enum OptionsLevelEnum {
    ...
    private OptionsLevelEnum(String value) {
      this.value = value;
    }
