...
public class SDKError extends Exception {
  ...
  public SDKError(HttpResponse<InputStream> rawResponse, int code, String message, byte[] body) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return java.util.Objects.deepEquals(this.rawResponse, other.rawResponse)
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(rawResponse, code, message, body);
  }

  @Override
  public String toString() {
    return Utils.toString(
        SDKError.class, "rawResponse", rawResponse, "code", code, "message", message, "body", body);
  }
