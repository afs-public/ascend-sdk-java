...
public class AccountTransfersListTransfersRequestBuilder {
  ...
  public AccountTransfersListTransfersRequestBuilder retryConfig(RetryConfig retryConfig) {
    Utils.checkNotNull(retryConfig, "retryConfig");
    this.retryConfig = Optional.of(retryConfig);
    return this;
  }

  public AccountTransfersListTransfersRequestBuilder retryConfig(
   ...
   *
   * <pre><code>
   * for (AccountTransfersListTransfersResponse page : builder.callAsIterable()) {
   *     // Process each page
   * }
   * </code></pre>
   *
   ...
   */
  public Iterable<AccountTransfersListTransfersResponse> callAsIterable() {
    Optional<Options> options = Optional.of(Options.builder().retryConfig(retryConfig).build());
    ...
    Iterator<HttpResponse<InputStream>> iterator =
        new Paginator<>(
            ...
            AccountTransfersListTransfersRequest::withPageToken,
  ...
  public Stream<AccountTransfersListTransfersResponse> callAsStream() {
