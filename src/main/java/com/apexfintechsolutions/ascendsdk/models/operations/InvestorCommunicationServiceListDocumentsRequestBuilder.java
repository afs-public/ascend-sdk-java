...
public class InvestorCommunicationServiceListDocumentsRequestBuilder {
  ...
  public InvestorCommunicationServiceListDocumentsRequestBuilder retryConfig(
  ...
  private InvestorCommunicationServiceListDocumentsRequest buildRequest() {

    InvestorCommunicationServiceListDocumentsRequest request =
        new InvestorCommunicationServiceListDocumentsRequest(pageSize, pageToken, filter);
  ...
  public InvestorCommunicationServiceListDocumentsResponse call() throws Exception {
    ...
    InvestorCommunicationServiceListDocumentsRequest request = buildRequest();
   ...
   *
   * <pre><code>
   * for (InvestorCommunicationServiceListDocumentsResponse page : builder.callAsIterable()) {
   *     // Process each page
   * }
   * </code></pre>
   *
   ...
   */
  public Iterable<InvestorCommunicationServiceListDocumentsResponse> callAsIterable() {
    Optional<Options> options = Optional.of(Options.builder().retryConfig(retryConfig).build());
    ...
    Iterator<HttpResponse<InputStream>> iterator =
        new Paginator<>(
            ...
            InvestorCommunicationServiceListDocumentsRequest::withPageToken,
  ...
  public Stream<InvestorCommunicationServiceListDocumentsResponse> callAsStream() {
