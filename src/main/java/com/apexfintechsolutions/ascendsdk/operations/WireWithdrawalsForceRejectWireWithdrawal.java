...
public class WireWithdrawalsForceRejectWireWithdrawal {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "forceRejectWireWithdrawalRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(WireWithdrawalsForceRejectWireWithdrawalRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              WireWithdrawalsForceRejectWireWithdrawalRequest.class,
              new TypeReference<WireWithdrawalsForceRejectWireWithdrawalRequest>() {});
    ...
    public HttpResponse<InputStream> doRequest(
        WireWithdrawalsForceRejectWireWithdrawalRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public WireWithdrawalsForceRejectWireWithdrawalResponse handleResponse(
      ...
      WireWithdrawalsForceRejectWireWithdrawalResponse.Builder resBuilder =
          WireWithdrawalsForceRejectWireWithdrawalResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      WireWithdrawalsForceRejectWireWithdrawalResponse res = resBuilder.build();
