...
public class AchWithdrawalsGetAchWithdrawal {
  ...
  public static class Sync extends Base
      implements RequestOperation<
          AchWithdrawalsGetAchWithdrawalRequest, AchWithdrawalsGetAchWithdrawalResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(AchWithdrawalsGetAchWithdrawalRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, AchWithdrawalsGetAchWithdrawalRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AchWithdrawalsGetAchWithdrawalRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public AchWithdrawalsGetAchWithdrawalResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AchWithdrawalsGetAchWithdrawalResponse.Builder resBuilder =
          AchWithdrawalsGetAchWithdrawalResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AchWithdrawalsGetAchWithdrawalResponse res = resBuilder.build();
