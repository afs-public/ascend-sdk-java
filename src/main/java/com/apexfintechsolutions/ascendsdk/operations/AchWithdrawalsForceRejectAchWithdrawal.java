...
public class AchWithdrawalsForceRejectAchWithdrawal {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "forceRejectAchWithdrawalRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(AchWithdrawalsForceRejectAchWithdrawalRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              AchWithdrawalsForceRejectAchWithdrawalRequest.class,
              new TypeReference<AchWithdrawalsForceRejectAchWithdrawalRequest>() {});
    ...
    public HttpResponse<InputStream> doRequest(
        AchWithdrawalsForceRejectAchWithdrawalRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public AchWithdrawalsForceRejectAchWithdrawalResponse handleResponse(
      ...
      AchWithdrawalsForceRejectAchWithdrawalResponse.Builder resBuilder =
          AchWithdrawalsForceRejectAchWithdrawalResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AchWithdrawalsForceRejectAchWithdrawalResponse res = resBuilder.build();
