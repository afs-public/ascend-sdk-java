...
public class AccountsGetLegalEntity {
  ...
  public static class Sync extends Base
      implements RequestOperation<AccountsGetLegalEntityRequest, AccountsGetLegalEntityResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(AccountsGetLegalEntityRequest request) throws Exception {
      HttpRequest req = buildRequest(request, AccountsGetLegalEntityRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountsGetLegalEntityRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public AccountsGetLegalEntityResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AccountsGetLegalEntityResponse.Builder resBuilder =
          AccountsGetLegalEntityResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsGetLegalEntityResponse res = resBuilder.build();
