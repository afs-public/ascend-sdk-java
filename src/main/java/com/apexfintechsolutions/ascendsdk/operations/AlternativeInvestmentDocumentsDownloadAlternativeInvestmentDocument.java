...
public class AlternativeInvestmentDocumentsDownloadAlternativeInvestmentDocument {
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/trading/v1/assets/{asset_id}/alternativeInvestmentDocuments/{alternativeInvestmentDocument_id}:download",
              request,
              null);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(
    ...
    public AlternativeInvestmentDocumentsDownloadAlternativeInvestmentDocumentResponse
        handleResponse(HttpResponse<InputStream> response) throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AlternativeInvestmentDocumentsDownloadAlternativeInvestmentDocumentResponse.Builder
          resBuilder =
              AlternativeInvestmentDocumentsDownloadAlternativeInvestmentDocumentResponse.builder()
      ...
      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          DownloadAlternativeInvestmentDocumentResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withDownloadAlternativeInvestmentDocumentResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
