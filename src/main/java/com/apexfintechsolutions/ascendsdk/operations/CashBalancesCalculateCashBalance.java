...
public class CashBalancesCalculateCashBalance {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(CashBalancesCalculateCashBalanceRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, CashBalancesCalculateCashBalanceRequest.class);
