...
public class CashBalancesCalculateCashBalance {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(CashBalancesCalculateCashBalanceRequest request) throws Exception {
      String url =
          Utils.generateURL(
  ...
  public static class Sync extends Base
    ...
    @Override
    public HttpResponse<InputStream> doRequest(CashBalancesCalculateCashBalanceRequest request)
        throws Exception {
    ...
    @Override
    public CashBalancesCalculateCashBalanceResponse handleResponse(
      ...
      CashBalancesCalculateCashBalanceResponse.Builder resBuilder =
          CashBalancesCalculateCashBalanceResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      CashBalancesCalculateCashBalanceResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          CalculateCashBalanceResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withCalculateCashBalanceResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
