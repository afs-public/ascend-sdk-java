...
public class AccountsEndLargeTrader1 {
  ...
  public static class Sync extends Base
      implements RequestOperation<AccountsEndLargeTrader1Request, AccountsEndLargeTrader1Response> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(AccountsEndLargeTrader1Request request) throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              AccountsEndLargeTrader1Request.class,
              new TypeReference<AccountsEndLargeTrader1Request>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountsEndLargeTrader1Request request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public AccountsEndLargeTrader1Response handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AccountsEndLargeTrader1Response.Builder resBuilder =
          AccountsEndLargeTrader1Response.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsEndLargeTrader1Response res = resBuilder.build();
