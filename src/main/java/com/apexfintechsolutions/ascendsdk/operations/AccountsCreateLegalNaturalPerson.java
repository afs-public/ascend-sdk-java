...
public class AccountsCreateLegalNaturalPerson {
  ...
  public static class Sync extends Base
      implements RequestOperation<
          LegalNaturalPersonCreate, AccountsCreateLegalNaturalPersonResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(LegalNaturalPersonCreate request) throws Exception {
      HttpRequest req = buildRequest(request, new TypeReference<LegalNaturalPersonCreate>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(LegalNaturalPersonCreate request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public AccountsCreateLegalNaturalPersonResponse handleResponse(
      ...
      AccountsCreateLegalNaturalPersonResponse.Builder resBuilder =
          AccountsCreateLegalNaturalPersonResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsCreateLegalNaturalPersonResponse res = resBuilder.build();
