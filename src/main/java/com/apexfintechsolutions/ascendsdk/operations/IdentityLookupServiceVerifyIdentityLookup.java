...
public class IdentityLookupServiceVerifyIdentityLookup {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "IdentityLookupService_VerifyIdentityLookup",
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/cip/v1/correspondents/{correspondent_id}/identityLookups/{identityLookup_id}:verify",
              request,
              null);
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "verifyIdentityLookupRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(IdentityLookupServiceVerifyIdentityLookupRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              IdentityLookupServiceVerifyIdentityLookupRequest.class,
              new TypeReference<IdentityLookupServiceVerifyIdentityLookupRequest>() {});
    ...
    public HttpResponse<InputStream> doRequest(
        IdentityLookupServiceVerifyIdentityLookupRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public IdentityLookupServiceVerifyIdentityLookupResponse handleResponse(
      ...
      IdentityLookupServiceVerifyIdentityLookupResponse.Builder resBuilder =
          IdentityLookupServiceVerifyIdentityLookupResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      IdentityLookupServiceVerifyIdentityLookupResponse res = resBuilder.build();
