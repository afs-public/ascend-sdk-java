...
public class AchWithdrawalsCancelAchWithdrawal {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "cancelAchWithdrawalRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(AchWithdrawalsCancelAchWithdrawalRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              AchWithdrawalsCancelAchWithdrawalRequest.class,
              new TypeReference<AchWithdrawalsCancelAchWithdrawalRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AchWithdrawalsCancelAchWithdrawalRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public AchWithdrawalsCancelAchWithdrawalResponse handleResponse(
      ...
      AchWithdrawalsCancelAchWithdrawalResponse.Builder resBuilder =
          AchWithdrawalsCancelAchWithdrawalResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AchWithdrawalsCancelAchWithdrawalResponse res = resBuilder.build();
