...
public class AccountsAssignLargeTraderLegalEntity {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(AccountsAssignLargeTraderLegalEntityRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              AccountsAssignLargeTraderLegalEntityRequest.class,
              new TypeReference<AccountsAssignLargeTraderLegalEntityRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountsAssignLargeTraderLegalEntityRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public AccountsAssignLargeTraderLegalEntityResponse handleResponse(
      ...
      AccountsAssignLargeTraderLegalEntityResponse.Builder resBuilder =
          AccountsAssignLargeTraderLegalEntityResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsAssignLargeTraderLegalEntityResponse res = resBuilder.build();
