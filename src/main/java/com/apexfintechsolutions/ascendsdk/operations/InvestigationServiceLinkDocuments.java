...
public class InvestigationServiceLinkDocuments {
  ...
  abstract static class Base {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "linkDocumentsRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(InvestigationServiceLinkDocumentsRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              InvestigationServiceLinkDocumentsRequest.class,
              new TypeReference<InvestigationServiceLinkDocumentsRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(InvestigationServiceLinkDocumentsRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public InvestigationServiceLinkDocumentsResponse handleResponse(
      ...
      InvestigationServiceLinkDocumentsResponse.Builder resBuilder =
          InvestigationServiceLinkDocumentsResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      InvestigationServiceLinkDocumentsResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          LinkDocumentsResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withLinkDocumentsResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
