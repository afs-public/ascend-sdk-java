...
public class AchWithdrawalsForceReturnAchWithdrawal {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "forceReturnAchWithdrawalRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(AchWithdrawalsForceReturnAchWithdrawalRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              AchWithdrawalsForceReturnAchWithdrawalRequest.class,
              new TypeReference<AchWithdrawalsForceReturnAchWithdrawalRequest>() {});
    ...
    public HttpResponse<InputStream> doRequest(
        AchWithdrawalsForceReturnAchWithdrawalRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public AchWithdrawalsForceReturnAchWithdrawalResponse handleResponse(
      ...
      AchWithdrawalsForceReturnAchWithdrawalResponse.Builder resBuilder =
          AchWithdrawalsForceReturnAchWithdrawalResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AchWithdrawalsForceReturnAchWithdrawalResponse res = resBuilder.build();
