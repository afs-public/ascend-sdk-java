...
public class BankRelationshipsVerifyMicroDeposits {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "verifyMicroDepositsRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(BankRelationshipsVerifyMicroDepositsRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              BankRelationshipsVerifyMicroDepositsRequest.class,
              new TypeReference<BankRelationshipsVerifyMicroDepositsRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(BankRelationshipsVerifyMicroDepositsRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public BankRelationshipsVerifyMicroDepositsResponse handleResponse(
      ...
      BankRelationshipsVerifyMicroDepositsResponse.Builder resBuilder =
          BankRelationshipsVerifyMicroDepositsResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      BankRelationshipsVerifyMicroDepositsResponse res = resBuilder.build();
