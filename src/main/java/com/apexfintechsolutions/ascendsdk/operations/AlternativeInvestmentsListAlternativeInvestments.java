...
public class AlternativeInvestmentsListAlternativeInvestments {
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/trading/v1/assets/{asset_id}/alternativeInvestments",
              request,
              null);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(
        AlternativeInvestmentsListAlternativeInvestmentsRequest request) throws Exception {
      HttpRequest req =
          buildRequest(request, AlternativeInvestmentsListAlternativeInvestmentsRequest.class);
    ...
    @Override
    public AlternativeInvestmentsListAlternativeInvestmentsResponse handleResponse(
      ...
      AlternativeInvestmentsListAlternativeInvestmentsResponse.Builder resBuilder =
          AlternativeInvestmentsListAlternativeInvestmentsResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AlternativeInvestmentsListAlternativeInvestmentsResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListAlternativeInvestmentsResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListAlternativeInvestmentsResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
