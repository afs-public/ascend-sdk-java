...
public class AchDepositSchedulesCreateAchDepositSchedule {
  ...
  abstract static class Base {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "achDepositScheduleCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(AchDepositSchedulesCreateAchDepositScheduleRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              AchDepositSchedulesCreateAchDepositScheduleRequest.class,
              new TypeReference<AchDepositSchedulesCreateAchDepositScheduleRequest>() {});
    ...
    public HttpResponse<InputStream> doRequest(
        AchDepositSchedulesCreateAchDepositScheduleRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public AchDepositSchedulesCreateAchDepositScheduleResponse handleResponse(
      ...
      AchDepositSchedulesCreateAchDepositScheduleResponse.Builder resBuilder =
          AchDepositSchedulesCreateAchDepositScheduleResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AchDepositSchedulesCreateAchDepositScheduleResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          AchDepositSchedule out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withAchDepositSchedule(out);
          return res;
        } else {
          throw new SDKError(
              response,
