...
public class WireWithdrawalSchedulesUpdateWireWithdrawalSchedule {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(WireWithdrawalSchedulesUpdateWireWithdrawalScheduleRequest request)
        throws Exception {
      String url =
          Utils.generateURL(
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "wireWithdrawalScheduleUpdate", "json", false);
  ...
  public static class Sync extends Base
    ...
    public HttpResponse<InputStream> doRequest(
        WireWithdrawalSchedulesUpdateWireWithdrawalScheduleRequest request) throws Exception {
    ...
    @Override
    public WireWithdrawalSchedulesUpdateWireWithdrawalScheduleResponse handleResponse(
      ...
      WireWithdrawalSchedulesUpdateWireWithdrawalScheduleResponse.Builder resBuilder =
          WireWithdrawalSchedulesUpdateWireWithdrawalScheduleResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      WireWithdrawalSchedulesUpdateWireWithdrawalScheduleResponse res = resBuilder.build();
