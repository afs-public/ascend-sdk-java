...
public class SubscriberGetPushSubscriptionDelivery {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(SubscriberGetPushSubscriptionDeliveryRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, SubscriberGetPushSubscriptionDeliveryRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(SubscriberGetPushSubscriptionDeliveryRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public SubscriberGetPushSubscriptionDeliveryResponse handleResponse(
      ...
      SubscriberGetPushSubscriptionDeliveryResponse.Builder resBuilder =
          SubscriberGetPushSubscriptionDeliveryResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      SubscriberGetPushSubscriptionDeliveryResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          PushSubscriptionDelivery out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withPushSubscriptionDelivery(out);
          return res;
        } else {
          throw new SDKError(
              response,
