...
public class PositionJournalsForceRejectPositionJournal {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "PositionJournals_ForceRejectPositionJournal",
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/transfers/v1/positionJournals/{positionJournal_id}:forceReject",
              request,
              null);
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "forceRejectPositionJournalRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(PositionJournalsForceRejectPositionJournalRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              PositionJournalsForceRejectPositionJournalRequest.class,
              new TypeReference<PositionJournalsForceRejectPositionJournalRequest>() {});
    ...
    public HttpResponse<InputStream> doRequest(
        PositionJournalsForceRejectPositionJournalRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public PositionJournalsForceRejectPositionJournalResponse handleResponse(
      ...
      PositionJournalsForceRejectPositionJournalResponse.Builder resBuilder =
          PositionJournalsForceRejectPositionJournalResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      PositionJournalsForceRejectPositionJournalResponse res = resBuilder.build();
