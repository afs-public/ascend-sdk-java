...
public class PreIpoCompanyResearchDocumentsListPreIpoCompanyResearchDocuments {
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/trading/v1/preIpoCompanies/{preIpoCompany_id}/researchDocuments",
              request,
              null);
  ...
  public static class Sync extends Base
    ...
    @Override
    public PreIpoCompanyResearchDocumentsListPreIpoCompanyResearchDocumentsResponse handleResponse(
      ...
      PreIpoCompanyResearchDocumentsListPreIpoCompanyResearchDocumentsResponse.Builder resBuilder =
          PreIpoCompanyResearchDocumentsListPreIpoCompanyResearchDocumentsResponse.builder()
      ...
      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListPreIpoCompanyResearchDocumentsResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListPreIpoCompanyResearchDocumentsResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
