...
public class OrderServiceSetExtraReportingData {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "OrderService_SetExtraReportingData",
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/trading/v1/accounts/{account_id}/orders/{order_id}:setExtraReportingData",
              request,
              null);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(OrderServiceSetExtraReportingDataRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              OrderServiceSetExtraReportingDataRequest.class,
              new TypeReference<OrderServiceSetExtraReportingDataRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(OrderServiceSetExtraReportingDataRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public OrderServiceSetExtraReportingDataResponse handleResponse(
      ...
      OrderServiceSetExtraReportingDataResponse.Builder resBuilder =
          OrderServiceSetExtraReportingDataResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      OrderServiceSetExtraReportingDataResponse res = resBuilder.build();
