...
public class CreditsCancelCredit {
  ...
  abstract static class Base {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "cancelCreditRequestCreate", "json", false);
  ...
  public static class Sync extends Base
      implements RequestOperation<CreditsCancelCreditRequest, CreditsCancelCreditResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(CreditsCancelCreditRequest request) throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              CreditsCancelCreditRequest.class,
              new TypeReference<CreditsCancelCreditRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(CreditsCancelCreditRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public CreditsCancelCreditResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      CreditsCancelCreditResponse.Builder resBuilder =
          CreditsCancelCreditResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      CreditsCancelCreditResponse res = resBuilder.build();
