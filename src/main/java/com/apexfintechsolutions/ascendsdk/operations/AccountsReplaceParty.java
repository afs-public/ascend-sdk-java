...
public class AccountsReplaceParty {
  ...
  abstract static class Base {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "replacePartyRequestCreate", "json", false);
  ...
  public static class Sync extends Base
      implements RequestOperation<AccountsReplacePartyRequest, AccountsReplacePartyResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(AccountsReplacePartyRequest request) throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              AccountsReplacePartyRequest.class,
              new TypeReference<AccountsReplacePartyRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountsReplacePartyRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public AccountsReplacePartyResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AccountsReplacePartyResponse.Builder resBuilder =
          AccountsReplacePartyResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsReplacePartyResponse res = resBuilder.build();
