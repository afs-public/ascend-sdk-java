...
public class SubscriberCreatePushSubscription {
  ...
  public static class Sync extends Base
      implements RequestOperation<
          PushSubscriptionCreate, SubscriberCreatePushSubscriptionResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(PushSubscriptionCreate request) throws Exception {
      HttpRequest req = buildRequest(request, new TypeReference<PushSubscriptionCreate>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(PushSubscriptionCreate request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public SubscriberCreatePushSubscriptionResponse handleResponse(
      ...
      SubscriberCreatePushSubscriptionResponse.Builder resBuilder =
          SubscriberCreatePushSubscriptionResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      SubscriberCreatePushSubscriptionResponse res = resBuilder.build();
