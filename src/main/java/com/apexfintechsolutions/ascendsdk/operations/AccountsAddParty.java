...
public class AccountsAddParty {
  ...
  abstract static class Base {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      String url =
          Utils.generateURL(
              klass, this.baseUrl, "/accounts/v1/accounts/{account_id}/parties:add", request, null);
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "addPartyRequestCreate", "json", false);
  ...
  public static class Sync extends Base
      implements RequestOperation<AccountsAddPartyRequest, AccountsAddPartyResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(AccountsAddPartyRequest request) throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              AccountsAddPartyRequest.class,
              new TypeReference<AccountsAddPartyRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountsAddPartyRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public AccountsAddPartyResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AccountsAddPartyResponse.Builder resBuilder =
          AccountsAddPartyResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsAddPartyResponse res = resBuilder.build();
