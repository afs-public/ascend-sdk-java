...
public class AchWithdrawalsCreateAchWithdrawal {
  ...
  abstract static class Base {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "achWithdrawalCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(AchWithdrawalsCreateAchWithdrawalRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              AchWithdrawalsCreateAchWithdrawalRequest.class,
              new TypeReference<AchWithdrawalsCreateAchWithdrawalRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AchWithdrawalsCreateAchWithdrawalRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public AchWithdrawalsCreateAchWithdrawalResponse handleResponse(
      ...
      AchWithdrawalsCreateAchWithdrawalResponse.Builder resBuilder =
          AchWithdrawalsCreateAchWithdrawalResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AchWithdrawalsCreateAchWithdrawalResponse res = resBuilder.build();
