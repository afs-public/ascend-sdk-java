...
public class AlternativeOrdersSettleAlternativeOrder {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/trading/v1/accounts/{account_id}/alternativeOrders/{alternativeOrder_id}:settle",
              request,
              null);
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "settleAlternativeOrderRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(AlternativeOrdersSettleAlternativeOrderRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              AlternativeOrdersSettleAlternativeOrderRequest.class,
              new TypeReference<AlternativeOrdersSettleAlternativeOrderRequest>() {});
    ...
    public HttpResponse<InputStream> doRequest(
        AlternativeOrdersSettleAlternativeOrderRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public AlternativeOrdersSettleAlternativeOrderResponse handleResponse(
      ...
      AlternativeOrdersSettleAlternativeOrderResponse.Builder resBuilder =
          AlternativeOrdersSettleAlternativeOrderResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AlternativeOrdersSettleAlternativeOrderResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          AlternativeOrder out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withAlternativeOrder(out);
          return res;
        } else {
          throw new SDKError(
              response,
