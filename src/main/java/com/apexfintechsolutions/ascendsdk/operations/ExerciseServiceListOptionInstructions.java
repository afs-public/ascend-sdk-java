...
public class ExerciseServiceListOptionInstructions {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "ExerciseService_ListOptionInstructions",
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(ExerciseServiceListOptionInstructionsRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, ExerciseServiceListOptionInstructionsRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ExerciseServiceListOptionInstructionsRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public ExerciseServiceListOptionInstructionsResponse handleResponse(
      ...
      ExerciseServiceListOptionInstructionsResponse.Builder resBuilder =
          ExerciseServiceListOptionInstructionsResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      ExerciseServiceListOptionInstructionsResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListOptionInstructionsResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListOptionInstructionsResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
