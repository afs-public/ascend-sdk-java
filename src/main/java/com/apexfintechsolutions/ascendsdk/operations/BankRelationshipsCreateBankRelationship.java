...
public class BankRelationshipsCreateBankRelationship {
  ...
  abstract static class Base {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "bankRelationshipCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(BankRelationshipsCreateBankRelationshipRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              BankRelationshipsCreateBankRelationshipRequest.class,
              new TypeReference<BankRelationshipsCreateBankRelationshipRequest>() {});
    ...
    public HttpResponse<InputStream> doRequest(
        BankRelationshipsCreateBankRelationshipRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public BankRelationshipsCreateBankRelationshipResponse handleResponse(
      ...
      BankRelationshipsCreateBankRelationshipResponse.Builder resBuilder =
          BankRelationshipsCreateBankRelationshipResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      BankRelationshipsCreateBankRelationshipResponse res = resBuilder.build();
