...
public class LedgerListPositions {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(LedgerListPositionsRequest request) throws Exception {
      String url =
          Utils.generateURL(
      ...
      req.addQueryParams(Utils.getQueryParams(LedgerListPositionsRequest.class, request, null));
  ...
  public static class Sync extends Base
      implements RequestOperation<LedgerListPositionsRequest, LedgerListPositionsResponse> {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(LedgerListPositionsRequest request)
        throws Exception {
    ...
    @Override
    public LedgerListPositionsResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      LedgerListPositionsResponse.Builder resBuilder =
          LedgerListPositionsResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      LedgerListPositionsResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListPositionsResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListPositionsResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
