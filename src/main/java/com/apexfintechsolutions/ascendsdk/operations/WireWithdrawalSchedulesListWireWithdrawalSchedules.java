...
public class WireWithdrawalSchedulesListWireWithdrawalSchedules {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(WireWithdrawalSchedulesListWireWithdrawalSchedulesRequest request)
        throws Exception {
      String url =
          Utils.generateURL(
  ...
  public static class Sync extends Base
    ...
    public HttpResponse<InputStream> doRequest(
        WireWithdrawalSchedulesListWireWithdrawalSchedulesRequest request) throws Exception {
    ...
    @Override
    public WireWithdrawalSchedulesListWireWithdrawalSchedulesResponse handleResponse(
      ...
      WireWithdrawalSchedulesListWireWithdrawalSchedulesResponse.Builder resBuilder =
          WireWithdrawalSchedulesListWireWithdrawalSchedulesResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      WireWithdrawalSchedulesListWireWithdrawalSchedulesResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListWireWithdrawalSchedulesResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListWireWithdrawalSchedulesResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
