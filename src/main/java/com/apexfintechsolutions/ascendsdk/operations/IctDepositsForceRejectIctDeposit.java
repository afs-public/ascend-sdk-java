...
public class IctDepositsForceRejectIctDeposit {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "forceRejectIctDepositRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(IctDepositsForceRejectIctDepositRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              IctDepositsForceRejectIctDepositRequest.class,
              new TypeReference<IctDepositsForceRejectIctDepositRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(IctDepositsForceRejectIctDepositRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public IctDepositsForceRejectIctDepositResponse handleResponse(
      ...
      IctDepositsForceRejectIctDepositResponse.Builder resBuilder =
          IctDepositsForceRejectIctDepositResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      IctDepositsForceRejectIctDepositResponse res = resBuilder.build();
