...
public class AccountsUpdateAccountGroup {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/accounts/v1/accounts/{account_id}:updateAccountGroup",
              request,
              null);
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "updateAccountGroupRequestUpdate", "json", false);
  ...
  public static class Sync extends Base
      implements RequestOperation<
          AccountsUpdateAccountGroupRequest, AccountsUpdateAccountGroupResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(AccountsUpdateAccountGroupRequest request) throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              AccountsUpdateAccountGroupRequest.class,
              new TypeReference<AccountsUpdateAccountGroupRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountsUpdateAccountGroupRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public AccountsUpdateAccountGroupResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AccountsUpdateAccountGroupResponse.Builder resBuilder =
          AccountsUpdateAccountGroupResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsUpdateAccountGroupResponse res = resBuilder.build();
