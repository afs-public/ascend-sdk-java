...
public class WireDepositsSimulateWireDeposit {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "WireDeposits_SimulateWireDeposit",
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/transfers/v1/accounts/{account_id}/wireDeposits:simulate",
              request,
              null);
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "simulateWireDepositRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(WireDepositsSimulateWireDepositRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              WireDepositsSimulateWireDepositRequest.class,
              new TypeReference<WireDepositsSimulateWireDepositRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(WireDepositsSimulateWireDepositRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public WireDepositsSimulateWireDepositResponse handleResponse(
      ...
      WireDepositsSimulateWireDepositResponse.Builder resBuilder =
          WireDepositsSimulateWireDepositResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      WireDepositsSimulateWireDepositResponse res = resBuilder.build();
