...
public class ReaderListEventMessages {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(ReaderListEventMessagesRequest request) throws Exception {
      HttpRequest req = buildRequest(request, ReaderListEventMessagesRequest.class);
