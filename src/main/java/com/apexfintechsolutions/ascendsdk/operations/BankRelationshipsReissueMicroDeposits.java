...
public class BankRelationshipsReissueMicroDeposits {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "reissueMicroDepositsRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(BankRelationshipsReissueMicroDepositsRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              BankRelationshipsReissueMicroDepositsRequest.class,
              new TypeReference<BankRelationshipsReissueMicroDepositsRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(BankRelationshipsReissueMicroDepositsRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public BankRelationshipsReissueMicroDepositsResponse handleResponse(
      ...
      BankRelationshipsReissueMicroDepositsResponse.Builder resBuilder =
          BankRelationshipsReissueMicroDepositsResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      BankRelationshipsReissueMicroDepositsResponse res = resBuilder.build();
