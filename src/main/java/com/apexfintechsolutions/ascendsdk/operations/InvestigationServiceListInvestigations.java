...
public class InvestigationServiceListInvestigations {
  ...
  abstract static class Base {
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url = Utils.generateURL(this.baseUrl, "/investigations/v1/investigations");
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(InvestigationServiceListInvestigationsRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, InvestigationServiceListInvestigationsRequest.class);
    ...
    public HttpResponse<InputStream> doRequest(
        InvestigationServiceListInvestigationsRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public InvestigationServiceListInvestigationsResponse handleResponse(
      ...
      InvestigationServiceListInvestigationsResponse.Builder resBuilder =
          InvestigationServiceListInvestigationsResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      InvestigationServiceListInvestigationsResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListInvestigationsResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListInvestigationsResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
