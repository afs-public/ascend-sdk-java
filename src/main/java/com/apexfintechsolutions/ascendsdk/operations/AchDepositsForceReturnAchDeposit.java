...
public class AchDepositsForceReturnAchDeposit {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "forceReturnAchDepositRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(AchDepositsForceReturnAchDepositRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              AchDepositsForceReturnAchDepositRequest.class,
              new TypeReference<AchDepositsForceReturnAchDepositRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AchDepositsForceReturnAchDepositRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public AchDepositsForceReturnAchDepositResponse handleResponse(
      ...
      AchDepositsForceReturnAchDepositResponse.Builder resBuilder =
          AchDepositsForceReturnAchDepositResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AchDepositsForceReturnAchDepositResponse res = resBuilder.build();
