...
public class AssetsListAssetsCorrespondent {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(AssetsListAssetsCorrespondentRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, AssetsListAssetsCorrespondentRequest.class);
