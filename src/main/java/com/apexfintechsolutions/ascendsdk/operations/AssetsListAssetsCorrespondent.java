...
public class AssetsListAssetsCorrespondent {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(AssetsListAssetsCorrespondentRequest request) throws Exception {
      String url =
          Utils.generateURL(
  ...
  public static class Sync extends Base
      implements RequestOperation<
          AssetsListAssetsCorrespondentRequest, AssetsListAssetsCorrespondentResponse> {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AssetsListAssetsCorrespondentRequest request)
        throws Exception {
    ...
    @Override
    public AssetsListAssetsCorrespondentResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AssetsListAssetsCorrespondentResponse.Builder resBuilder =
          AssetsListAssetsCorrespondentResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AssetsListAssetsCorrespondentResponse res = resBuilder.build();
