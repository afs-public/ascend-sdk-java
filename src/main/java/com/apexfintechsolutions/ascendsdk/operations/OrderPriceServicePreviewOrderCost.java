...
public class OrderPriceServicePreviewOrderCost {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "orderCostPreviewRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(OrderPriceServicePreviewOrderCostRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              OrderPriceServicePreviewOrderCostRequest.class,
              new TypeReference<OrderPriceServicePreviewOrderCostRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(OrderPriceServicePreviewOrderCostRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public OrderPriceServicePreviewOrderCostResponse handleResponse(
      ...
      OrderPriceServicePreviewOrderCostResponse.Builder resBuilder =
          OrderPriceServicePreviewOrderCostResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      OrderPriceServicePreviewOrderCostResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          OrderCostPreviewResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withOrderCostPreviewResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
