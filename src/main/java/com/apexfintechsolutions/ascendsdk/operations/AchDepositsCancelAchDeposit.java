...
public class AchDepositsCancelAchDeposit {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "cancelAchDepositRequestCreate", "json", false);
  ...
  public static class Sync extends Base
      implements RequestOperation<
          AchDepositsCancelAchDepositRequest, AchDepositsCancelAchDepositResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(AchDepositsCancelAchDepositRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              AchDepositsCancelAchDepositRequest.class,
              new TypeReference<AchDepositsCancelAchDepositRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AchDepositsCancelAchDepositRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public AchDepositsCancelAchDepositResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AchDepositsCancelAchDepositResponse.Builder resBuilder =
          AchDepositsCancelAchDepositResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AchDepositsCancelAchDepositResponse res = resBuilder.build();
