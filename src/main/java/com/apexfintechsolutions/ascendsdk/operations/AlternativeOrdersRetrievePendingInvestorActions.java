...
public class AlternativeOrdersRetrievePendingInvestorActions {
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/trading/v1/accounts/{account_id}/alternativeOrders/{alternativeOrder_id}:retrievePendingInvestorActions",
              request,
              null);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(
        AlternativeOrdersRetrievePendingInvestorActionsRequest request) throws Exception {
      HttpRequest req =
          buildRequest(request, AlternativeOrdersRetrievePendingInvestorActionsRequest.class);
    ...
    @Override
    public AlternativeOrdersRetrievePendingInvestorActionsResponse handleResponse(
      ...
      AlternativeOrdersRetrievePendingInvestorActionsResponse.Builder resBuilder =
          AlternativeOrdersRetrievePendingInvestorActionsResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AlternativeOrdersRetrievePendingInvestorActionsResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          RetrievePendingInvestorActionsResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withRetrievePendingInvestorActionsResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
