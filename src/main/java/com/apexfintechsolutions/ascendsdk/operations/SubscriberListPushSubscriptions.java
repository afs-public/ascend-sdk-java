...
public class SubscriberListPushSubscriptions {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(SubscriberListPushSubscriptionsRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, SubscriberListPushSubscriptionsRequest.class);
