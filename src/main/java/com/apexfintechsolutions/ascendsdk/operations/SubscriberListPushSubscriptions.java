...
public class SubscriberListPushSubscriptions {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(SubscriberListPushSubscriptionsRequest request) throws Exception {
      String url = Utils.generateURL(this.baseUrl, "/events/v1/subscriptions");
  ...
  public static class Sync extends Base
    ...
    @Override
    public HttpResponse<InputStream> doRequest(SubscriberListPushSubscriptionsRequest request)
        throws Exception {
    ...
    @Override
    public SubscriberListPushSubscriptionsResponse handleResponse(
      ...
      SubscriberListPushSubscriptionsResponse.Builder resBuilder =
          SubscriberListPushSubscriptionsResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      SubscriberListPushSubscriptionsResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListPushSubscriptionsResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListPushSubscriptionsResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
