...
public class PositionJournalsForceApprovePositionJournal {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "PositionJournals_ForceApprovePositionJournal",
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/transfers/v1/positionJournals/{positionJournal_id}:forceApprove",
              request,
              null);
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "forceApprovePositionJournalRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(PositionJournalsForceApprovePositionJournalRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              PositionJournalsForceApprovePositionJournalRequest.class,
              new TypeReference<PositionJournalsForceApprovePositionJournalRequest>() {});
    ...
    public HttpResponse<InputStream> doRequest(
        PositionJournalsForceApprovePositionJournalRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public PositionJournalsForceApprovePositionJournalResponse handleResponse(
      ...
      PositionJournalsForceApprovePositionJournalResponse.Builder resBuilder =
          PositionJournalsForceApprovePositionJournalResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      PositionJournalsForceApprovePositionJournalResponse res = resBuilder.build();
