...
public class LedgerListEntries {
  ...
  abstract static class Base {
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url =
          Utils.generateURL(
              klass, this.baseUrl, "/ledger/v1/accounts/{account_id}/entries", request, null);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(LedgerListEntriesRequest request) throws Exception {
      HttpRequest req = buildRequest(request, LedgerListEntriesRequest.class);
