...
public class LedgerListEntries {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(LedgerListEntriesRequest request) throws Exception {
      String url =
          Utils.generateURL(
      ...
      req.addQueryParams(Utils.getQueryParams(LedgerListEntriesRequest.class, request, null));
  ...
  public static class Sync extends Base
      implements RequestOperation<LedgerListEntriesRequest, LedgerListEntriesResponse> {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(LedgerListEntriesRequest request) throws Exception {
    ...
    @Override
    public LedgerListEntriesResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      LedgerListEntriesResponse.Builder resBuilder =
          LedgerListEntriesResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      LedgerListEntriesResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListEntriesResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListEntriesResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
