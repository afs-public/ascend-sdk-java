...
public class AlternativeInvestmentDocumentsGetAlternativeInvestmentDocument {
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/trading/v1/assets/{asset_id}/alternativeInvestmentDocuments/{alternativeInvestmentDocument_id}",
              request,
              null);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(
      ...
      HttpRequest req =
          buildRequest(
              request, AlternativeInvestmentDocumentsGetAlternativeInvestmentDocumentRequest.class);
    ...
    @Override
    public AlternativeInvestmentDocumentsGetAlternativeInvestmentDocumentResponse handleResponse(
      ...
      AlternativeInvestmentDocumentsGetAlternativeInvestmentDocumentResponse.Builder resBuilder =
          AlternativeInvestmentDocumentsGetAlternativeInvestmentDocumentResponse.builder()
      ...
      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          AlternativeInvestmentDocument out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withAlternativeInvestmentDocument(out);
          return res;
        } else {
          throw new SDKError(
              response,
