...
public class BankRelationshipsGetMicroDepositAmounts {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(BankRelationshipsGetMicroDepositAmountsRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, BankRelationshipsGetMicroDepositAmountsRequest.class);
    ...
    public HttpResponse<InputStream> doRequest(
        BankRelationshipsGetMicroDepositAmountsRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public BankRelationshipsGetMicroDepositAmountsResponse handleResponse(
      ...
      BankRelationshipsGetMicroDepositAmountsResponse.Builder resBuilder =
          BankRelationshipsGetMicroDepositAmountsResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      BankRelationshipsGetMicroDepositAmountsResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          MicroDepositAmounts out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withMicroDepositAmounts(out);
          return res;
        } else {
          throw new SDKError(
              response,
