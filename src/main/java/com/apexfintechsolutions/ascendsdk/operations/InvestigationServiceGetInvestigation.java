...
public class InvestigationServiceGetInvestigation {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(InvestigationServiceGetInvestigationRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, InvestigationServiceGetInvestigationRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(InvestigationServiceGetInvestigationRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public InvestigationServiceGetInvestigationResponse handleResponse(
      ...
      InvestigationServiceGetInvestigationResponse.Builder resBuilder =
          InvestigationServiceGetInvestigationResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      InvestigationServiceGetInvestigationResponse res = resBuilder.build();
