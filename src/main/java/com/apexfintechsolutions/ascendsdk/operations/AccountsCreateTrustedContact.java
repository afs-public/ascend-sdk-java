...
public class AccountsCreateTrustedContact {
  ...
  abstract static class Base {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "trustedContactCreate", "json", false);
  ...
  public static class Sync extends Base
      implements RequestOperation<
          AccountsCreateTrustedContactRequest, AccountsCreateTrustedContactResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(AccountsCreateTrustedContactRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              AccountsCreateTrustedContactRequest.class,
              new TypeReference<AccountsCreateTrustedContactRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountsCreateTrustedContactRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
                    ...
                    try {
                      ...
                      if (Utils.statusCodeMatches(
                          httpRes.statusCode(), "400", "403", "4XX", "500", "503", "5XX")) {
    ...
    @Override
    public AccountsCreateTrustedContactResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AccountsCreateTrustedContactResponse.Builder resBuilder =
          AccountsCreateTrustedContactResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsCreateTrustedContactResponse res = resBuilder.build();
