...
public class PreIpoCompanyNewsEventsListPreIpoCompanyNewsEvents {
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/trading/v1/preIpoCompanies/{preIpoCompany_id}/newsEvents",
              request,
              null);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(
        PreIpoCompanyNewsEventsListPreIpoCompanyNewsEventsRequest request) throws Exception {
      HttpRequest req =
          buildRequest(request, PreIpoCompanyNewsEventsListPreIpoCompanyNewsEventsRequest.class);
    ...
    @Override
    public PreIpoCompanyNewsEventsListPreIpoCompanyNewsEventsResponse handleResponse(
      ...
      PreIpoCompanyNewsEventsListPreIpoCompanyNewsEventsResponse.Builder resBuilder =
          PreIpoCompanyNewsEventsListPreIpoCompanyNewsEventsResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      PreIpoCompanyNewsEventsListPreIpoCompanyNewsEventsResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListPreIpoCompanyNewsEventsResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListPreIpoCompanyNewsEventsResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
