...
public class AlternativeOrdersListAlternativeOrders {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(AlternativeOrdersListAlternativeOrdersRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, AlternativeOrdersListAlternativeOrdersRequest.class);
    ...
    public HttpResponse<InputStream> doRequest(
        AlternativeOrdersListAlternativeOrdersRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public AlternativeOrdersListAlternativeOrdersResponse handleResponse(
      ...
      AlternativeOrdersListAlternativeOrdersResponse.Builder resBuilder =
          AlternativeOrdersListAlternativeOrdersResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AlternativeOrdersListAlternativeOrdersResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListAlternativeOrdersResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListAlternativeOrdersResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
