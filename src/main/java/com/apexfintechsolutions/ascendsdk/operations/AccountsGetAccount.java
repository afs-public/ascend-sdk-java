...
public class AccountsGetAccount {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(AccountsGetAccountRequest request) throws Exception {
      String url =
          Utils.generateURL(
      ...
      req.addQueryParams(Utils.getQueryParams(AccountsGetAccountRequest.class, request, null));
  ...
  public static class Sync extends Base
      implements RequestOperation<AccountsGetAccountRequest, AccountsGetAccountResponse> {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountsGetAccountRequest request) throws Exception {
    ...
    @Override
    public AccountsGetAccountResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AccountsGetAccountResponse.Builder resBuilder =
          AccountsGetAccountResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsGetAccountResponse res = resBuilder.build();
