...
public class AccountsGetAccount {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(AccountsGetAccountRequest request) throws Exception {
      HttpRequest req = buildRequest(request, AccountsGetAccountRequest.class);
