...
public class BookingRebookTradeAllocation {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(BookingRebookTradeAllocationRequest request) throws Exception {
      String url =
          Utils.generateURL(
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "rebookTradeAllocationRequestCreate", "json", false);
  ...
  public static class Sync extends Base
      implements RequestOperation<
          BookingRebookTradeAllocationRequest, BookingRebookTradeAllocationResponse> {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(BookingRebookTradeAllocationRequest request)
        throws Exception {
    ...
    @Override
    public BookingRebookTradeAllocationResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      BookingRebookTradeAllocationResponse.Builder resBuilder =
          BookingRebookTradeAllocationResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      BookingRebookTradeAllocationResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          RebookTradeAllocationResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withRebookTradeAllocationResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
