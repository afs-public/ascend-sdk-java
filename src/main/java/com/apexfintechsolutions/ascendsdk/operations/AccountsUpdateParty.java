...
public class AccountsUpdateParty {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(AccountsUpdatePartyRequest request) throws Exception {
      String url =
          Utils.generateURL(
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "partyRequestUpdate", "json", false);
      ...
      req.addQueryParams(Utils.getQueryParams(AccountsUpdatePartyRequest.class, request, null));
  ...
  public static class Sync extends Base
      implements RequestOperation<AccountsUpdatePartyRequest, AccountsUpdatePartyResponse> {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountsUpdatePartyRequest request)
        throws Exception {
    ...
    @Override
    public AccountsUpdatePartyResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AccountsUpdatePartyResponse.Builder resBuilder =
          AccountsUpdatePartyResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsUpdatePartyResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          Party out = Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withParty(out);
          return res;
        } else {
          throw new SDKError(
