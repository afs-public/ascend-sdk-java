...
public class AccountsGetNote {
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/accounts/v1/accounts/{account_id}/notes/{note_id}",
              request,
              null);
  ...
  public static class Sync extends Base
      implements RequestOperation<AccountsGetNoteRequest, AccountsGetNoteResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(AccountsGetNoteRequest request) throws Exception {
      HttpRequest req = buildRequest(request, AccountsGetNoteRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountsGetNoteRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public AccountsGetNoteResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AccountsGetNoteResponse.Builder resBuilder =
          AccountsGetNoteResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsGetNoteResponse res = resBuilder.build();
