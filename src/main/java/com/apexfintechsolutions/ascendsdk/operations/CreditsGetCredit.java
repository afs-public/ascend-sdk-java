...
public class CreditsGetCredit {
  ...
  public static class Sync extends Base
      implements RequestOperation<CreditsGetCreditRequest, CreditsGetCreditResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(CreditsGetCreditRequest request) throws Exception {
      HttpRequest req = buildRequest(request, CreditsGetCreditRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(CreditsGetCreditRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public CreditsGetCreditResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      CreditsGetCreditResponse.Builder resBuilder =
          CreditsGetCreditResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      CreditsGetCreditResponse res = resBuilder.build();
