...
public class CashJournalSchedulesGetCashJournalSchedule {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "CashJournalSchedules_GetCashJournalSchedule",
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(CashJournalSchedulesGetCashJournalScheduleRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(request, CashJournalSchedulesGetCashJournalScheduleRequest.class);
    ...
    public HttpResponse<InputStream> doRequest(
        CashJournalSchedulesGetCashJournalScheduleRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public CashJournalSchedulesGetCashJournalScheduleResponse handleResponse(
      ...
      CashJournalSchedulesGetCashJournalScheduleResponse.Builder resBuilder =
          CashJournalSchedulesGetCashJournalScheduleResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      CashJournalSchedulesGetCashJournalScheduleResponse res = resBuilder.build();
