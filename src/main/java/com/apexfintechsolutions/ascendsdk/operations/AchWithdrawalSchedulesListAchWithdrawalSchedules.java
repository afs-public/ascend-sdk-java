...
public class AchWithdrawalSchedulesListAchWithdrawalSchedules {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(AchWithdrawalSchedulesListAchWithdrawalSchedulesRequest request)
        throws Exception {
      String url =
          Utils.generateURL(
  ...
  public static class Sync extends Base
    ...
    public HttpResponse<InputStream> doRequest(
        AchWithdrawalSchedulesListAchWithdrawalSchedulesRequest request) throws Exception {
    ...
    @Override
    public AchWithdrawalSchedulesListAchWithdrawalSchedulesResponse handleResponse(
      ...
      AchWithdrawalSchedulesListAchWithdrawalSchedulesResponse.Builder resBuilder =
          AchWithdrawalSchedulesListAchWithdrawalSchedulesResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AchWithdrawalSchedulesListAchWithdrawalSchedulesResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListAchWithdrawalSchedulesResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListAchWithdrawalSchedulesResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
