...
public class BasketOrdersServiceSetExtraReportingData {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "BasketOrdersService_SetExtraReportingData",
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "basketTradingSetExtraReportingDataRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(BasketOrdersServiceSetExtraReportingDataRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              BasketOrdersServiceSetExtraReportingDataRequest.class,
              new TypeReference<BasketOrdersServiceSetExtraReportingDataRequest>() {});
    ...
    public HttpResponse<InputStream> doRequest(
        BasketOrdersServiceSetExtraReportingDataRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public BasketOrdersServiceSetExtraReportingDataResponse handleResponse(
      ...
      BasketOrdersServiceSetExtraReportingDataResponse.Builder resBuilder =
          BasketOrdersServiceSetExtraReportingDataResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      BasketOrdersServiceSetExtraReportingDataResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          SetExtraReportingDataResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withSetExtraReportingDataResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
