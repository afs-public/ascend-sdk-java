...
public class SnapshotsListSnapshots {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(SnapshotsListSnapshotsRequest request) throws Exception {
      String url = Utils.generateURL(this.baseUrl, "/analytics/v1/snapshots");
      HTTPRequest req = new HTTPRequest(url, "GET");
      req.addHeader("Accept", "application/json")
          .addHeader("user-agent", SDKConfiguration.USER_AGENT);

      req.addQueryParams(Utils.getQueryParams(SnapshotsListSnapshotsRequest.class, request, null));
