...
public class CashJournalsForceApproveCashJournal {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "forceApproveCashJournalRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(CashJournalsForceApproveCashJournalRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              CashJournalsForceApproveCashJournalRequest.class,
              new TypeReference<CashJournalsForceApproveCashJournalRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(CashJournalsForceApproveCashJournalRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public CashJournalsForceApproveCashJournalResponse handleResponse(
      ...
      CashJournalsForceApproveCashJournalResponse.Builder resBuilder =
          CashJournalsForceApproveCashJournalResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      CashJournalsForceApproveCashJournalResponse res = resBuilder.build();
