...
public class AccountsUpdateLegalNaturalPerson {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(AccountsUpdateLegalNaturalPersonRequest request) throws Exception {
      String url =
          Utils.generateURL(
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "legalNaturalPersonUpdate", "json", false);
  ...
  public static class Sync extends Base
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountsUpdateLegalNaturalPersonRequest request)
        throws Exception {
    ...
    @Override
    public AccountsUpdateLegalNaturalPersonResponse handleResponse(
      ...
      AccountsUpdateLegalNaturalPersonResponse.Builder resBuilder =
          AccountsUpdateLegalNaturalPersonResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsUpdateLegalNaturalPersonResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          LegalNaturalPerson out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withLegalNaturalPerson(out);
          return res;
        } else {
          throw new SDKError(
              response,
