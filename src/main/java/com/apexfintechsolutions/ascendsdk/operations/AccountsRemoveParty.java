...
public class AccountsRemoveParty {
  ...
  abstract static class Base {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "removePartyRequestCreate", "json", false);
  ...
  public static class Sync extends Base
      implements RequestOperation<AccountsRemovePartyRequest, AccountsRemovePartyResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(AccountsRemovePartyRequest request) throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              AccountsRemovePartyRequest.class,
              new TypeReference<AccountsRemovePartyRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountsRemovePartyRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public AccountsRemovePartyResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AccountsRemovePartyResponse.Builder resBuilder =
          AccountsRemovePartyResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsRemovePartyResponse res = resBuilder.build();
