...
public class AlternativeOrdersCreateAlternativeOrder {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/trading/v1/accounts/{account_id}/alternativeOrders",
              request,
              null);
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "alternativeOrderCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(AlternativeOrdersCreateAlternativeOrderRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              AlternativeOrdersCreateAlternativeOrderRequest.class,
              new TypeReference<AlternativeOrdersCreateAlternativeOrderRequest>() {});
    ...
    public HttpResponse<InputStream> doRequest(
        AlternativeOrdersCreateAlternativeOrderRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public AlternativeOrdersCreateAlternativeOrderResponse handleResponse(
      ...
      AlternativeOrdersCreateAlternativeOrderResponse.Builder resBuilder =
          AlternativeOrdersCreateAlternativeOrderResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AlternativeOrdersCreateAlternativeOrderResponse res = resBuilder.build();
