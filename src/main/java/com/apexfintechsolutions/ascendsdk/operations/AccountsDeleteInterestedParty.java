...
public class AccountsDeleteInterestedParty {
  ...
  public static class Sync extends Base
      implements RequestOperation<
          AccountsDeleteInterestedPartyRequest, AccountsDeleteInterestedPartyResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(AccountsDeleteInterestedPartyRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, AccountsDeleteInterestedPartyRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountsDeleteInterestedPartyRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public AccountsDeleteInterestedPartyResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AccountsDeleteInterestedPartyResponse.Builder resBuilder =
          AccountsDeleteInterestedPartyResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsDeleteInterestedPartyResponse res = resBuilder.build();
