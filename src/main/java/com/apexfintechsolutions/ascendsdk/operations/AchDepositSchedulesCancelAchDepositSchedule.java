...
public class AchDepositSchedulesCancelAchDepositSchedule {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "cancelAchDepositScheduleRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(AchDepositSchedulesCancelAchDepositScheduleRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              AchDepositSchedulesCancelAchDepositScheduleRequest.class,
              new TypeReference<AchDepositSchedulesCancelAchDepositScheduleRequest>() {});
    ...
    public HttpResponse<InputStream> doRequest(
        AchDepositSchedulesCancelAchDepositScheduleRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public AchDepositSchedulesCancelAchDepositScheduleResponse handleResponse(
      ...
      AchDepositSchedulesCancelAchDepositScheduleResponse.Builder resBuilder =
          AchDepositSchedulesCancelAchDepositScheduleResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AchDepositSchedulesCancelAchDepositScheduleResponse res = resBuilder.build();
