...
public class WireDepositsForceApproveWireDeposit {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "WireDeposits_ForceApproveWireDeposit",
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/transfers/v1/accounts/{account_id}/wireDeposits/{wireDeposit_id}:forceApprove",
              request,
              null);
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "forceApproveWireDepositRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(WireDepositsForceApproveWireDepositRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              WireDepositsForceApproveWireDepositRequest.class,
              new TypeReference<WireDepositsForceApproveWireDepositRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(WireDepositsForceApproveWireDepositRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public WireDepositsForceApproveWireDepositResponse handleResponse(
      ...
      WireDepositsForceApproveWireDepositResponse.Builder resBuilder =
          WireDepositsForceApproveWireDepositResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      WireDepositsForceApproveWireDepositResponse res = resBuilder.build();
