...
public class AccountsListAvailableEnrollments1 {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(AccountsListAvailableEnrollments1Request request) throws Exception {
      String url =
          Utils.generateURL(
  ...
  public static class Sync extends Base
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountsListAvailableEnrollments1Request request)
        throws Exception {
    ...
    @Override
    public AccountsListAvailableEnrollments1Response handleResponse(
      ...
      AccountsListAvailableEnrollments1Response.Builder resBuilder =
          AccountsListAvailableEnrollments1Response.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsListAvailableEnrollments1Response res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListAvailableEnrollmentsResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListAvailableEnrollmentsResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
