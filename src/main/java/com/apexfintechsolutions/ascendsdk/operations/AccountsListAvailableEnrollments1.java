...
public class AccountsListAvailableEnrollments1 {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(AccountsListAvailableEnrollments1Request request)
        throws Exception {
      HttpRequest req = buildRequest(request, AccountsListAvailableEnrollments1Request.class);
