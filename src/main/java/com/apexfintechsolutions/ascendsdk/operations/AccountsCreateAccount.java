...
public class AccountsCreateAccount {
  ...
  public static class Sync extends Base
      implements RequestOperation<AccountRequestCreate, AccountsCreateAccountResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(AccountRequestCreate request) throws Exception {
      HttpRequest req = buildRequest(request, new TypeReference<AccountRequestCreate>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountRequestCreate request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public AccountsCreateAccountResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AccountsCreateAccountResponse.Builder resBuilder =
          AccountsCreateAccountResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsCreateAccountResponse res = resBuilder.build();
