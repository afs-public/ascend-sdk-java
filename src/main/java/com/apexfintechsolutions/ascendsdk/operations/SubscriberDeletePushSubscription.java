...
public class SubscriberDeletePushSubscription {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(SubscriberDeletePushSubscriptionRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, SubscriberDeletePushSubscriptionRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(SubscriberDeletePushSubscriptionRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public SubscriberDeletePushSubscriptionResponse handleResponse(
      ...
      SubscriberDeletePushSubscriptionResponse.Builder resBuilder =
          SubscriberDeletePushSubscriptionResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      SubscriberDeletePushSubscriptionResponse res = resBuilder.build();
