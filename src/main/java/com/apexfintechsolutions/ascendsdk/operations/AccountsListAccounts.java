...
public class AccountsListAccounts {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(AccountsListAccountsRequest request) throws Exception {
      HttpRequest req = buildRequest(request, AccountsListAccountsRequest.class);
