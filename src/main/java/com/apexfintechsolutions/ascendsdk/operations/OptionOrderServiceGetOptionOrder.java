...
public class OptionOrderServiceGetOptionOrder {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "OptionOrderService_GetOptionOrder",
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/trading/v1/accounts/{account_id}/optionOrders/{optionOrder_id}",
              request,
              null);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(OptionOrderServiceGetOptionOrderRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, OptionOrderServiceGetOptionOrderRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(OptionOrderServiceGetOptionOrderRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public OptionOrderServiceGetOptionOrderResponse handleResponse(
      ...
      OptionOrderServiceGetOptionOrderResponse.Builder resBuilder =
          OptionOrderServiceGetOptionOrderResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      OptionOrderServiceGetOptionOrderResponse res = resBuilder.build();
