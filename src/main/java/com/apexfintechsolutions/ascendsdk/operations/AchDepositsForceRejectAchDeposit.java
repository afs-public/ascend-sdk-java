...
public class AchDepositsForceRejectAchDeposit {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "forceRejectAchDepositRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(AchDepositsForceRejectAchDepositRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              AchDepositsForceRejectAchDepositRequest.class,
              new TypeReference<AchDepositsForceRejectAchDepositRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AchDepositsForceRejectAchDepositRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public AchDepositsForceRejectAchDepositResponse handleResponse(
      ...
      AchDepositsForceRejectAchDepositResponse.Builder resBuilder =
          AchDepositsForceRejectAchDepositResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AchDepositsForceRejectAchDepositResponse res = resBuilder.build();
