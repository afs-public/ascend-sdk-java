...
public class WireWithdrawalsGetWireWithdrawal {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(WireWithdrawalsGetWireWithdrawalRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, WireWithdrawalsGetWireWithdrawalRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(WireWithdrawalsGetWireWithdrawalRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public WireWithdrawalsGetWireWithdrawalResponse handleResponse(
      ...
      WireWithdrawalsGetWireWithdrawalResponse.Builder resBuilder =
          WireWithdrawalsGetWireWithdrawalResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      WireWithdrawalsGetWireWithdrawalResponse res = resBuilder.build();
