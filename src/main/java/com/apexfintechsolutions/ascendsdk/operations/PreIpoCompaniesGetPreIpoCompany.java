...
public class PreIpoCompaniesGetPreIpoCompany {
  ...
  abstract static class Base {
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url =
          Utils.generateURL(
              klass, this.baseUrl, "/trading/v1/preIpoCompanies/{preIpoCompany_id}", request, null);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(PreIpoCompaniesGetPreIpoCompanyRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, PreIpoCompaniesGetPreIpoCompanyRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(PreIpoCompaniesGetPreIpoCompanyRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public PreIpoCompaniesGetPreIpoCompanyResponse handleResponse(
      ...
      PreIpoCompaniesGetPreIpoCompanyResponse.Builder resBuilder =
          PreIpoCompaniesGetPreIpoCompanyResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      PreIpoCompaniesGetPreIpoCompanyResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          PreIpoCompany out = Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withPreIpoCompany(out);
          return res;
        } else {
          throw new SDKError(
              response,
