...
public class AchDepositsGetAchDeposit {
  ...
  public static class Sync extends Base
      implements RequestOperation<
          AchDepositsGetAchDepositRequest, AchDepositsGetAchDepositResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(AchDepositsGetAchDepositRequest request) throws Exception {
      HttpRequest req = buildRequest(request, AchDepositsGetAchDepositRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AchDepositsGetAchDepositRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public AchDepositsGetAchDepositResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AchDepositsGetAchDepositResponse.Builder resBuilder =
          AchDepositsGetAchDepositResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AchDepositsGetAchDepositResponse res = resBuilder.build();
