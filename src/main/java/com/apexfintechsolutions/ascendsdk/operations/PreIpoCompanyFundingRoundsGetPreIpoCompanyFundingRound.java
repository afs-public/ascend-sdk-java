...
public class PreIpoCompanyFundingRoundsGetPreIpoCompanyFundingRound {
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/trading/v1/preIpoCompanies/{preIpoCompany_id}/fundingRounds/{fundingRound_id}",
              request,
              null);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(
        PreIpoCompanyFundingRoundsGetPreIpoCompanyFundingRoundRequest request) throws Exception {
      HttpRequest req =
          buildRequest(
              request, PreIpoCompanyFundingRoundsGetPreIpoCompanyFundingRoundRequest.class);
    ...
    @Override
    public PreIpoCompanyFundingRoundsGetPreIpoCompanyFundingRoundResponse handleResponse(
      ...
      PreIpoCompanyFundingRoundsGetPreIpoCompanyFundingRoundResponse.Builder resBuilder =
          PreIpoCompanyFundingRoundsGetPreIpoCompanyFundingRoundResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      PreIpoCompanyFundingRoundsGetPreIpoCompanyFundingRoundResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          PreIpoCompanyFundingRound out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withPreIpoCompanyFundingRound(out);
          return res;
        } else {
          throw new SDKError(
              response,
