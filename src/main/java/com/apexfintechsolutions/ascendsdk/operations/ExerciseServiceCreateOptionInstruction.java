...
public class ExerciseServiceCreateOptionInstruction {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "ExerciseService_CreateOptionInstruction",
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "optionInstructionCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(ExerciseServiceCreateOptionInstructionRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              ExerciseServiceCreateOptionInstructionRequest.class,
              new TypeReference<ExerciseServiceCreateOptionInstructionRequest>() {});
    ...
    public HttpResponse<InputStream> doRequest(
        ExerciseServiceCreateOptionInstructionRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public ExerciseServiceCreateOptionInstructionResponse handleResponse(
      ...
      ExerciseServiceCreateOptionInstructionResponse.Builder resBuilder =
          ExerciseServiceCreateOptionInstructionResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      ExerciseServiceCreateOptionInstructionResponse res = resBuilder.build();
