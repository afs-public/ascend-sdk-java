...
public class WireWithdrawalsCreateWireWithdrawal {
  ...
  abstract static class Base {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "wireWithdrawalCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(WireWithdrawalsCreateWireWithdrawalRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              WireWithdrawalsCreateWireWithdrawalRequest.class,
              new TypeReference<WireWithdrawalsCreateWireWithdrawalRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(WireWithdrawalsCreateWireWithdrawalRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public WireWithdrawalsCreateWireWithdrawalResponse handleResponse(
      ...
      WireWithdrawalsCreateWireWithdrawalResponse.Builder resBuilder =
          WireWithdrawalsCreateWireWithdrawalResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      WireWithdrawalsCreateWireWithdrawalResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          WireWithdrawal out = Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withWireWithdrawal(out);
          return res;
        } else {
          throw new SDKError(
              response,
