...
public class InvestorCommunicationServiceBatchCreateUploadLinks {
  ...
  abstract static class Base {
    ...
    <T, U> HttpRequest buildRequest(T request, TypeReference<U> typeReference) throws Exception {
      String url = Utils.generateURL(this.baseUrl, "/investordocs/v1/uploadLinks:batchCreate");
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(BatchCreateUploadLinksRequestCreate request)
        throws Exception {
      HttpRequest req =
          buildRequest(request, new TypeReference<BatchCreateUploadLinksRequestCreate>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(BatchCreateUploadLinksRequestCreate request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public InvestorCommunicationServiceBatchCreateUploadLinksResponse handleResponse(
      ...
      InvestorCommunicationServiceBatchCreateUploadLinksResponse.Builder resBuilder =
          InvestorCommunicationServiceBatchCreateUploadLinksResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      InvestorCommunicationServiceBatchCreateUploadLinksResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          BatchCreateUploadLinksResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withBatchCreateUploadLinksResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
