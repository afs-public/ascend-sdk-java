...
public class CheckWithdrawalSchedulesCreateCheckWithdrawalSchedule {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "CheckWithdrawalSchedules_CreateCheckWithdrawalSchedule",
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/transfers/v1/accounts/{account_id}/checkWithdrawalSchedules",
              request,
              null);
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "checkWithdrawalScheduleCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(
        CheckWithdrawalSchedulesCreateCheckWithdrawalScheduleRequest request) throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              CheckWithdrawalSchedulesCreateCheckWithdrawalScheduleRequest.class,
              new TypeReference<CheckWithdrawalSchedulesCreateCheckWithdrawalScheduleRequest>() {});
    ...
    @Override
    public CheckWithdrawalSchedulesCreateCheckWithdrawalScheduleResponse handleResponse(
      ...
      CheckWithdrawalSchedulesCreateCheckWithdrawalScheduleResponse.Builder resBuilder =
          CheckWithdrawalSchedulesCreateCheckWithdrawalScheduleResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      CheckWithdrawalSchedulesCreateCheckWithdrawalScheduleResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          CheckWithdrawalSchedule out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withCheckWithdrawalSchedule(out);
          return res;
        } else {
          throw new SDKError(
              response,
