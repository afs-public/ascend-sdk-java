...
public class TransferScheduleSummariesListScheduleSummaries {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(TransferScheduleSummariesListScheduleSummariesRequest request)
        throws Exception {
      String url = Utils.generateURL(this.baseUrl, "/transfers/v1/schedules");
  ...
  public static class Sync extends Base
    ...
    public HttpResponse<InputStream> doRequest(
        TransferScheduleSummariesListScheduleSummariesRequest request) throws Exception {
    ...
    @Override
    public TransferScheduleSummariesListScheduleSummariesResponse handleResponse(
      ...
      TransferScheduleSummariesListScheduleSummariesResponse.Builder resBuilder =
          TransferScheduleSummariesListScheduleSummariesResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      TransferScheduleSummariesListScheduleSummariesResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListScheduleSummariesResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListScheduleSummariesResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
