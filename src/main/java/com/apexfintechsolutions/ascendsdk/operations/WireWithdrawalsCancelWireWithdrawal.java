...
public class WireWithdrawalsCancelWireWithdrawal {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "cancelWireWithdrawalRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(WireWithdrawalsCancelWireWithdrawalRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              WireWithdrawalsCancelWireWithdrawalRequest.class,
              new TypeReference<WireWithdrawalsCancelWireWithdrawalRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(WireWithdrawalsCancelWireWithdrawalRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public WireWithdrawalsCancelWireWithdrawalResponse handleResponse(
      ...
      WireWithdrawalsCancelWireWithdrawalResponse.Builder resBuilder =
          WireWithdrawalsCancelWireWithdrawalResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      WireWithdrawalsCancelWireWithdrawalResponse res = resBuilder.build();
