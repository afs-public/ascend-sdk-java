...
public class CheckWithdrawalSchedulesListCheckWithdrawalSchedules {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "CheckWithdrawalSchedules_ListCheckWithdrawalSchedules",
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(
        CheckWithdrawalSchedulesListCheckWithdrawalSchedulesRequest request) throws Exception {
      HttpRequest req =
          buildRequest(request, CheckWithdrawalSchedulesListCheckWithdrawalSchedulesRequest.class);
    ...
    @Override
    public CheckWithdrawalSchedulesListCheckWithdrawalSchedulesResponse handleResponse(
      ...
      CheckWithdrawalSchedulesListCheckWithdrawalSchedulesResponse.Builder resBuilder =
          CheckWithdrawalSchedulesListCheckWithdrawalSchedulesResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      CheckWithdrawalSchedulesListCheckWithdrawalSchedulesResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListCheckWithdrawalSchedulesResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListCheckWithdrawalSchedulesResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
