...
public class MarginsRealTimeGetBuyingPower {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(MarginsRealTimeGetBuyingPowerRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, MarginsRealTimeGetBuyingPowerRequest.class);
