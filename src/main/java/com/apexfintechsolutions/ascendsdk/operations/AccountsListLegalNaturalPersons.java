...
public class AccountsListLegalNaturalPersons {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(AccountsListLegalNaturalPersonsRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, AccountsListLegalNaturalPersonsRequest.class);
