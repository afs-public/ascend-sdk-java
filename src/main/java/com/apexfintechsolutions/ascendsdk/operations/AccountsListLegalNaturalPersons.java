...
public class AccountsListLegalNaturalPersons {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(AccountsListLegalNaturalPersonsRequest request) throws Exception {
      String url = Utils.generateURL(this.baseUrl, "/accounts/v1/legalNaturalPersons");
  ...
  public static class Sync extends Base
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountsListLegalNaturalPersonsRequest request)
        throws Exception {
    ...
    @Override
    public AccountsListLegalNaturalPersonsResponse handleResponse(
      ...
      AccountsListLegalNaturalPersonsResponse.Builder resBuilder =
          AccountsListLegalNaturalPersonsResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsListLegalNaturalPersonsResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListLegalNaturalPersonsResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListLegalNaturalPersonsResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
