...
public class AlternativeInvestmentsGetAlternativeInvestment {
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/trading/v1/assets/{asset_id}/alternativeInvestment",
              request,
              null);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(
        AlternativeInvestmentsGetAlternativeInvestmentRequest request) throws Exception {
      HttpRequest req =
          buildRequest(request, AlternativeInvestmentsGetAlternativeInvestmentRequest.class);
    ...
    @Override
    public AlternativeInvestmentsGetAlternativeInvestmentResponse handleResponse(
      ...
      AlternativeInvestmentsGetAlternativeInvestmentResponse.Builder resBuilder =
          AlternativeInvestmentsGetAlternativeInvestmentResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AlternativeInvestmentsGetAlternativeInvestmentResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          AlternativeInvestment out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withAlternativeInvestment(out);
          return res;
        } else {
          throw new SDKError(
              response,
