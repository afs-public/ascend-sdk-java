...
public class AssetsListAssets1 {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(AssetsListAssets1Request request) throws Exception {
      HttpRequest req = buildRequest(request, AssetsListAssets1Request.class);
