...
public class AccountAccreditationServiceGetAccountAccreditation {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "AccountAccreditationService_GetAccountAccreditation",
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/trading/v1/accounts/{account_id}/accreditation",
              request,
              null);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(
        AccountAccreditationServiceGetAccountAccreditationRequest request) throws Exception {
      HttpRequest req =
          buildRequest(request, AccountAccreditationServiceGetAccountAccreditationRequest.class);
    ...
    @Override
    public AccountAccreditationServiceGetAccountAccreditationResponse handleResponse(
      ...
      AccountAccreditationServiceGetAccountAccreditationResponse.Builder resBuilder =
          AccountAccreditationServiceGetAccountAccreditationResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountAccreditationServiceGetAccountAccreditationResponse res = resBuilder.build();
