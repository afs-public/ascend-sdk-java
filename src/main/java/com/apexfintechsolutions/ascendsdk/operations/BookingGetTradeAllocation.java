...
public class BookingGetTradeAllocation {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(BookingGetTradeAllocationRequest request) throws Exception {
      HttpRequest req = buildRequest(request, BookingGetTradeAllocationRequest.class);
