...
public class BookingGetTradeAllocation {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(BookingGetTradeAllocationRequest request) throws Exception {
      String url =
          Utils.generateURL(
  ...
  public static class Sync extends Base
      implements RequestOperation<
          BookingGetTradeAllocationRequest, BookingGetTradeAllocationResponse> {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(BookingGetTradeAllocationRequest request)
        throws Exception {
    ...
    @Override
    public BookingGetTradeAllocationResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      BookingGetTradeAllocationResponse.Builder resBuilder =
          BookingGetTradeAllocationResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      BookingGetTradeAllocationResponse res = resBuilder.build();
