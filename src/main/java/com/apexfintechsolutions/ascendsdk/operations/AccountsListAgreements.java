...
public class AccountsListAgreements {
  ...
  abstract static class Base {
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url =
          Utils.generateURL(
              klass, this.baseUrl, "/accounts/v1/accounts/{account_id}/agreements", request, null);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(AccountsListAgreementsRequest request) throws Exception {
      HttpRequest req = buildRequest(request, AccountsListAgreementsRequest.class);
