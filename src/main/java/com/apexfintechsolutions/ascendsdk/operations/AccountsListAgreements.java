...
public class AccountsListAgreements {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(AccountsListAgreementsRequest request) throws Exception {
      String url =
          Utils.generateURL(
      ...
      req.addQueryParams(Utils.getQueryParams(AccountsListAgreementsRequest.class, request, null));
  ...
  public static class Sync extends Base
      implements RequestOperation<AccountsListAgreementsRequest, AccountsListAgreementsResponse> {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountsListAgreementsRequest request)
        throws Exception {
    ...
    @Override
    public AccountsListAgreementsResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AccountsListAgreementsResponse.Builder resBuilder =
          AccountsListAgreementsResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsListAgreementsResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListAgreementsResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListAgreementsResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
