...
public class WireWithdrawalSchedulesCreateWireWithdrawalSchedule {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "wireWithdrawalScheduleCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(
        WireWithdrawalSchedulesCreateWireWithdrawalScheduleRequest request) throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              WireWithdrawalSchedulesCreateWireWithdrawalScheduleRequest.class,
              new TypeReference<WireWithdrawalSchedulesCreateWireWithdrawalScheduleRequest>() {});
                  ...
                  () -> {
                    ...
                    try {
                      ...
                      if (Utils.statusCodeMatches(
                          httpRes.statusCode(), "400", "403", "409", "4XX", "5XX")) {
    ...
    @Override
    public WireWithdrawalSchedulesCreateWireWithdrawalScheduleResponse handleResponse(
      ...
      WireWithdrawalSchedulesCreateWireWithdrawalScheduleResponse.Builder resBuilder =
          WireWithdrawalSchedulesCreateWireWithdrawalScheduleResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      WireWithdrawalSchedulesCreateWireWithdrawalScheduleResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          WireWithdrawalSchedule out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withWireWithdrawalSchedule(out);
          return res;
        } else {
          throw new SDKError(
              response,
      ...
      if (Utils.statusCodeMatches(response.statusCode(), "400", "403", "409")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
