...
public class AccountsListAvailableEnrollments {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(AccountsListAvailableEnrollmentsRequest request) throws Exception {
      String url =
          Utils.generateURL(
  ...
  public static class Sync extends Base
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountsListAvailableEnrollmentsRequest request)
        throws Exception {
    ...
    @Override
    public AccountsListAvailableEnrollmentsResponse handleResponse(
      ...
      AccountsListAvailableEnrollmentsResponse.Builder resBuilder =
          AccountsListAvailableEnrollmentsResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsListAvailableEnrollmentsResponse res = resBuilder.build();
