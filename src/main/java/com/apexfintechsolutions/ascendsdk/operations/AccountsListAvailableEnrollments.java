...
public class AccountsListAvailableEnrollments {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(AccountsListAvailableEnrollmentsRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, AccountsListAvailableEnrollmentsRequest.class);
