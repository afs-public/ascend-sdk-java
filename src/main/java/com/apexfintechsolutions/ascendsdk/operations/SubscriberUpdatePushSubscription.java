...
public class SubscriberUpdatePushSubscription {
  ...
  abstract static class Base {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      String url =
          Utils.generateURL(
              klass, this.baseUrl, "/events/v1/subscriptions/{subscription_id}", request, null);
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "pushSubscriptionUpdate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(SubscriberUpdatePushSubscriptionRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              SubscriberUpdatePushSubscriptionRequest.class,
              new TypeReference<SubscriberUpdatePushSubscriptionRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(SubscriberUpdatePushSubscriptionRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public SubscriberUpdatePushSubscriptionResponse handleResponse(
