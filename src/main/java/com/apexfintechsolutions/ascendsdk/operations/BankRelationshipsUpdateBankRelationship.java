...
public class BankRelationshipsUpdateBankRelationship {
  ...
  abstract static class Base {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "bankRelationshipUpdate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(BankRelationshipsUpdateBankRelationshipRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              BankRelationshipsUpdateBankRelationshipRequest.class,
              new TypeReference<BankRelationshipsUpdateBankRelationshipRequest>() {});
    ...
    public HttpResponse<InputStream> doRequest(
        BankRelationshipsUpdateBankRelationshipRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public BankRelationshipsUpdateBankRelationshipResponse handleResponse(
      ...
      BankRelationshipsUpdateBankRelationshipResponse.Builder resBuilder =
          BankRelationshipsUpdateBankRelationshipResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      BankRelationshipsUpdateBankRelationshipResponse res = resBuilder.build();
