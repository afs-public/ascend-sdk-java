...
public class IctWithdrawalsForceRejectIctWithdrawal {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "forceRejectIctWithdrawalRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(IctWithdrawalsForceRejectIctWithdrawalRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              IctWithdrawalsForceRejectIctWithdrawalRequest.class,
              new TypeReference<IctWithdrawalsForceRejectIctWithdrawalRequest>() {});
    ...
    public HttpResponse<InputStream> doRequest(
        IctWithdrawalsForceRejectIctWithdrawalRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public IctWithdrawalsForceRejectIctWithdrawalResponse handleResponse(
      ...
      IctWithdrawalsForceRejectIctWithdrawalResponse.Builder resBuilder =
          IctWithdrawalsForceRejectIctWithdrawalResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      IctWithdrawalsForceRejectIctWithdrawalResponse res = resBuilder.build();
