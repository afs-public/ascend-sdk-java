...
public class OrderServiceListCorrespondentOrders {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "OrderService_ListCorrespondentOrders",
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(OrderServiceListCorrespondentOrdersRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, OrderServiceListCorrespondentOrdersRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(OrderServiceListCorrespondentOrdersRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public OrderServiceListCorrespondentOrdersResponse handleResponse(
      ...
      OrderServiceListCorrespondentOrdersResponse.Builder resBuilder =
          OrderServiceListCorrespondentOrdersResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      OrderServiceListCorrespondentOrdersResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListCorrespondentOrdersResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListCorrespondentOrdersResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
