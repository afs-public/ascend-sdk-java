...
public class InvestigationServiceUpdateInvestigation {
  ...
  abstract static class Base {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "investigationUpdate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(InvestigationServiceUpdateInvestigationRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              InvestigationServiceUpdateInvestigationRequest.class,
              new TypeReference<InvestigationServiceUpdateInvestigationRequest>() {});
    ...
    public HttpResponse<InputStream> doRequest(
        InvestigationServiceUpdateInvestigationRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public InvestigationServiceUpdateInvestigationResponse handleResponse(
      ...
      InvestigationServiceUpdateInvestigationResponse.Builder resBuilder =
          InvestigationServiceUpdateInvestigationResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      InvestigationServiceUpdateInvestigationResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          Investigation out = Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withInvestigation(out);
          return res;
        } else {
          throw new SDKError(
              response,
