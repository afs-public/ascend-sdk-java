...
public class BasketOrdersServiceGetBasket {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(BasketOrdersServiceGetBasketRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, BasketOrdersServiceGetBasketRequest.class);
