...
public class BasketOrdersServiceGetBasket {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(BasketOrdersServiceGetBasketRequest request) throws Exception {
      String url =
          Utils.generateURL(
  ...
  public static class Sync extends Base
      implements RequestOperation<
          BasketOrdersServiceGetBasketRequest, BasketOrdersServiceGetBasketResponse> {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(BasketOrdersServiceGetBasketRequest request)
        throws Exception {
    ...
    @Override
    public BasketOrdersServiceGetBasketResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      BasketOrdersServiceGetBasketResponse.Builder resBuilder =
          BasketOrdersServiceGetBasketResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      BasketOrdersServiceGetBasketResponse res = resBuilder.build();
