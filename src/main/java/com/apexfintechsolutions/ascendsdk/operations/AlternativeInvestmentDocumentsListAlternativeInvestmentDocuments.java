...
public class AlternativeInvestmentDocumentsListAlternativeInvestmentDocuments {
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/trading/v1/assets/{asset_id}/alternativeInvestmentDocuments",
              request,
              null);
  ...
  public static class Sync extends Base
                  ...
                  () -> {
                    ...
                    try {
                      ...
                      if (Utils.statusCodeMatches(
                          httpRes.statusCode(), "400", "401", "403", "4XX", "500", "5XX")) {
    ...
    @Override
    public AlternativeInvestmentDocumentsListAlternativeInvestmentDocumentsResponse handleResponse(
      ...
      AlternativeInvestmentDocumentsListAlternativeInvestmentDocumentsResponse.Builder resBuilder =
          AlternativeInvestmentDocumentsListAlternativeInvestmentDocumentsResponse.builder()
      ...
      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListAlternativeInvestmentDocumentsResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListAlternativeInvestmentDocumentsResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
