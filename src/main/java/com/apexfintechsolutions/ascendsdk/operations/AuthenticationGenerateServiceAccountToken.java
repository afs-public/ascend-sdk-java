...
public class AuthenticationGenerateServiceAccountToken {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(GenerateServiceAccountTokenRequestCreate request)
        throws Exception {
      HttpRequest req =
          buildRequest(request, new TypeReference<GenerateServiceAccountTokenRequestCreate>() {});
                  ...
                  () -> {
                    ...
                    try {
                      ...
                      if (Utils.statusCodeMatches(
                          httpRes.statusCode(), "400", "401", "4XX", "500", "5XX")) {
