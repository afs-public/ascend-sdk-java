...
public class AccountsUpdateAccount {
  ...
  abstract static class Base {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      String url =
          Utils.generateURL(
              klass, this.baseUrl, "/accounts/v1/accounts/{account_id}", request, null);
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "accountRequestUpdate", "json", false);
  ...
  public static class Sync extends Base
      implements RequestOperation<AccountsUpdateAccountRequest, AccountsUpdateAccountResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(AccountsUpdateAccountRequest request) throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              AccountsUpdateAccountRequest.class,
              new TypeReference<AccountsUpdateAccountRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountsUpdateAccountRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public AccountsUpdateAccountResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AccountsUpdateAccountResponse.Builder resBuilder =
          AccountsUpdateAccountResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsUpdateAccountResponse res = resBuilder.build();
