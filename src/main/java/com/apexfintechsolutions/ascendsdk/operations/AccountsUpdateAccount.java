...
public class AccountsUpdateAccount {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(AccountsUpdateAccountRequest request) throws Exception {
      String url =
          Utils.generateURL(
      ...
      req.addQueryParams(Utils.getQueryParams(AccountsUpdateAccountRequest.class, request, null));
