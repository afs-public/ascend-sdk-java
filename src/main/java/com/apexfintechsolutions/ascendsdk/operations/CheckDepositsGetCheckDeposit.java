...
public class CheckDepositsGetCheckDeposit {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(CheckDepositsGetCheckDepositRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, CheckDepositsGetCheckDepositRequest.class);
