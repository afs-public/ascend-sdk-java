...
public class AchWithdrawalSchedulesCancelAchWithdrawalSchedule {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "cancelAchWithdrawalScheduleRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(
        AchWithdrawalSchedulesCancelAchWithdrawalScheduleRequest request) throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              AchWithdrawalSchedulesCancelAchWithdrawalScheduleRequest.class,
              new TypeReference<AchWithdrawalSchedulesCancelAchWithdrawalScheduleRequest>() {});
    ...
    @Override
    public AchWithdrawalSchedulesCancelAchWithdrawalScheduleResponse handleResponse(
      ...
      AchWithdrawalSchedulesCancelAchWithdrawalScheduleResponse.Builder resBuilder =
          AchWithdrawalSchedulesCancelAchWithdrawalScheduleResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AchWithdrawalSchedulesCancelAchWithdrawalScheduleResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          AchWithdrawalSchedule out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withAchWithdrawalSchedule(out);
          return res;
        } else {
          throw new SDKError(
              response,
