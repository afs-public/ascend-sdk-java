...
public class AccountsUpdateTrustedContact {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(AccountsUpdateTrustedContactRequest request) throws Exception {
      String url =
          Utils.generateURL(
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "trustedContactUpdate", "json", false);
  ...
  public static class Sync extends Base
      implements RequestOperation<
          AccountsUpdateTrustedContactRequest, AccountsUpdateTrustedContactResponse> {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountsUpdateTrustedContactRequest request)
        throws Exception {
      ...
      try {
        ...
        if (Utils.statusCodeMatches(
            httpRes.statusCode(), "400", "403", "404", "4XX", "500", "503", "5XX")) {
    ...
    @Override
    public AccountsUpdateTrustedContactResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AccountsUpdateTrustedContactResponse.Builder resBuilder =
          AccountsUpdateTrustedContactResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsUpdateTrustedContactResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          TrustedContact out = Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withTrustedContact(out);
          return res;
        } else {
          throw new SDKError(
              response,
