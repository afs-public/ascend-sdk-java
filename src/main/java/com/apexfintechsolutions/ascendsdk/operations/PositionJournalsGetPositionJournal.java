...
public class PositionJournalsGetPositionJournal {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "PositionJournals_GetPositionJournal",
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/transfers/v1/positionJournals/{positionJournal_id}",
              request,
              null);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(PositionJournalsGetPositionJournalRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, PositionJournalsGetPositionJournalRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(PositionJournalsGetPositionJournalRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public PositionJournalsGetPositionJournalResponse handleResponse(
      ...
      PositionJournalsGetPositionJournalResponse.Builder resBuilder =
          PositionJournalsGetPositionJournalResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      PositionJournalsGetPositionJournalResponse res = resBuilder.build();
