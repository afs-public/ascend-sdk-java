...
public class PositionJournalsCreatePositionJournal {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "PositionJournals_CreatePositionJournal",
    ...
    <T, U> HttpRequest buildRequest(T request, TypeReference<U> typeReference) throws Exception {
      String url = Utils.generateURL(this.baseUrl, "/transfers/v1/positionJournals");
  ...
  public static class Sync extends Base
      implements RequestOperation<
          PositionJournalCreate, PositionJournalsCreatePositionJournalResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(PositionJournalCreate request) throws Exception {
      HttpRequest req = buildRequest(request, new TypeReference<PositionJournalCreate>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(PositionJournalCreate request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public PositionJournalsCreatePositionJournalResponse handleResponse(
      ...
      PositionJournalsCreatePositionJournalResponse.Builder resBuilder =
          PositionJournalsCreatePositionJournalResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      PositionJournalsCreatePositionJournalResponse res = resBuilder.build();
