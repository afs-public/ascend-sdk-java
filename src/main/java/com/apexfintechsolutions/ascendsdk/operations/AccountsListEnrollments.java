...
public class AccountsListEnrollments {
  ...
  abstract static class Base {
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url =
          Utils.generateURL(
              klass, this.baseUrl, "/accounts/v1/accounts/{account_id}/enrollments", request, null);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(AccountsListEnrollmentsRequest request) throws Exception {
      HttpRequest req = buildRequest(request, AccountsListEnrollmentsRequest.class);
