...
public class AccountsListEnrollments {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(AccountsListEnrollmentsRequest request) throws Exception {
      String url =
          Utils.generateURL(
      ...
      req.addQueryParams(Utils.getQueryParams(AccountsListEnrollmentsRequest.class, request, null));
  ...
  public static class Sync extends Base
      implements RequestOperation<AccountsListEnrollmentsRequest, AccountsListEnrollmentsResponse> {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountsListEnrollmentsRequest request)
        throws Exception {
    ...
    @Override
    public AccountsListEnrollmentsResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AccountsListEnrollmentsResponse.Builder resBuilder =
          AccountsListEnrollmentsResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsListEnrollmentsResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListEnrollmentsResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListEnrollmentsResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
