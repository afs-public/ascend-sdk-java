...
public class RetirementConstraintsRetrieveDistributionConstraints {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "retrieveDistributionConstraintsRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(
        RetirementConstraintsRetrieveDistributionConstraintsRequest request) throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              RetirementConstraintsRetrieveDistributionConstraintsRequest.class,
              new TypeReference<RetirementConstraintsRetrieveDistributionConstraintsRequest>() {});
    ...
    @Override
    public RetirementConstraintsRetrieveDistributionConstraintsResponse handleResponse(
      ...
      RetirementConstraintsRetrieveDistributionConstraintsResponse.Builder resBuilder =
          RetirementConstraintsRetrieveDistributionConstraintsResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      RetirementConstraintsRetrieveDistributionConstraintsResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          DistributionConstraints out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withDistributionConstraints(out);
          return res;
        } else {
          throw new SDKError(
              response,
