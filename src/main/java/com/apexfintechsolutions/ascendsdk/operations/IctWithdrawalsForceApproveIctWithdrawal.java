...
public class IctWithdrawalsForceApproveIctWithdrawal {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "forceApproveIctWithdrawalRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(IctWithdrawalsForceApproveIctWithdrawalRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              IctWithdrawalsForceApproveIctWithdrawalRequest.class,
              new TypeReference<IctWithdrawalsForceApproveIctWithdrawalRequest>() {});
    ...
    public HttpResponse<InputStream> doRequest(
        IctWithdrawalsForceApproveIctWithdrawalRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public IctWithdrawalsForceApproveIctWithdrawalResponse handleResponse(
      ...
      IctWithdrawalsForceApproveIctWithdrawalResponse.Builder resBuilder =
          IctWithdrawalsForceApproveIctWithdrawalResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      IctWithdrawalsForceApproveIctWithdrawalResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          IctWithdrawal out = Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withIctWithdrawal(out);
          return res;
        } else {
          throw new SDKError(
              response,
