...
public class AccountsEndLargeTraderLegalNaturalPerson {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "endLargeTraderRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(AccountsEndLargeTraderLegalNaturalPersonRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              AccountsEndLargeTraderLegalNaturalPersonRequest.class,
              new TypeReference<AccountsEndLargeTraderLegalNaturalPersonRequest>() {});
    ...
    public HttpResponse<InputStream> doRequest(
        AccountsEndLargeTraderLegalNaturalPersonRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public AccountsEndLargeTraderLegalNaturalPersonResponse handleResponse(
      ...
      AccountsEndLargeTraderLegalNaturalPersonResponse.Builder resBuilder =
          AccountsEndLargeTraderLegalNaturalPersonResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsEndLargeTraderLegalNaturalPersonResponse res = resBuilder.build();
