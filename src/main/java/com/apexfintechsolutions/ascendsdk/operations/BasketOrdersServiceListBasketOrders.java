...
public class BasketOrdersServiceListBasketOrders {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(BasketOrdersServiceListBasketOrdersRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, BasketOrdersServiceListBasketOrdersRequest.class);
