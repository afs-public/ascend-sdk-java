...
public class BasketOrdersServiceListBasketOrders {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(BasketOrdersServiceListBasketOrdersRequest request) throws Exception {
      String url =
          Utils.generateURL(
  ...
  public static class Sync extends Base
    ...
    @Override
    public HttpResponse<InputStream> doRequest(BasketOrdersServiceListBasketOrdersRequest request)
        throws Exception {
    ...
    @Override
    public BasketOrdersServiceListBasketOrdersResponse handleResponse(
      ...
      BasketOrdersServiceListBasketOrdersResponse.Builder resBuilder =
          BasketOrdersServiceListBasketOrdersResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      BasketOrdersServiceListBasketOrdersResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListBasketOrdersResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListBasketOrdersResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
