...
public class AccountsListAvailableRestrictions {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(AccountsListAvailableRestrictionsRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, AccountsListAvailableRestrictionsRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountsListAvailableRestrictionsRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public AccountsListAvailableRestrictionsResponse handleResponse(
      ...
      AccountsListAvailableRestrictionsResponse.Builder resBuilder =
          AccountsListAvailableRestrictionsResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsListAvailableRestrictionsResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListAvailableRestrictionsResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListAvailableRestrictionsResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
