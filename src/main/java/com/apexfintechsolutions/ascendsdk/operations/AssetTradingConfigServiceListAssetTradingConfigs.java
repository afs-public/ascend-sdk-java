...
public class AssetTradingConfigServiceListAssetTradingConfigs {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "AssetTradingConfigService_ListAssetTradingConfigs",
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/assettradingconfig/v1/correspondents/{correspondent_id}/assets/{asset_id}/tradingConfigs",
              request,
              null);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(
      ...
      HttpRequest req =
          buildRequest(request, AssetTradingConfigServiceListAssetTradingConfigsRequest.class);
    ...
    @Override
    public AssetTradingConfigServiceListAssetTradingConfigsResponse handleResponse(
      ...
      AssetTradingConfigServiceListAssetTradingConfigsResponse.Builder resBuilder =
          AssetTradingConfigServiceListAssetTradingConfigsResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AssetTradingConfigServiceListAssetTradingConfigsResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListAssetTradingConfigsResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListAssetTradingConfigsResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
