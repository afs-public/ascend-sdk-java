...
public class CashJournalSchedulesCreateCashJournalSchedule {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "CashJournalSchedules_CreateCashJournalSchedule",
    ...
    <T, U> HttpRequest buildRequest(T request, TypeReference<U> typeReference) throws Exception {
      String url = Utils.generateURL(this.baseUrl, "/transfers/v1/cashJournalSchedules");
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(CashJournalScheduleCreate request) throws Exception {
      HttpRequest req = buildRequest(request, new TypeReference<CashJournalScheduleCreate>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(CashJournalScheduleCreate request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public CashJournalSchedulesCreateCashJournalScheduleResponse handleResponse(
      ...
      CashJournalSchedulesCreateCashJournalScheduleResponse.Builder resBuilder =
          CashJournalSchedulesCreateCashJournalScheduleResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      CashJournalSchedulesCreateCashJournalScheduleResponse res = resBuilder.build();
