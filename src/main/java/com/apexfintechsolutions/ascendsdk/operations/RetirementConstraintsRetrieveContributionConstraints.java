...
public class RetirementConstraintsRetrieveContributionConstraints {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "retrieveContributionConstraintsRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(
        RetirementConstraintsRetrieveContributionConstraintsRequest request) throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              RetirementConstraintsRetrieveContributionConstraintsRequest.class,
              new TypeReference<RetirementConstraintsRetrieveContributionConstraintsRequest>() {});
    ...
    @Override
    public RetirementConstraintsRetrieveContributionConstraintsResponse handleResponse(
      ...
      RetirementConstraintsRetrieveContributionConstraintsResponse.Builder resBuilder =
          RetirementConstraintsRetrieveContributionConstraintsResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      RetirementConstraintsRetrieveContributionConstraintsResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ContributionConstraints out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withContributionConstraints(out);
          return res;
        } else {
          throw new SDKError(
              response,
