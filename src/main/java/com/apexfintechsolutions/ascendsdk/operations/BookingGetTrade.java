...
public class BookingGetTrade {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(BookingGetTradeRequest request) throws Exception {
      String url =
          Utils.generateURL(
  ...
  public static class Sync extends Base
      implements RequestOperation<BookingGetTradeRequest, BookingGetTradeResponse> {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(BookingGetTradeRequest request) throws Exception {
    ...
    @Override
    public BookingGetTradeResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      BookingGetTradeResponse.Builder resBuilder =
          BookingGetTradeResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      BookingGetTradeResponse res = resBuilder.build();
