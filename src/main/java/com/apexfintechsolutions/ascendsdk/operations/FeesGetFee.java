...
public class FeesGetFee {
  ...
  public static class Sync extends Base
      implements RequestOperation<FeesGetFeeRequest, FeesGetFeeResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(FeesGetFeeRequest request) throws Exception {
      HttpRequest req = buildRequest(request, FeesGetFeeRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(FeesGetFeeRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public FeesGetFeeResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      FeesGetFeeResponse.Builder resBuilder =
          FeesGetFeeResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      FeesGetFeeResponse res = resBuilder.build();
