...
public class PositionJournalsCancelPositionJournal {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "PositionJournals_CancelPositionJournal",
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/transfers/v1/positionJournals/{positionJournal_id}:cancel",
              request,
              null);
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "cancelPositionJournalRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(PositionJournalsCancelPositionJournalRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              PositionJournalsCancelPositionJournalRequest.class,
              new TypeReference<PositionJournalsCancelPositionJournalRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(PositionJournalsCancelPositionJournalRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public PositionJournalsCancelPositionJournalResponse handleResponse(
      ...
      PositionJournalsCancelPositionJournalResponse.Builder resBuilder =
          PositionJournalsCancelPositionJournalResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      PositionJournalsCancelPositionJournalResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          PositionJournal out = Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withPositionJournal(out);
          return res;
        } else {
          throw new SDKError(
              response,
