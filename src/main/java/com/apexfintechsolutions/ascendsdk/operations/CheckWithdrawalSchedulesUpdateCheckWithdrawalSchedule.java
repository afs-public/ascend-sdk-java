...
public class CheckWithdrawalSchedulesUpdateCheckWithdrawalSchedule {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "CheckWithdrawalSchedules_UpdateCheckWithdrawalSchedule",
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/transfers/v1/accounts/{account_id}/checkWithdrawalSchedules/{checkWithdrawalSchedule_id}",
              request,
              null);
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "checkWithdrawalScheduleUpdate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(
        CheckWithdrawalSchedulesUpdateCheckWithdrawalScheduleRequest request) throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              CheckWithdrawalSchedulesUpdateCheckWithdrawalScheduleRequest.class,
              new TypeReference<CheckWithdrawalSchedulesUpdateCheckWithdrawalScheduleRequest>() {});
    ...
    @Override
    public CheckWithdrawalSchedulesUpdateCheckWithdrawalScheduleResponse handleResponse(
      ...
      CheckWithdrawalSchedulesUpdateCheckWithdrawalScheduleResponse.Builder resBuilder =
          CheckWithdrawalSchedulesUpdateCheckWithdrawalScheduleResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      CheckWithdrawalSchedulesUpdateCheckWithdrawalScheduleResponse res = resBuilder.build();
