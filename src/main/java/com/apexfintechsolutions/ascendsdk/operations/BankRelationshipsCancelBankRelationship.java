...
public class BankRelationshipsCancelBankRelationship {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "cancelBankRelationshipRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(BankRelationshipsCancelBankRelationshipRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              BankRelationshipsCancelBankRelationshipRequest.class,
              new TypeReference<BankRelationshipsCancelBankRelationshipRequest>() {});
    ...
    public HttpResponse<InputStream> doRequest(
        BankRelationshipsCancelBankRelationshipRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public BankRelationshipsCancelBankRelationshipResponse handleResponse(
      ...
      BankRelationshipsCancelBankRelationshipResponse.Builder resBuilder =
          BankRelationshipsCancelBankRelationshipResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      BankRelationshipsCancelBankRelationshipResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          BankRelationship out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withBankRelationship(out);
          return res;
        } else {
          throw new SDKError(
              response,
