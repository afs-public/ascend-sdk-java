...
public class AchDepositsForceNocAchDeposit {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "forceNocAchDepositRequestCreate", "json", false);
  ...
  public static class Sync extends Base
      implements RequestOperation<
          AchDepositsForceNocAchDepositRequest, AchDepositsForceNocAchDepositResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(AchDepositsForceNocAchDepositRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              AchDepositsForceNocAchDepositRequest.class,
              new TypeReference<AchDepositsForceNocAchDepositRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AchDepositsForceNocAchDepositRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public AchDepositsForceNocAchDepositResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AchDepositsForceNocAchDepositResponse.Builder resBuilder =
          AchDepositsForceNocAchDepositResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AchDepositsForceNocAchDepositResponse res = resBuilder.build();
