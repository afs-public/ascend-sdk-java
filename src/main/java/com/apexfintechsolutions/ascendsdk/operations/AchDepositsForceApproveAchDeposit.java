...
public class AchDepositsForceApproveAchDeposit {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "forceApproveAchDepositRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(AchDepositsForceApproveAchDepositRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              AchDepositsForceApproveAchDepositRequest.class,
              new TypeReference<AchDepositsForceApproveAchDepositRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AchDepositsForceApproveAchDepositRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public AchDepositsForceApproveAchDepositResponse handleResponse(
      ...
      AchDepositsForceApproveAchDepositResponse.Builder resBuilder =
          AchDepositsForceApproveAchDepositResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AchDepositsForceApproveAchDepositResponse res = resBuilder.build();
