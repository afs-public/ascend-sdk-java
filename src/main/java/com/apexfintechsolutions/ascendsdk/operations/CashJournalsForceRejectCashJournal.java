...
public class CashJournalsForceRejectCashJournal {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "forceRejectCashJournalRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(CashJournalsForceRejectCashJournalRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              CashJournalsForceRejectCashJournalRequest.class,
              new TypeReference<CashJournalsForceRejectCashJournalRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(CashJournalsForceRejectCashJournalRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public CashJournalsForceRejectCashJournalResponse handleResponse(
      ...
      CashJournalsForceRejectCashJournalResponse.Builder resBuilder =
          CashJournalsForceRejectCashJournalResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      CashJournalsForceRejectCashJournalResponse res = resBuilder.build();
