...
public class OrderServiceCancelOrder {
  ...
  abstract static class Base {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "cancelOrderRequestCreate", "json", false);
  ...
  public static class Sync extends Base
      implements RequestOperation<OrderServiceCancelOrderRequest, OrderServiceCancelOrderResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(OrderServiceCancelOrderRequest request) throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              OrderServiceCancelOrderRequest.class,
              new TypeReference<OrderServiceCancelOrderRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(OrderServiceCancelOrderRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public OrderServiceCancelOrderResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      OrderServiceCancelOrderResponse.Builder resBuilder =
          OrderServiceCancelOrderResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      OrderServiceCancelOrderResponse res = resBuilder.build();
