...
public class BookingCancelTradeAllocation {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(BookingCancelTradeAllocationRequest request) throws Exception {
      String url =
          Utils.generateURL(
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "cancelTradeAllocationRequestCreate", "json", false);
  ...
  public static class Sync extends Base
      implements RequestOperation<
          BookingCancelTradeAllocationRequest, BookingCancelTradeAllocationResponse> {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(BookingCancelTradeAllocationRequest request)
        throws Exception {
    ...
    @Override
    public BookingCancelTradeAllocationResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      BookingCancelTradeAllocationResponse.Builder resBuilder =
          BookingCancelTradeAllocationResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      BookingCancelTradeAllocationResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          CancelTradeAllocationResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withCancelTradeAllocationResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
