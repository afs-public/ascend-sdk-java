...
public class ExerciseServiceGetOptionInstruction {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "ExerciseService_GetOptionInstruction",
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/options/v1/accounts/{account_id}/assets/{asset_id}/instructions/{instruction_id}",
              request,
              null);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(ExerciseServiceGetOptionInstructionRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, ExerciseServiceGetOptionInstructionRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(ExerciseServiceGetOptionInstructionRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public ExerciseServiceGetOptionInstructionResponse handleResponse(
      ...
      ExerciseServiceGetOptionInstructionResponse.Builder resBuilder =
          ExerciseServiceGetOptionInstructionResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      ExerciseServiceGetOptionInstructionResponse res = resBuilder.build();
