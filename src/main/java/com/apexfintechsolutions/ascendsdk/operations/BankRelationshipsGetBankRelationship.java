...
public class BankRelationshipsGetBankRelationship {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(BankRelationshipsGetBankRelationshipRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, BankRelationshipsGetBankRelationshipRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(BankRelationshipsGetBankRelationshipRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public BankRelationshipsGetBankRelationshipResponse handleResponse(
      ...
      BankRelationshipsGetBankRelationshipResponse.Builder resBuilder =
          BankRelationshipsGetBankRelationshipResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      BankRelationshipsGetBankRelationshipResponse res = resBuilder.build();
