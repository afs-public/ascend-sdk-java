...
public class WatchlistServiceGetWatchlistItem {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(WatchlistServiceGetWatchlistItemRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, WatchlistServiceGetWatchlistItemRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(WatchlistServiceGetWatchlistItemRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public WatchlistServiceGetWatchlistItemResponse handleResponse(
      ...
      WatchlistServiceGetWatchlistItemResponse.Builder resBuilder =
          WatchlistServiceGetWatchlistItemResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      WatchlistServiceGetWatchlistItemResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          WatchlistItem out = Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withWatchlistItem(out);
          return res;
        } else {
          throw new SDKError(
              response,
