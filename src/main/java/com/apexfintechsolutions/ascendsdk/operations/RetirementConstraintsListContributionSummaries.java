...
public class RetirementConstraintsListContributionSummaries {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(RetirementConstraintsListContributionSummariesRequest request)
        throws Exception {
      String url =
          Utils.generateURL(
  ...
  public static class Sync extends Base
    ...
    public HttpResponse<InputStream> doRequest(
        RetirementConstraintsListContributionSummariesRequest request) throws Exception {
    ...
    @Override
    public RetirementConstraintsListContributionSummariesResponse handleResponse(
      ...
      RetirementConstraintsListContributionSummariesResponse.Builder resBuilder =
          RetirementConstraintsListContributionSummariesResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      RetirementConstraintsListContributionSummariesResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListContributionSummariesResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListContributionSummariesResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
