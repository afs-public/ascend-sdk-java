...
public class RetirementConstraintsRetrieveCashJournalConstraints {
  ...
  abstract static class Base {
    ...
    <T, U> HttpRequest buildRequest(T request, TypeReference<U> typeReference) throws Exception {
      String url =
          Utils.generateURL(
              this.baseUrl, "/transfers/v1/cashJournals:retrieveCashJournalConstraints");
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(RetrieveCashJournalConstraintsRequestCreate request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request, new TypeReference<RetrieveCashJournalConstraintsRequestCreate>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(RetrieveCashJournalConstraintsRequestCreate request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public RetirementConstraintsRetrieveCashJournalConstraintsResponse handleResponse(
      ...
      RetirementConstraintsRetrieveCashJournalConstraintsResponse.Builder resBuilder =
          RetirementConstraintsRetrieveCashJournalConstraintsResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      RetirementConstraintsRetrieveCashJournalConstraintsResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          CashJournalConstraints out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withCashJournalConstraints(out);
          return res;
        } else {
          throw new SDKError(
              response,
