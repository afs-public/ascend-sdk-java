...
public class CustomerIdentificationResultServiceGetCustomerIdentification {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(
      ...
      HttpRequest req =
          buildRequest(
              request, CustomerIdentificationResultServiceGetCustomerIdentificationRequest.class);
    ...
    @Override
    public CustomerIdentificationResultServiceGetCustomerIdentificationResponse handleResponse(
      ...
      CustomerIdentificationResultServiceGetCustomerIdentificationResponse.Builder resBuilder =
          CustomerIdentificationResultServiceGetCustomerIdentificationResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      CustomerIdentificationResultServiceGetCustomerIdentificationResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          CustomerIdentification out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withCustomerIdentification(out);
          return res;
        } else {
          throw new SDKError(
              response,
