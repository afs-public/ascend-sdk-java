...
public class OrderServiceGetOrder {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(OrderServiceGetOrderRequest request) throws Exception {
      HttpRequest req = buildRequest(request, OrderServiceGetOrderRequest.class);
