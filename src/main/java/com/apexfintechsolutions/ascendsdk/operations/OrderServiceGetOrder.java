...
public class OrderServiceGetOrder {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(OrderServiceGetOrderRequest request) throws Exception {
      String url =
          Utils.generateURL(
  ...
  public static class Sync extends Base
      implements RequestOperation<OrderServiceGetOrderRequest, OrderServiceGetOrderResponse> {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(OrderServiceGetOrderRequest request)
        throws Exception {
    ...
    @Override
    public OrderServiceGetOrderResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      OrderServiceGetOrderResponse.Builder resBuilder =
          OrderServiceGetOrderResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      OrderServiceGetOrderResponse res = resBuilder.build();
