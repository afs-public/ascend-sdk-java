...
public class PreIpoCompanyFundingRoundsListPreIpoCompanyFundingRounds {
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/trading/v1/preIpoCompanies/{preIpoCompany_id}/fundingRounds",
              request,
              null);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(
        PreIpoCompanyFundingRoundsListPreIpoCompanyFundingRoundsRequest request) throws Exception {
      HttpRequest req =
          buildRequest(
              request, PreIpoCompanyFundingRoundsListPreIpoCompanyFundingRoundsRequest.class);
    ...
    @Override
    public PreIpoCompanyFundingRoundsListPreIpoCompanyFundingRoundsResponse handleResponse(
      ...
      PreIpoCompanyFundingRoundsListPreIpoCompanyFundingRoundsResponse.Builder resBuilder =
          PreIpoCompanyFundingRoundsListPreIpoCompanyFundingRoundsResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      PreIpoCompanyFundingRoundsListPreIpoCompanyFundingRoundsResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListPreIpoCompanyFundingRoundsResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListPreIpoCompanyFundingRoundsResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
