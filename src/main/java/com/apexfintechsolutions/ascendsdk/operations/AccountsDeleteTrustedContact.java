...
public class AccountsDeleteTrustedContact {
  ...
  public static class Sync extends Base
      implements RequestOperation<
          AccountsDeleteTrustedContactRequest, AccountsDeleteTrustedContactResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(AccountsDeleteTrustedContactRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, AccountsDeleteTrustedContactRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountsDeleteTrustedContactRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public AccountsDeleteTrustedContactResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AccountsDeleteTrustedContactResponse.Builder resBuilder =
          AccountsDeleteTrustedContactResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsDeleteTrustedContactResponse res = resBuilder.build();
