...
public class AchWithdrawalsForceNocAchWithdrawal {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "forceNocAchWithdrawalRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(AchWithdrawalsForceNocAchWithdrawalRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              AchWithdrawalsForceNocAchWithdrawalRequest.class,
              new TypeReference<AchWithdrawalsForceNocAchWithdrawalRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AchWithdrawalsForceNocAchWithdrawalRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public AchWithdrawalsForceNocAchWithdrawalResponse handleResponse(
      ...
      AchWithdrawalsForceNocAchWithdrawalResponse.Builder resBuilder =
          AchWithdrawalsForceNocAchWithdrawalResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AchWithdrawalsForceNocAchWithdrawalResponse res = resBuilder.build();
