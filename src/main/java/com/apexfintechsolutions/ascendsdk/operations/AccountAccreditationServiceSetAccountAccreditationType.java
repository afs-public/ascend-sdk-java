...
public class AccountAccreditationServiceSetAccountAccreditationType {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "AccountAccreditationService_SetAccountAccreditationType",
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/trading/v1/accounts/{account_id}/accreditation:setType",
              request,
              null);
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "setAccountAccreditationTypeRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(
        AccountAccreditationServiceSetAccountAccreditationTypeRequest request) throws Exception {
      HttpRequest req =
          buildRequest(
              request,
    ...
    @Override
    public AccountAccreditationServiceSetAccountAccreditationTypeResponse handleResponse(
      ...
      AccountAccreditationServiceSetAccountAccreditationTypeResponse.Builder resBuilder =
          AccountAccreditationServiceSetAccountAccreditationTypeResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountAccreditationServiceSetAccountAccreditationTypeResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          AccountAccreditation out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withAccountAccreditation(out);
          return res;
        } else {
          throw new SDKError(
              response,
