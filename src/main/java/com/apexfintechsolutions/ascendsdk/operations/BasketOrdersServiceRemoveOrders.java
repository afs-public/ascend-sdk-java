...
public class BasketOrdersServiceRemoveOrders {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(BasketOrdersServiceRemoveOrdersRequest request) throws Exception {
      String url =
          Utils.generateURL(
              BasketOrdersServiceRemoveOrdersRequest.class,
              this.baseUrl,
              "/baskettrading/v1/correspondents/{correspondent_id}/baskets/{basket_id}:removeOrders",
              request,
              null);
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "removeOrdersRequestCreate", "json", false);
      ...
      return sdkConfiguration
          ...
          .beforeRequest(
              new BeforeRequestContextImpl(
                  ...
                  this.baseUrl,
                  "BasketOrdersService_RemoveOrders",
  ...
  public static class Sync extends Base
    ...
    @Override
    public HttpResponse<InputStream> doRequest(BasketOrdersServiceRemoveOrdersRequest request)
        throws Exception {
    ...
    @Override
    public BasketOrdersServiceRemoveOrdersResponse handleResponse(
      ...
      BasketOrdersServiceRemoveOrdersResponse.Builder resBuilder =
          BasketOrdersServiceRemoveOrdersResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      BasketOrdersServiceRemoveOrdersResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          RemoveOrdersResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withRemoveOrdersResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
