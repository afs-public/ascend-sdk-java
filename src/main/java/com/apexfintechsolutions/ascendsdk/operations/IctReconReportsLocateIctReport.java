...
public class IctReconReportsLocateIctReport {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(IctReconReportsLocateIctReportRequest request) throws Exception {
      String url =
          Utils.generateURL(
  ...
  public static class Sync extends Base
      implements RequestOperation<
          IctReconReportsLocateIctReportRequest, IctReconReportsLocateIctReportResponse> {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(IctReconReportsLocateIctReportRequest request)
        throws Exception {
    ...
    @Override
    public IctReconReportsLocateIctReportResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      IctReconReportsLocateIctReportResponse.Builder resBuilder =
          IctReconReportsLocateIctReportResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      IctReconReportsLocateIctReportResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          LocateIctReportResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withLocateIctReportResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
