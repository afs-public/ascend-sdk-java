...
public class IctReconReportsLocateIctReport {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(IctReconReportsLocateIctReportRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, IctReconReportsLocateIctReportRequest.class);
