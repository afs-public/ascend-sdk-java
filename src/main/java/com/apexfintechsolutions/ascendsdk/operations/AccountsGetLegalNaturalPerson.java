...
public class AccountsGetLegalNaturalPerson {
  ...
  public static class Sync extends Base
      implements RequestOperation<
          AccountsGetLegalNaturalPersonRequest, AccountsGetLegalNaturalPersonResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(AccountsGetLegalNaturalPersonRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, AccountsGetLegalNaturalPersonRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountsGetLegalNaturalPersonRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public AccountsGetLegalNaturalPersonResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AccountsGetLegalNaturalPersonResponse.Builder resBuilder =
          AccountsGetLegalNaturalPersonResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsGetLegalNaturalPersonResponse res = resBuilder.build();
