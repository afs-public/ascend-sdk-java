...
public class IdentityLookupServiceCreateIdentityLookup {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "IdentityLookupService_CreateIdentityLookup",
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/cip/v1/correspondents/{correspondent_id}/identityLookups",
              request,
              null);
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "identityLookupCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(IdentityLookupServiceCreateIdentityLookupRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              IdentityLookupServiceCreateIdentityLookupRequest.class,
              new TypeReference<IdentityLookupServiceCreateIdentityLookupRequest>() {});
    ...
    public HttpResponse<InputStream> doRequest(
        IdentityLookupServiceCreateIdentityLookupRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
                    ...
                    try {
                      ...
                      if (Utils.statusCodeMatches(
                          httpRes.statusCode(), "400", "403", "404", "429", "4XX", "500", "5XX")) {
    ...
    @Override
    public IdentityLookupServiceCreateIdentityLookupResponse handleResponse(
      ...
      IdentityLookupServiceCreateIdentityLookupResponse.Builder resBuilder =
          IdentityLookupServiceCreateIdentityLookupResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      IdentityLookupServiceCreateIdentityLookupResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          IdentityLookup out = Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withIdentityLookup(out);
          return res;
        } else {
          throw new SDKError(
              response,
      ...
      if (Utils.statusCodeMatches(response.statusCode(), "400", "403", "404", "429")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
