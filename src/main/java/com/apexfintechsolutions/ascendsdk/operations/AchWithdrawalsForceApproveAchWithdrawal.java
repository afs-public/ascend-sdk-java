...
public class AchWithdrawalsForceApproveAchWithdrawal {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "forceApproveAchWithdrawalRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(AchWithdrawalsForceApproveAchWithdrawalRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              AchWithdrawalsForceApproveAchWithdrawalRequest.class,
              new TypeReference<AchWithdrawalsForceApproveAchWithdrawalRequest>() {});
    ...
    public HttpResponse<InputStream> doRequest(
        AchWithdrawalsForceApproveAchWithdrawalRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public AchWithdrawalsForceApproveAchWithdrawalResponse handleResponse(
      ...
      AchWithdrawalsForceApproveAchWithdrawalResponse.Builder resBuilder =
          AchWithdrawalsForceApproveAchWithdrawalResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AchWithdrawalsForceApproveAchWithdrawalResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          AchWithdrawal out = Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withAchWithdrawal(out);
          return res;
        } else {
          throw new SDKError(
              response,
