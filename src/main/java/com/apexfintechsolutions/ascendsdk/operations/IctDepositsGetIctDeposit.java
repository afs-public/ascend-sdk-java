...
public class IctDepositsGetIctDeposit {
  ...
  public static class Sync extends Base
      implements RequestOperation<
          IctDepositsGetIctDepositRequest, IctDepositsGetIctDepositResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(IctDepositsGetIctDepositRequest request) throws Exception {
      HttpRequest req = buildRequest(request, IctDepositsGetIctDepositRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(IctDepositsGetIctDepositRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public IctDepositsGetIctDepositResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      IctDepositsGetIctDepositResponse.Builder resBuilder =
          IctDepositsGetIctDepositResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      IctDepositsGetIctDepositResponse res = resBuilder.build();
