...
public class IctWithdrawalsCancelIctWithdrawal {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "cancelIctWithdrawalRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(IctWithdrawalsCancelIctWithdrawalRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              IctWithdrawalsCancelIctWithdrawalRequest.class,
              new TypeReference<IctWithdrawalsCancelIctWithdrawalRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(IctWithdrawalsCancelIctWithdrawalRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public IctWithdrawalsCancelIctWithdrawalResponse handleResponse(
      ...
      IctWithdrawalsCancelIctWithdrawalResponse.Builder resBuilder =
          IctWithdrawalsCancelIctWithdrawalResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      IctWithdrawalsCancelIctWithdrawalResponse res = resBuilder.build();
