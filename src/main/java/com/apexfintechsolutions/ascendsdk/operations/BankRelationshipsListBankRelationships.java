...
public class BankRelationshipsListBankRelationships {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(BankRelationshipsListBankRelationshipsRequest request)
        throws Exception {
      String url =
          Utils.generateURL(
  ...
  public static class Sync extends Base
    ...
    public HttpResponse<InputStream> doRequest(
        BankRelationshipsListBankRelationshipsRequest request) throws Exception {
    ...
    @Override
    public BankRelationshipsListBankRelationshipsResponse handleResponse(
      ...
      BankRelationshipsListBankRelationshipsResponse.Builder resBuilder =
          BankRelationshipsListBankRelationshipsResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      BankRelationshipsListBankRelationshipsResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListBankRelationshipsResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListBankRelationshipsResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
