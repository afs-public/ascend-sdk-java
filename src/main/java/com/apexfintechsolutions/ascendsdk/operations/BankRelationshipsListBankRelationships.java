...
public class BankRelationshipsListBankRelationships {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(BankRelationshipsListBankRelationshipsRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, BankRelationshipsListBankRelationshipsRequest.class);
