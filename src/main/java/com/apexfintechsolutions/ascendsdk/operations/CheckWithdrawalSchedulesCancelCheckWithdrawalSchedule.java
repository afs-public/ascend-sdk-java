...
public class CheckWithdrawalSchedulesCancelCheckWithdrawalSchedule {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "CheckWithdrawalSchedules_CancelCheckWithdrawalSchedule",
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/transfers/v1/accounts/{account_id}/checkWithdrawalSchedules/{checkWithdrawalSchedule_id}:cancel",
              request,
              null);
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "cancelCheckWithdrawalScheduleRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(
        CheckWithdrawalSchedulesCancelCheckWithdrawalScheduleRequest request) throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              CheckWithdrawalSchedulesCancelCheckWithdrawalScheduleRequest.class,
              new TypeReference<CheckWithdrawalSchedulesCancelCheckWithdrawalScheduleRequest>() {});
    ...
    @Override
    public CheckWithdrawalSchedulesCancelCheckWithdrawalScheduleResponse handleResponse(
      ...
      CheckWithdrawalSchedulesCancelCheckWithdrawalScheduleResponse.Builder resBuilder =
          CheckWithdrawalSchedulesCancelCheckWithdrawalScheduleResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      CheckWithdrawalSchedulesCancelCheckWithdrawalScheduleResponse res = resBuilder.build();
