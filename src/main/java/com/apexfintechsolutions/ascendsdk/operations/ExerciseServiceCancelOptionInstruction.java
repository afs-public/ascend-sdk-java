...
public class ExerciseServiceCancelOptionInstruction {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "ExerciseService_CancelOptionInstruction",
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/options/v1/accounts/{account_id}/assets/{asset_id}/instructions/{instruction_id}:cancel",
              request,
              null);
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "cancelOptionInstructionRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(ExerciseServiceCancelOptionInstructionRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              ExerciseServiceCancelOptionInstructionRequest.class,
              new TypeReference<ExerciseServiceCancelOptionInstructionRequest>() {});
    ...
    public HttpResponse<InputStream> doRequest(
        ExerciseServiceCancelOptionInstructionRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public ExerciseServiceCancelOptionInstructionResponse handleResponse(
      ...
      ExerciseServiceCancelOptionInstructionResponse.Builder resBuilder =
          ExerciseServiceCancelOptionInstructionResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      ExerciseServiceCancelOptionInstructionResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          OptionInstruction out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withOptionInstruction(out);
          return res;
        } else {
          throw new SDKError(
              response,
