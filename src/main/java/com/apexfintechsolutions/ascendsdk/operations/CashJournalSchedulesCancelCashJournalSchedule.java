...
public class CashJournalSchedulesCancelCashJournalSchedule {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "CashJournalSchedules_CancelCashJournalSchedule",
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/transfers/v1/cashJournalSchedules/{cashJournalSchedule_id}:cancel",
              request,
              null);
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "cancelCashJournalScheduleRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(CashJournalSchedulesCancelCashJournalScheduleRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              CashJournalSchedulesCancelCashJournalScheduleRequest.class,
              new TypeReference<CashJournalSchedulesCancelCashJournalScheduleRequest>() {});
    ...
    public HttpResponse<InputStream> doRequest(
        CashJournalSchedulesCancelCashJournalScheduleRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public CashJournalSchedulesCancelCashJournalScheduleResponse handleResponse(
      ...
      CashJournalSchedulesCancelCashJournalScheduleResponse.Builder resBuilder =
          CashJournalSchedulesCancelCashJournalScheduleResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      CashJournalSchedulesCancelCashJournalScheduleResponse res = resBuilder.build();
