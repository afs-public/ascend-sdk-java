...
public class AccountsEndRestriction {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "endRestrictionRequestCreate", "json", false);
  ...
  public static class Sync extends Base
      implements RequestOperation<AccountsEndRestrictionRequest, AccountsEndRestrictionResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(AccountsEndRestrictionRequest request) throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              AccountsEndRestrictionRequest.class,
              new TypeReference<AccountsEndRestrictionRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountsEndRestrictionRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public AccountsEndRestrictionResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AccountsEndRestrictionResponse.Builder resBuilder =
          AccountsEndRestrictionResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsEndRestrictionResponse res = resBuilder.build();
