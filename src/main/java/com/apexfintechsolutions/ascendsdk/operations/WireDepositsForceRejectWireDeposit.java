...
public class WireDepositsForceRejectWireDeposit {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "WireDeposits_ForceRejectWireDeposit",
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/transfers/v1/accounts/{account_id}/wireDeposits/{wireDeposit_id}:forceReject",
              request,
              null);
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "forceRejectWireDepositRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(WireDepositsForceRejectWireDepositRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              WireDepositsForceRejectWireDepositRequest.class,
              new TypeReference<WireDepositsForceRejectWireDepositRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(WireDepositsForceRejectWireDepositRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public WireDepositsForceRejectWireDepositResponse handleResponse(
      ...
      WireDepositsForceRejectWireDepositResponse.Builder resBuilder =
          WireDepositsForceRejectWireDepositResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      WireDepositsForceRejectWireDepositResponse res = resBuilder.build();
