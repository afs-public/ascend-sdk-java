...
public class AccountTransfersGetTransfer {
  ...
  public static class Sync extends Base
      implements RequestOperation<
          AccountTransfersGetTransferRequest, AccountTransfersGetTransferResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(AccountTransfersGetTransferRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, AccountTransfersGetTransferRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountTransfersGetTransferRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public AccountTransfersGetTransferResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AccountTransfersGetTransferResponse.Builder resBuilder =
          AccountTransfersGetTransferResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountTransfersGetTransferResponse res = resBuilder.build();
