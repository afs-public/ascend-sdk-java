...
public class BasketOrdersServiceListCompressedOrders {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(BasketOrdersServiceListCompressedOrdersRequest request)
        throws Exception {
      String url =
          Utils.generateURL(
      ...
      req.addQueryParams(
          Utils.getQueryParams(
              BasketOrdersServiceListCompressedOrdersRequest.class, request, null));
  ...
  public static class Sync extends Base
    ...
    public HttpResponse<InputStream> doRequest(
        BasketOrdersServiceListCompressedOrdersRequest request) throws Exception {
      HttpRequest r = buildRequest(request);
      HttpResponse<InputStream> httpRes;
      try {
        httpRes = client.send(r);
        if (Utils.statusCodeMatches(
            httpRes.statusCode(), "400", "401", "403", "404", "4XX", "500", "503", "5XX")) {
    ...
    @Override
    public BasketOrdersServiceListCompressedOrdersResponse handleResponse(
      ...
      BasketOrdersServiceListCompressedOrdersResponse.Builder resBuilder =
          BasketOrdersServiceListCompressedOrdersResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      BasketOrdersServiceListCompressedOrdersResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListCompressedOrdersResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListCompressedOrdersResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
