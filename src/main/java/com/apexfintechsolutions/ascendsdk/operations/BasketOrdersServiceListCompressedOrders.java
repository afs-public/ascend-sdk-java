...
public class BasketOrdersServiceListCompressedOrders {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(BasketOrdersServiceListCompressedOrdersRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, BasketOrdersServiceListCompressedOrdersRequest.class);
