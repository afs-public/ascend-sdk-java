...
public class IctDepositsForceApproveIctDeposit {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "forceApproveIctDepositRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(IctDepositsForceApproveIctDepositRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              IctDepositsForceApproveIctDepositRequest.class,
              new TypeReference<IctDepositsForceApproveIctDepositRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(IctDepositsForceApproveIctDepositRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public IctDepositsForceApproveIctDepositResponse handleResponse(
      ...
      IctDepositsForceApproveIctDepositResponse.Builder resBuilder =
          IctDepositsForceApproveIctDepositResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      IctDepositsForceApproveIctDepositResponse res = resBuilder.build();
