...
public class FeesCancelFee {
  ...
  abstract static class Base {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "cancelFeeRequestCreate", "json", false);
  ...
  public static class Sync extends Base
      implements RequestOperation<FeesCancelFeeRequest, FeesCancelFeeResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(FeesCancelFeeRequest request) throws Exception {
      HttpRequest req =
          buildRequest(
              request, FeesCancelFeeRequest.class, new TypeReference<FeesCancelFeeRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(FeesCancelFeeRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public FeesCancelFeeResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      FeesCancelFeeResponse.Builder resBuilder =
          FeesCancelFeeResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      FeesCancelFeeResponse res = resBuilder.build();
