...
public class RetirementConstraintsListDistributionSummaries {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(RetirementConstraintsListDistributionSummariesRequest request)
        throws Exception {
      String url =
          Utils.generateURL(
  ...
  public static class Sync extends Base
    ...
    public HttpResponse<InputStream> doRequest(
        RetirementConstraintsListDistributionSummariesRequest request) throws Exception {
    ...
    @Override
    public RetirementConstraintsListDistributionSummariesResponse handleResponse(
      ...
      RetirementConstraintsListDistributionSummariesResponse.Builder resBuilder =
          RetirementConstraintsListDistributionSummariesResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      RetirementConstraintsListDistributionSummariesResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListDistributionSummariesResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListDistributionSummariesResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
