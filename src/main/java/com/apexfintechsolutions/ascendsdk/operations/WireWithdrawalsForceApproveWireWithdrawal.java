...
public class WireWithdrawalsForceApproveWireWithdrawal {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "forceApproveWireWithdrawalRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(WireWithdrawalsForceApproveWireWithdrawalRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              WireWithdrawalsForceApproveWireWithdrawalRequest.class,
              new TypeReference<WireWithdrawalsForceApproveWireWithdrawalRequest>() {});
    ...
    public HttpResponse<InputStream> doRequest(
        WireWithdrawalsForceApproveWireWithdrawalRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public WireWithdrawalsForceApproveWireWithdrawalResponse handleResponse(
      ...
      WireWithdrawalsForceApproveWireWithdrawalResponse.Builder resBuilder =
          WireWithdrawalsForceApproveWireWithdrawalResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      WireWithdrawalsForceApproveWireWithdrawalResponse res = resBuilder.build();
