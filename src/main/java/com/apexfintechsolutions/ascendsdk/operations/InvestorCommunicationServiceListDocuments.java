...
public class InvestorCommunicationServiceListDocuments {
  ...
  abstract static class Base {
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url = Utils.generateURL(this.baseUrl, "/investordocs/v1/documents");
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(InvestorCommunicationServiceListDocumentsRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(request, InvestorCommunicationServiceListDocumentsRequest.class);
    ...
    public HttpResponse<InputStream> doRequest(
        InvestorCommunicationServiceListDocumentsRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public InvestorCommunicationServiceListDocumentsResponse handleResponse(
      ...
      InvestorCommunicationServiceListDocumentsResponse.Builder resBuilder =
          InvestorCommunicationServiceListDocumentsResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      InvestorCommunicationServiceListDocumentsResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListDocumentsResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListDocumentsResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
