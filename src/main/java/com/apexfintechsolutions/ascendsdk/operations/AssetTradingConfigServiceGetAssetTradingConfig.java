...
public class AssetTradingConfigServiceGetAssetTradingConfig {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "AssetTradingConfigService_GetAssetTradingConfig",
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(
        AssetTradingConfigServiceGetAssetTradingConfigRequest request) throws Exception {
      HttpRequest req =
          buildRequest(request, AssetTradingConfigServiceGetAssetTradingConfigRequest.class);
    ...
    @Override
    public AssetTradingConfigServiceGetAssetTradingConfigResponse handleResponse(
      ...
      AssetTradingConfigServiceGetAssetTradingConfigResponse.Builder resBuilder =
          AssetTradingConfigServiceGetAssetTradingConfigResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AssetTradingConfigServiceGetAssetTradingConfigResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          AssetTradingConfig out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withAssetTradingConfig(out);
          return res;
        } else {
          throw new SDKError(
              response,
