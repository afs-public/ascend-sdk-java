...
public class CashJournalsCreateCashJournal {
  ...
  abstract static class Base {
    ...
    <T, U> HttpRequest buildRequest(T request, TypeReference<U> typeReference) throws Exception {
      String url = Utils.generateURL(this.baseUrl, "/transfers/v1/cashJournals");
  ...
  public static class Sync extends Base
      implements RequestOperation<CashJournalCreate, CashJournalsCreateCashJournalResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(CashJournalCreate request) throws Exception {
      HttpRequest req = buildRequest(request, new TypeReference<CashJournalCreate>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(CashJournalCreate request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public CashJournalsCreateCashJournalResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      CashJournalsCreateCashJournalResponse.Builder resBuilder =
          CashJournalsCreateCashJournalResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      CashJournalsCreateCashJournalResponse res = resBuilder.build();
