...
public class AccountsListEntitlements {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(AccountsListEntitlementsRequest request) throws Exception {
      String url =
          Utils.generateURL(
      ...
      req.addQueryParams(
          Utils.getQueryParams(AccountsListEntitlementsRequest.class, request, null));
  ...
  public static class Sync extends Base
      implements RequestOperation<
          AccountsListEntitlementsRequest, AccountsListEntitlementsResponse> {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountsListEntitlementsRequest request)
        throws Exception {
    ...
    @Override
    public AccountsListEntitlementsResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AccountsListEntitlementsResponse.Builder resBuilder =
          AccountsListEntitlementsResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsListEntitlementsResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListEntitlementsResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListEntitlementsResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
