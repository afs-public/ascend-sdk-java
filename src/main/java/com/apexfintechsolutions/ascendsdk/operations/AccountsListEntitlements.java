...
public class AccountsListEntitlements {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(AccountsListEntitlementsRequest request) throws Exception {
      HttpRequest req = buildRequest(request, AccountsListEntitlementsRequest.class);
