...
public class CheckDepositsForceApproveCheckDeposit {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/transfers/v1/accounts/{account_id}/checkDeposits/{checkDeposit_id}:forceApprove",
              request,
              null);
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "forceApproveCheckDepositRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(CheckDepositsForceApproveCheckDepositRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              CheckDepositsForceApproveCheckDepositRequest.class,
              new TypeReference<CheckDepositsForceApproveCheckDepositRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(CheckDepositsForceApproveCheckDepositRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public CheckDepositsForceApproveCheckDepositResponse handleResponse(
      ...
      CheckDepositsForceApproveCheckDepositResponse.Builder resBuilder =
          CheckDepositsForceApproveCheckDepositResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      CheckDepositsForceApproveCheckDepositResponse res = resBuilder.build();
