...
public class LedgerListActivities {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(LedgerListActivitiesRequest request) throws Exception {
      String url =
          Utils.generateURL(
      ...
      req.addQueryParams(Utils.getQueryParams(LedgerListActivitiesRequest.class, request, null));
  ...
  public static class Sync extends Base
      implements RequestOperation<LedgerListActivitiesRequest, LedgerListActivitiesResponse> {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(LedgerListActivitiesRequest request)
        throws Exception {
    ...
    @Override
    public LedgerListActivitiesResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      LedgerListActivitiesResponse.Builder resBuilder =
          LedgerListActivitiesResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      LedgerListActivitiesResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListActivitiesResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListActivitiesResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
