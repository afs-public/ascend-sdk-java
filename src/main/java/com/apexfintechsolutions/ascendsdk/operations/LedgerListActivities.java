...
public class LedgerListActivities {
  ...
  abstract static class Base {
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url =
          Utils.generateURL(
              klass, this.baseUrl, "/ledger/v1/accounts/{account_id}/activities", request, null);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(LedgerListActivitiesRequest request) throws Exception {
      HttpRequest req = buildRequest(request, LedgerListActivitiesRequest.class);
