...
public class BasketOrdersServiceCreateBasket {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(BasketOrdersServiceCreateBasketRequest request) throws Exception {
      String url =
          Utils.generateURL(
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "basketCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    @Override
    public HttpResponse<InputStream> doRequest(BasketOrdersServiceCreateBasketRequest request)
        throws Exception {
      ...
      try {
        ...
        if (Utils.statusCodeMatches(
            httpRes.statusCode(), "400", "401", "403", "409", "4XX", "500", "503", "5XX")) {
    ...
    @Override
    public BasketOrdersServiceCreateBasketResponse handleResponse(
      ...
      BasketOrdersServiceCreateBasketResponse.Builder resBuilder =
          BasketOrdersServiceCreateBasketResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      BasketOrdersServiceCreateBasketResponse res = resBuilder.build();
