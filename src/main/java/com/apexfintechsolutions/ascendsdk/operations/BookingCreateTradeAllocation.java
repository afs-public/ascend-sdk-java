...
public class BookingCreateTradeAllocation {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(BookingCreateTradeAllocationRequest request) throws Exception {
      String url =
          Utils.generateURL(
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "tradeAllocationCreate", "json", false);
  ...
  public static class Sync extends Base
      implements RequestOperation<
          BookingCreateTradeAllocationRequest, BookingCreateTradeAllocationResponse> {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(BookingCreateTradeAllocationRequest request)
        throws Exception {
      ...
      try {
        ...
        if (Utils.statusCodeMatches(
            httpRes.statusCode(), "400", "403", "404", "409", "4XX", "500", "503", "504", "5XX")) {
    ...
    @Override
    public BookingCreateTradeAllocationResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      BookingCreateTradeAllocationResponse.Builder resBuilder =
          BookingCreateTradeAllocationResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      BookingCreateTradeAllocationResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          TradeAllocation out = Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withTradeAllocation(out);
          return res;
        } else {
          throw new SDKError(
              response,
      ...
      if (Utils.statusCodeMatches(response.statusCode(), "400", "403", "404", "409")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
