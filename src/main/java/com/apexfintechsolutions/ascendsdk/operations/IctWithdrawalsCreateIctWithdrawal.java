...
public class IctWithdrawalsCreateIctWithdrawal {
  ...
  abstract static class Base {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "ictWithdrawalCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(IctWithdrawalsCreateIctWithdrawalRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              IctWithdrawalsCreateIctWithdrawalRequest.class,
              new TypeReference<IctWithdrawalsCreateIctWithdrawalRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(IctWithdrawalsCreateIctWithdrawalRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public IctWithdrawalsCreateIctWithdrawalResponse handleResponse(
      ...
      IctWithdrawalsCreateIctWithdrawalResponse.Builder resBuilder =
          IctWithdrawalsCreateIctWithdrawalResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      IctWithdrawalsCreateIctWithdrawalResponse res = resBuilder.build();
