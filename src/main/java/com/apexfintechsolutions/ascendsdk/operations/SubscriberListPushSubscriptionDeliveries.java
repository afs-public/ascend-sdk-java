...
public class SubscriberListPushSubscriptionDeliveries {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(SubscriberListPushSubscriptionDeliveriesRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(request, SubscriberListPushSubscriptionDeliveriesRequest.class);
