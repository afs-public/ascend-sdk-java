...
public class SubscriberListPushSubscriptionDeliveries {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(SubscriberListPushSubscriptionDeliveriesRequest request)
        throws Exception {
      String url =
          Utils.generateURL(
      ...
      req.addQueryParams(
          Utils.getQueryParams(
              SubscriberListPushSubscriptionDeliveriesRequest.class, request, null));
  ...
  public static class Sync extends Base
    ...
    public HttpResponse<InputStream> doRequest(
        SubscriberListPushSubscriptionDeliveriesRequest request) throws Exception {
    ...
    @Override
    public SubscriberListPushSubscriptionDeliveriesResponse handleResponse(
      ...
      SubscriberListPushSubscriptionDeliveriesResponse.Builder resBuilder =
          SubscriberListPushSubscriptionDeliveriesResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      SubscriberListPushSubscriptionDeliveriesResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListPushSubscriptionDeliveriesResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListPushSubscriptionDeliveriesResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
