...
public class MarginsRealTimeGetAssetBuyingPower {
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/buyingpower/v1/accounts/{account_id}/assets/{asset_id}/buyingPower",
              request,
              null);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(MarginsRealTimeGetAssetBuyingPowerRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, MarginsRealTimeGetAssetBuyingPowerRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(MarginsRealTimeGetAssetBuyingPowerRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public MarginsRealTimeGetAssetBuyingPowerResponse handleResponse(
      ...
      MarginsRealTimeGetAssetBuyingPowerResponse.Builder resBuilder =
          MarginsRealTimeGetAssetBuyingPowerResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      MarginsRealTimeGetAssetBuyingPowerResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          AssetBuyingPower out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withAssetBuyingPower(out);
          return res;
        } else {
          throw new SDKError(
              response,
