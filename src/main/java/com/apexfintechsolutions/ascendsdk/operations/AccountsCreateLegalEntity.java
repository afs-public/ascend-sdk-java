...
public class AccountsCreateLegalEntity {
  ...
  public static class Sync extends Base
      implements RequestOperation<LegalEntityCreate, AccountsCreateLegalEntityResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(LegalEntityCreate request) throws Exception {
      HttpRequest req = buildRequest(request, new TypeReference<LegalEntityCreate>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(LegalEntityCreate request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public AccountsCreateLegalEntityResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AccountsCreateLegalEntityResponse.Builder resBuilder =
          AccountsCreateLegalEntityResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsCreateLegalEntityResponse res = resBuilder.build();
