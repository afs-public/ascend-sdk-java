...
public class CheckDepositsSimulateCreateCheckDeposit {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/transfers/v1/accounts/{account_id}/checkDeposits:simulate",
              request,
              null);
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "simulateCreateCheckDepositRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(CheckDepositsSimulateCreateCheckDepositRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              CheckDepositsSimulateCreateCheckDepositRequest.class,
              new TypeReference<CheckDepositsSimulateCreateCheckDepositRequest>() {});
    ...
    public HttpResponse<InputStream> doRequest(
        CheckDepositsSimulateCreateCheckDepositRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public CheckDepositsSimulateCreateCheckDepositResponse handleResponse(
      ...
      CheckDepositsSimulateCreateCheckDepositResponse.Builder resBuilder =
          CheckDepositsSimulateCreateCheckDepositResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      CheckDepositsSimulateCreateCheckDepositResponse res = resBuilder.build();
