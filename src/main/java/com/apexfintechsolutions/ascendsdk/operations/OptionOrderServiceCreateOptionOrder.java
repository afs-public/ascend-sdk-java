...
public class OptionOrderServiceCreateOptionOrder {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "OptionOrderService_CreateOptionOrder",
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      String url =
          Utils.generateURL(
              klass, this.baseUrl, "/trading/v1/accounts/{account_id}/optionOrders", request, null);
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "optionOrderCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(OptionOrderServiceCreateOptionOrderRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              OptionOrderServiceCreateOptionOrderRequest.class,
              new TypeReference<OptionOrderServiceCreateOptionOrderRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(OptionOrderServiceCreateOptionOrderRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public OptionOrderServiceCreateOptionOrderResponse handleResponse(
      ...
      OptionOrderServiceCreateOptionOrderResponse.Builder resBuilder =
          OptionOrderServiceCreateOptionOrderResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      OptionOrderServiceCreateOptionOrderResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          OptionOrder out = Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withOptionOrder(out);
          return res;
        } else {
          throw new SDKError(
              response,
