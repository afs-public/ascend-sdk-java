...
public class OptionOrderServiceCancelOptionOrder {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "OptionOrderService_CancelOptionOrder",
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/trading/v1/accounts/{account_id}/optionOrders/{optionOrder_id}:cancel",
              request,
              null);
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "cancelOptionOrderRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(OptionOrderServiceCancelOptionOrderRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              OptionOrderServiceCancelOptionOrderRequest.class,
              new TypeReference<OptionOrderServiceCancelOptionOrderRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(OptionOrderServiceCancelOptionOrderRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public OptionOrderServiceCancelOptionOrderResponse handleResponse(
      ...
      OptionOrderServiceCancelOptionOrderResponse.Builder resBuilder =
          OptionOrderServiceCancelOptionOrderResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      OptionOrderServiceCancelOptionOrderResponse res = resBuilder.build();
