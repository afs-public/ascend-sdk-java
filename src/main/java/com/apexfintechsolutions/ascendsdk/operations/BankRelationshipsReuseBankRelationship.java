...
public class BankRelationshipsReuseBankRelationship {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "reuseBankRelationshipRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(BankRelationshipsReuseBankRelationshipRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              BankRelationshipsReuseBankRelationshipRequest.class,
              new TypeReference<BankRelationshipsReuseBankRelationshipRequest>() {});
    ...
    public HttpResponse<InputStream> doRequest(
        BankRelationshipsReuseBankRelationshipRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public BankRelationshipsReuseBankRelationshipResponse handleResponse(
      ...
      BankRelationshipsReuseBankRelationshipResponse.Builder resBuilder =
          BankRelationshipsReuseBankRelationshipResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      BankRelationshipsReuseBankRelationshipResponse res = resBuilder.build();
