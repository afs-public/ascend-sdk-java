...
public class AchDepositSchedulesListAchDepositSchedules {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(AchDepositSchedulesListAchDepositSchedulesRequest request)
        throws Exception {
      String url =
          Utils.generateURL(
  ...
  public static class Sync extends Base
    ...
    public HttpResponse<InputStream> doRequest(
        AchDepositSchedulesListAchDepositSchedulesRequest request) throws Exception {
    ...
    @Override
    public AchDepositSchedulesListAchDepositSchedulesResponse handleResponse(
      ...
      AchDepositSchedulesListAchDepositSchedulesResponse.Builder resBuilder =
          AchDepositSchedulesListAchDepositSchedulesResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AchDepositSchedulesListAchDepositSchedulesResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListAchDepositSchedulesResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListAchDepositSchedulesResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
