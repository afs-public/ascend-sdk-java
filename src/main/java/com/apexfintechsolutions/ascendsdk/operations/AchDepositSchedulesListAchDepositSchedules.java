...
public class AchDepositSchedulesListAchDepositSchedules {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(AchDepositSchedulesListAchDepositSchedulesRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(request, AchDepositSchedulesListAchDepositSchedulesRequest.class);
