...
public class OptionOrderServiceSetOptionExtraReportingData {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "OptionOrderService_SetOptionExtraReportingData",
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/trading/v1/accounts/{account_id}/optionOrders/{optionOrder_id}:setExtraReportingData",
              request,
              null);
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "setOptionExtraReportingDataRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(OptionOrderServiceSetOptionExtraReportingDataRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              OptionOrderServiceSetOptionExtraReportingDataRequest.class,
              new TypeReference<OptionOrderServiceSetOptionExtraReportingDataRequest>() {});
    ...
    public HttpResponse<InputStream> doRequest(
        OptionOrderServiceSetOptionExtraReportingDataRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public OptionOrderServiceSetOptionExtraReportingDataResponse handleResponse(
      ...
      OptionOrderServiceSetOptionExtraReportingDataResponse.Builder resBuilder =
          OptionOrderServiceSetOptionExtraReportingDataResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      OptionOrderServiceSetOptionExtraReportingDataResponse res = resBuilder.build();
