...
public class AccountsUpdateInterestedParty {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(AccountsUpdateInterestedPartyRequest request) throws Exception {
      String url =
          Utils.generateURL(
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "interestedPartyUpdate", "json", false);
  ...
  public static class Sync extends Base
      implements RequestOperation<
          AccountsUpdateInterestedPartyRequest, AccountsUpdateInterestedPartyResponse> {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountsUpdateInterestedPartyRequest request)
        throws Exception {
    ...
    @Override
    public AccountsUpdateInterestedPartyResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AccountsUpdateInterestedPartyResponse.Builder resBuilder =
          AccountsUpdateInterestedPartyResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsUpdateInterestedPartyResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          InterestedParty out = Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withInterestedParty(out);
          return res;
        } else {
          throw new SDKError(
              response,
