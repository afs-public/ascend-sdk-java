...
public class AuthenticationListSigningKeys {
  ...
  public static class Sync extends Base
    ...
    public Sync(
        ...
        AuthenticationListSigningKeysSecurity security,
        Optional<Options> options) {
      super(sdkConfiguration, security, options);
    }

    private HttpRequest onBuildRequest(AuthenticationListSigningKeysRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, AuthenticationListSigningKeysRequest.class);
