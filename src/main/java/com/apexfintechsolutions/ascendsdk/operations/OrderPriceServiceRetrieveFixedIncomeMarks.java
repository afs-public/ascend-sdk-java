...
public class OrderPriceServiceRetrieveFixedIncomeMarks {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "retrieveFixedIncomeMarksRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(OrderPriceServiceRetrieveFixedIncomeMarksRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              OrderPriceServiceRetrieveFixedIncomeMarksRequest.class,
              new TypeReference<OrderPriceServiceRetrieveFixedIncomeMarksRequest>() {});
    ...
    public HttpResponse<InputStream> doRequest(
        OrderPriceServiceRetrieveFixedIncomeMarksRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
                    ...
                    try {
                      ...
                      if (Utils.statusCodeMatches(
                          httpRes.statusCode(), "400", "401", "403", "4XX", "500", "503", "5XX")) {
    ...
    @Override
    public OrderPriceServiceRetrieveFixedIncomeMarksResponse handleResponse(
      ...
      OrderPriceServiceRetrieveFixedIncomeMarksResponse.Builder resBuilder =
          OrderPriceServiceRetrieveFixedIncomeMarksResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      OrderPriceServiceRetrieveFixedIncomeMarksResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          RetrieveFixedIncomeMarksResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withRetrieveFixedIncomeMarksResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
