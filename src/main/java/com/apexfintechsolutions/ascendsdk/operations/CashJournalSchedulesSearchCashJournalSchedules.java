...
public class CashJournalSchedulesSearchCashJournalSchedules {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "CashJournalSchedules_SearchCashJournalSchedules",
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url = Utils.generateURL(this.baseUrl, "/transfers/v1/cashJournalSchedules:search");
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(
      ...
      HttpRequest req =
          buildRequest(request, CashJournalSchedulesSearchCashJournalSchedulesRequest.class);
    ...
    @Override
    public CashJournalSchedulesSearchCashJournalSchedulesResponse handleResponse(
      ...
      CashJournalSchedulesSearchCashJournalSchedulesResponse.Builder resBuilder =
          CashJournalSchedulesSearchCashJournalSchedulesResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      CashJournalSchedulesSearchCashJournalSchedulesResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          SearchCashJournalSchedulesResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withSearchCashJournalSchedulesResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
