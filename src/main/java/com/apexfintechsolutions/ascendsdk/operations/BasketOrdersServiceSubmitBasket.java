...
public class BasketOrdersServiceSubmitBasket {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(BasketOrdersServiceSubmitBasketRequest request) throws Exception {
      String url =
          Utils.generateURL(
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "submitBasketRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    @Override
    public HttpResponse<InputStream> doRequest(BasketOrdersServiceSubmitBasketRequest request)
        throws Exception {
    ...
    @Override
    public BasketOrdersServiceSubmitBasketResponse handleResponse(
      ...
      BasketOrdersServiceSubmitBasketResponse.Builder resBuilder =
          BasketOrdersServiceSubmitBasketResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      BasketOrdersServiceSubmitBasketResponse res = resBuilder.build();
