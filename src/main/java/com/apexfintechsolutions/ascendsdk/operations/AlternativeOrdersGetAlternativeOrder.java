...
public class AlternativeOrdersGetAlternativeOrder {
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/trading/v1/accounts/{account_id}/alternativeOrders/{alternativeOrder_id}",
              request,
              null);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(AlternativeOrdersGetAlternativeOrderRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, AlternativeOrdersGetAlternativeOrderRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AlternativeOrdersGetAlternativeOrderRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public AlternativeOrdersGetAlternativeOrderResponse handleResponse(
      ...
      AlternativeOrdersGetAlternativeOrderResponse.Builder resBuilder =
          AlternativeOrdersGetAlternativeOrderResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AlternativeOrdersGetAlternativeOrderResponse res = resBuilder.build();
