...
public class CashJournalSchedulesUpdateCashJournalSchedule {
  ...
  abstract static class Base {
    ...
    BeforeRequestContextImpl createBeforeRequestContext() {
      return new BeforeRequestContextImpl(
          ...
          this.baseUrl,
          "CashJournalSchedules_UpdateCashJournalSchedule",
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      String url =
          Utils.generateURL(
              klass,
              this.baseUrl,
              "/transfers/v1/cashJournalSchedules/{cashJournalSchedule_id}",
              request,
              null);
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "cashJournalScheduleUpdate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(CashJournalSchedulesUpdateCashJournalScheduleRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              CashJournalSchedulesUpdateCashJournalScheduleRequest.class,
              new TypeReference<CashJournalSchedulesUpdateCashJournalScheduleRequest>() {});
    ...
    public HttpResponse<InputStream> doRequest(
        CashJournalSchedulesUpdateCashJournalScheduleRequest request) throws Exception {
      Retries retries =
          Retries.builder()
              .action(
                  () -> {
    ...
    @Override
    public CashJournalSchedulesUpdateCashJournalScheduleResponse handleResponse(
      ...
      CashJournalSchedulesUpdateCashJournalScheduleResponse.Builder resBuilder =
          CashJournalSchedulesUpdateCashJournalScheduleResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      CashJournalSchedulesUpdateCashJournalScheduleResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          CashJournalSchedule out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withCashJournalSchedule(out);
          return res;
        } else {
          throw new SDKError(
              response,
