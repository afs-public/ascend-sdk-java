...
public class WireWithdrawalSchedulesCancelWireWithdrawalSchedule {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "cancelWireWithdrawalScheduleRequestCreate", "json", false);
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(
        WireWithdrawalSchedulesCancelWireWithdrawalScheduleRequest request) throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              WireWithdrawalSchedulesCancelWireWithdrawalScheduleRequest.class,
              new TypeReference<WireWithdrawalSchedulesCancelWireWithdrawalScheduleRequest>() {});
                  ...
                  () -> {
                    ...
                    try {
                      ...
                      if (Utils.statusCodeMatches(
                          httpRes.statusCode(), "400", "403", "404", "4XX", "5XX")) {
    ...
    @Override
    public WireWithdrawalSchedulesCancelWireWithdrawalScheduleResponse handleResponse(
      ...
      WireWithdrawalSchedulesCancelWireWithdrawalScheduleResponse.Builder resBuilder =
          WireWithdrawalSchedulesCancelWireWithdrawalScheduleResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      WireWithdrawalSchedulesCancelWireWithdrawalScheduleResponse res = resBuilder.build();
