...
public class BookingGetExecution {
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(BookingGetExecutionRequest request) throws Exception {
      HttpRequest req = buildRequest(request, BookingGetExecutionRequest.class);
