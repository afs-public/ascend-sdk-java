...
public class BookingGetExecution {
  ...
  abstract static class Base {
    ...
    HttpRequest buildRequest(BookingGetExecutionRequest request) throws Exception {
      String url =
          Utils.generateURL(
  ...
  public static class Sync extends Base
      implements RequestOperation<BookingGetExecutionRequest, BookingGetExecutionResponse> {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(BookingGetExecutionRequest request)
        throws Exception {
    ...
    @Override
    public BookingGetExecutionResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      BookingGetExecutionResponse.Builder resBuilder =
          BookingGetExecutionResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      BookingGetExecutionResponse res = resBuilder.build();
