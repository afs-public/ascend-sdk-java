...
public class PreIpoCompaniesListPreIpoCompanies {
  ...
  abstract static class Base {
    ...
    <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
      String url = Utils.generateURL(this.baseUrl, "/trading/v1/preIpoCompanies");
  ...
  public static class Sync extends Base
    ...
    private HttpRequest onBuildRequest(PreIpoCompaniesListPreIpoCompaniesRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, PreIpoCompaniesListPreIpoCompaniesRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(PreIpoCompaniesListPreIpoCompaniesRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public PreIpoCompaniesListPreIpoCompaniesResponse handleResponse(
      ...
      PreIpoCompaniesListPreIpoCompaniesResponse.Builder resBuilder =
          PreIpoCompaniesListPreIpoCompaniesResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      PreIpoCompaniesListPreIpoCompaniesResponse res = resBuilder.build();

      if (Utils.statusCodeMatches(response.statusCode(), "200")) {
        if (Utils.contentTypeMatches(contentType, "application/json")) {
          ListPreIpoCompaniesResponse out =
              Utils.mapper().readValue(response.body(), new TypeReference<>() {});
          res.withListPreIpoCompaniesResponse(out);
          return res;
        } else {
          throw new SDKError(
              response,
