...
public class IctWithdrawalsGetIctWithdrawal {
  ...
  public static class Sync extends Base
      implements RequestOperation<
          IctWithdrawalsGetIctWithdrawalRequest, IctWithdrawalsGetIctWithdrawalResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(IctWithdrawalsGetIctWithdrawalRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, IctWithdrawalsGetIctWithdrawalRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(IctWithdrawalsGetIctWithdrawalRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public IctWithdrawalsGetIctWithdrawalResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      IctWithdrawalsGetIctWithdrawalResponse.Builder resBuilder =
          IctWithdrawalsGetIctWithdrawalResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      IctWithdrawalsGetIctWithdrawalResponse res = resBuilder.build();
