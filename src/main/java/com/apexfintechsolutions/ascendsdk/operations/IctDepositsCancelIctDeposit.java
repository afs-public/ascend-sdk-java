...
public class IctDepositsCancelIctDeposit {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(
              convertedRequest, "cancelIctDepositRequestCreate", "json", false);
  ...
  public static class Sync extends Base
      implements RequestOperation<
          IctDepositsCancelIctDepositRequest, IctDepositsCancelIctDepositResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(IctDepositsCancelIctDepositRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              IctDepositsCancelIctDepositRequest.class,
              new TypeReference<IctDepositsCancelIctDepositRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(IctDepositsCancelIctDepositRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public IctDepositsCancelIctDepositResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      IctDepositsCancelIctDepositResponse.Builder resBuilder =
          IctDepositsCancelIctDepositResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      IctDepositsCancelIctDepositResponse res = resBuilder.build();
