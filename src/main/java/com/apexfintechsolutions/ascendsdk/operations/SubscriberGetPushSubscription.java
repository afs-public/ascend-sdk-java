...
public class SubscriberGetPushSubscription {
  ...
  public static class Sync extends Base
      implements RequestOperation<
          SubscriberGetPushSubscriptionRequest, SubscriberGetPushSubscriptionResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(SubscriberGetPushSubscriptionRequest request)
        throws Exception {
      HttpRequest req = buildRequest(request, SubscriberGetPushSubscriptionRequest.class);
    ...
    @Override
    public HttpResponse<InputStream> doRequest(SubscriberGetPushSubscriptionRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public SubscriberGetPushSubscriptionResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      SubscriberGetPushSubscriptionResponse.Builder resBuilder =
          SubscriberGetPushSubscriptionResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      SubscriberGetPushSubscriptionResponse res = resBuilder.build();
