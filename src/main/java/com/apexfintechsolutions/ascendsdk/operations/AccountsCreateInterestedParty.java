...
public class AccountsCreateInterestedParty {
  ...
  abstract static class Base {
    ...
    <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference)
      ...
      SerializedBody serializedRequestBody =
          Utils.serializeRequestBody(convertedRequest, "interestedPartyCreate", "json", false);
  ...
  public static class Sync extends Base
      implements RequestOperation<
          AccountsCreateInterestedPartyRequest, AccountsCreateInterestedPartyResponse> {
    public Sync(SDKConfiguration sdkConfiguration, Optional<Options> options) {
      super(sdkConfiguration, options);
    }

    private HttpRequest onBuildRequest(AccountsCreateInterestedPartyRequest request)
        throws Exception {
      HttpRequest req =
          buildRequest(
              request,
              AccountsCreateInterestedPartyRequest.class,
              new TypeReference<AccountsCreateInterestedPartyRequest>() {});
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AccountsCreateInterestedPartyRequest request)
        throws Exception {
      Retries retries =
          Retries.builder()
              .action(
    ...
    @Override
    public AccountsCreateInterestedPartyResponse handleResponse(HttpResponse<InputStream> response)
        throws Exception {
      String contentType =
          response.headers().firstValue("Content-Type").orElse("application/octet-stream");
      AccountsCreateInterestedPartyResponse.Builder resBuilder =
          AccountsCreateInterestedPartyResponse.builder()
              .contentType(contentType)
              .statusCode(response.statusCode())
              .rawResponse(response);

      AccountsCreateInterestedPartyResponse res = resBuilder.build();
