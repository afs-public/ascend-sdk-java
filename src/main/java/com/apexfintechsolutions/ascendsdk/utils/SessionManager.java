...
import com.apexfintechsolutions.ascendsdk.models.errors.AuthException;
...
public final class SessionManager<T extends SessionManager.HasSessionKey> {
  ...
  public Session<T> getSession(
      ...
      Function<List<String>, Session<T>> tokenProvider) {
  ...
  // VisibleForTesting
  public static <T extends HasSessionKey> boolean shouldCreateNewSession(
      Optional<Session<T>> currentSession, Optional<List<String>> oauthScopes) {
  ...
  private static <T extends HasSessionKey> List<String> accumulateScopes(
      Optional<List<String>> requiredScopes, Optional<Session<T>> session) {
  ...
  public static boolean hasRequiredScopes(
      List<String> sessionScopes, Optional<List<String>> requiredScopes) {
  ...
  public static <T extends HasSessionKey> Session<T> requestOAuth2Token(
    ...
    try {
      ...
      final Optional<OffsetDateTime> expiresAt =
          t.expiresInMs.map(x -> OffsetDateTime.now().plus(x, ChronoUnit.MILLIS));
