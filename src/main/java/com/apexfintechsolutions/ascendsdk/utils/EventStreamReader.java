...
public final class EventStreamReader implements AutoCloseable {
   ...
   * when end of stream reached (and may occur with a partially read event message that has not yet
   * been terminated). Characters in comment lines are discarded as read (they are not buffered).
   *
