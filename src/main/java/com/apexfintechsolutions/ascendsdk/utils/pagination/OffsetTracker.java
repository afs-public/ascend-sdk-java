...
/**
 * Handles pagination based on the number of results in each response. This tracker is suitable for
 * APIs that return a count of items in each response and use that to determine if there are more
 * pages.
 *
