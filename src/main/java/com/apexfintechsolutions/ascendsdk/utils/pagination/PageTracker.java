...
/**
 * Handles pagination using total page count from responses. This tracker is suitable for APIs that
 * return the total number of pages in each response and use that to determine when to stop
 * pagination.
 *
