...
/**
 * Handles pagination using cursor values from responses. This tracker is suitable for APIs that
 * return a cursor value in each response that should be used to fetch the next page.
 *
