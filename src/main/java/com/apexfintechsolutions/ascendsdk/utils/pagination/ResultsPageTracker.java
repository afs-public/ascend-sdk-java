...
import static com.apexfintechsolutions.ascendsdk.utils.Utils.castLong;
...
/**
 * Handles pagination using a results expression to determine termination. This tracker is suitable
 * for APIs that return a count of items in each response and use that to determine if there are
 * more pages, while maintaining monotonic page number increments.
 *
 * @param <ProgressParamT> The numeric type to use for page numbers (e.g., Integer, Long)
 */
public class ResultsPageTracker<ProgressParamT extends Number>
