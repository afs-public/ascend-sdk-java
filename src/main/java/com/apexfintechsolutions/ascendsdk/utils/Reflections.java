...
public class Reflections {
  ...
  /**
   * Extracts the underlying value from an open enum instance if the class follows the open enum
   * pattern.
   *
   * <p>An open enum is a class that emulates enum behavior but can handle unknown values without
   ...
   *     follows the open enum pattern and the value extraction succeeds, {@code Optional.empty()}
   *     otherwise
   */
