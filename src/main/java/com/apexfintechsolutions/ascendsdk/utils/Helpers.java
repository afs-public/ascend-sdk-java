...
public final class Helpers {
   ...
   * HttpRequest}.
   *
   * <p>Note that headers can be added and modified but not removed. To remove headers use {@link
   * #copy(HttpRequest, BiPredicate)} (which applies a filter to the headers while copying).
   *
   * <p>Note also that this method is redundant from JDK 16 because the method {@code
   * HttpRequest.newBuilder(HttpRequest)} is available.
   *
   ...
   * HttpRequest}.
   *
   * <p>Note that this method is redundant from JDK 16 because the method {@code
   * HttpRequest.newBuilder(HttpRequest, BiPredicate)} is available.
   *
   * @param request request to copy
  ...
  /**
   * Returns the request body as a String assuming that the bytes of the request body are encoded
   * with UTF-8.
   *
   * @param request http request to extract from
