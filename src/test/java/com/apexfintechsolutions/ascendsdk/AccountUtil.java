  ...
  public static LegalNaturalPerson createLnp(SDK sdk) throws Exception {
    ...
    var req =
        LegalNaturalPersonCreate.builder()
            .birthDate(DateCreate.builder().day(1).month(1).year(1980).build())
            .givenName("John")
            .familyName("Doe")
            .employment(
            ...
            .identityVerificationResult(
                IdentityVerificationResultCreate.builder()
                    ...
                    .executionDate(DateCreate.builder().day(1).month(1).year(2023).build())
                    .externalCaseId("example")
                    .nameVerified(true)
                    .taxIdVerified(true)
                    .vendor("Super Security Service")
                    .rawVendorDataDocumentId("12345")
                    .build())
            .build();
