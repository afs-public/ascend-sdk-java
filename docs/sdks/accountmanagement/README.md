...
* [updateAccountGroup](#updateaccountgroup) - Update Account Group
...
* [createNote](#createnote) - Create Note (Account)
* [listNotes](#listnotes) - List Notes (Account)
* [getNote](#getnote) - Get Note (Account)
...
<!-- UsageSnippet language="java" operationID="Accounts_UpdateAccountGroup" method="put" path="/accounts/v1/accounts/{account_id}:updateAccountGroup" -->
```java
package hello.world;
...
public class Application {
    ...
    public static void main(String[] args) throws Status, Status, Exception {
        ...
        AccountsUpdateAccountGroupResponse res = sdk.accountManagement().updateAccountGroup()
                .accountId("01HC3MAQ4DR9QN1V8MJ4CN1HMK")
                .updateAccountGroupRequestUpdate(UpdateAccountGroupRequestUpdate.builder()
                    .build())
                .call();
...
| --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| `accountId`                                                                                   | *String*                                                                                      | :heavy_check_mark:                                                                            | The account id.                                                                               | 01HC3MAQ4DR9QN1V8MJ4CN1HMK                                                                    |
| `updateAccountGroupRequestUpdate`                                                             | [UpdateAccountGroupRequestUpdate](../../models/components/UpdateAccountGroupRequestUpdate.md) | :heavy_check_mark:                                                                            | N/A                                                                                           |                                                                                               |

### Response

**[AccountsUpdateAccountGroupResponse](../../models/operations/AccountsUpdateAccountGroupResponse.md)**
...
| `updateMask`                                                                                                                                                                                                                                                                                   | *Optional\<String>*                                                                                                                                                                                                                                                                            | :heavy_minus_sign:                                                                                                                                                                                                                                                                             | The list of fields to update. Updatable Fields  `given_name`  `middle_names`  `family_name`  `phone_number`  `email_address`  `mailing_address.region_code`  `mailing_address.postal_code`  `mailing_address.administrative_area`  `mailing_address.locality`  `mailing_address.address_lines` | {<br/>"update_mask": "given_name,middle_names"<br/>}                                                                                                                                                                                                                                           |
...
<!-- UsageSnippet language="java" operationID="Accounts_CreateNote" method="post" path="/accounts/v1/accounts/{account_id}/notes" -->
```java
package hello.world;
...
public class Application {
    ...
    public static void main(String[] args) throws Status, Status, Exception {
        ...
        AccountsCreateNoteResponse res = sdk.accountManagement().createNote()
                .accountId("01HC3MAQ4DR9QN1V8MJ4CN1HMK")
                .noteCreate(NoteCreate.builder()
...
| --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- |
| `accountId`                                         | *String*                                            | :heavy_check_mark:                                  | The account id.                                     | 01HC3MAQ4DR9QN1V8MJ4CN1HMK                          |
| `noteCreate`                                        | [NoteCreate](../../models/components/NoteCreate.md) | :heavy_check_mark:                                  | N/A                                                 |                                                     |

### Response

**[AccountsCreateNoteResponse](../../models/operations/AccountsCreateNoteResponse.md)**
...
<!-- UsageSnippet language="java" operationID="Accounts_ListNotes" method="get" path="/accounts/v1/accounts/{account_id}/notes" -->
```java
package hello.world;
...
public class Application {
    ...
    public static void main(String[] args) throws Status, Status, Exception {
        ...
        AccountsListNotesResponse res = sdk.accountManagement().listNotes()
                .accountId("01HC3MAQ4DR9QN1V8MJ4CN1HMK")
                .pageSize(50)
        ...
        if (res.listNotesResponse().isPresent()) {
            // handle response
        }
    }
}
...
**[AccountsListNotesResponse](../../models/operations/AccountsListNotesResponse.md)**
...
<!-- UsageSnippet language="java" operationID="Accounts_GetNote" method="get" path="/accounts/v1/accounts/{account_id}/notes/{note_id}" -->
```java
package hello.world;
...
public class Application {
    ...
    public static void main(String[] args) throws Status, Status, Exception {
        ...
        AccountsGetNoteResponse res = sdk.accountManagement().getNote()
                .accountId("01HC3MAQ4DR9QN1V8MJ4CN1HMK")
                .noteId("8096110d-fb55-4f9d-b883-b84f0b70d3ea")
                .call();
...
| ------------------------------------ | ------------------------------------ | ------------------------------------ | ------------------------------------ | ------------------------------------ |
| `accountId`                          | *String*                             | :heavy_check_mark:                   | The account id.                      | 01HC3MAQ4DR9QN1V8MJ4CN1HMK           |
| `noteId`                             | *String*                             | :heavy_check_mark:                   | The note id.                         | 8096110d-fb55-4f9d-b883-b84f0b70d3ea |

### Response

**[AccountsGetNoteResponse](../../models/operations/AccountsGetNoteResponse.md)**
