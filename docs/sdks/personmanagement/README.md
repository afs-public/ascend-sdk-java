...
| `orderBy`                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | *Optional\<String>*                                                                                                                                                                                                                                                                                                                                                                                                                                                           | :heavy_minus_sign:                                                                                                                                                                                                                                                                                                                                                                                                                                                            | The order in which legal natural persons are listed.                                                                                                                                                                                                                                                                                                                                                                                                                          | given_name desc                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
public class Application {
    ...
    public static void main(String[] args) throws Status, Status, Exception {
        ...
        sdk.personManagement().listLegalEntities()
                .pageSize(25)
                .pageToken("AbTYnwAkMjIyZDNjYTAtZmVjZS00N2Q5LTgyMDctNzI3MDdkMjFiZj3h")
                .orderBy("entity_name desc")
                .filter("legal_entity_id == \"e6716139-da77-46d1-9f15-13599161db0b\"")
                .callAsStream()
...
| `orderBy`                                                                                                                                                                                                                                                                                                                                                                                                       | *Optional\<String>*                                                                                                                                                                                                                                                                                                                                                                                             | :heavy_minus_sign:                                                                                                                                                                                                                                                                                                                                                                                              | The order in which legal entities are listed.                                                                                                                                                                                                                                                                                                                                                                   | entity_name desc                                                                                                                                                                                                                                                                                                                                                                                                |
| `filter`                                                                                                                                                                                                                                                                                                                                                                                                        | *Optional\<String>*                                                                                                                                                                                                                                                                                                                                                                                             | :heavy_minus_sign:                                                                                                                                                                                                                                                                                                                                                                                              | A CEL string to filter results; Use `upperAscii()` for case-insensitive searches; E.g. `entity_name.upperAscii()=="AcMe,InC".upperAscii()`; See the [CEL Search](https://developer.apexclearing.com/apex-fintech-solutions/docs/cel-search) page in Guides for more information; Filter options include:<br/> `legal_entity_id`<br/> `investigation_id`<br/> `exempt_customer_reason`<br/> `exempt_verifying_beneficial_owners` | legal_entity_id == "e6716139-da77-46d1-9f15-13599161db0b"                                                                                                                                                                                                                                                                                                                                                       |
